export default {
	...
	"common.actions.restore": "Відновити",
	...
	"common.labels.class": "Клас",
	"common.labels.classes": "класи",
	"common.labels.close": "Закрити",
	"common.labels.collapse": "колапс",
	"common.labels.collapsed": "згорнуто",
	"common.labels.complete.firstName": "Повне ім'я",
	...
	"common.labels.description": "Опис",
	"common.labels.email": "Електронна пошта",
	...
	"common.labels.logout": "Вийти",
	"common.labels.migrated.tooltip": "Показує, коли перенесення облікового запису завершено",
	...
	"common.labels.repeat.email": "Нова електронна пошта",
	...
	"common.medium.alert.incomplete": "Конфігурація носія не актуальна або не завершена.",
	...
	"common.placeholder.firstName": "Клара",
	"common.placeholder.lastName": "Інцидент",
	"common.placeholder.password.confirmation": "Підтвердьте за допомогою пароля",
	"common.placeholder.password.current": "Поточний пароль",
	"common.placeholder.password.new.confirmation": "Повторно введіть новий пароль",
	"common.placeholder.password.new": "Новий пароль",
	...
	"common.validation.tooLong": "Введений текст перевищує максимальну довжину в {maxLength} символів.",
	"common.validation.fileTooBig": "Файл не повинен перевищувати {maxSize} КБ.",
	"common.validation.tooShort": "Введений текст не досягає мінімальної довжини в {minLength} символів.",
	...
	"common.words.color.blue-grey": "Синьо-сірий",
	"common.words.color.brown": "Коричневий",
	"common.words.color.green": "Зелений",
	"common.words.color.light-blue": "Світло-блакитний",
	...
	"common.words.copiedToClipboard.failure": "Не вдалося скопіювати в буфер обміну. Спробуйте вручну.",
	"common.words.copyLinkToClipboard.success": "Посилання скопійовано в буфер обміну",
	"common.words.copyLinkToClipboard.failure": "Не вдалося скопіювати посилання в буфер обміну",
	...
	"components.administrationSection.description.moreInformation": "Важлива інформація про процес міграції {0}.",
	"components.administrationSection.description.moreInformation.link": "доступний тут",
	...
	"components.administration.adminMigrationSection.endWarningCard.check":
		"Я підтверджую завершення міграції. Щонайменше після закінчення періоду очікування в {gracePeriod} дн. стару систему реєстрації буде остаточно вимкнено, а облікові записи, які не було перенесено, видалено.",
	...
	"components.administration.adminMigrationSection.headers": "Міграція облікового запису в moin.schule",
	...
	"components.administration.adminMigrationSection.mandatorySwitch.label": "Міграція обов'язкова",
	"components.administration.adminMigrationSection.migrationActive": "Міграція облікового запису активна.",
	"components.administration.adminMigrationSection.migrationEnableButton.label": "Розпочати міграцію",
	"components.administration.adminMigrationSection.migrationEndButton.label": "повна міграція",
	...
	"components.administration.adminMigrationSection.migrationWizardButton.label": "Відкрийте помічник з міграції",
	...
	"components.administration.adminMigrationSection.showOutdatedUsers.label":
		"Показати застарілі облікові записи користувачів",
	"components.administration.adminMigrationSection.startWarningCard.agree": "старт",
	"components.administration.adminMigrationSection.startWarningCard.disagree": "Переривати",
	...
	"components.administration.externalToolsSection.action.showDatasheet": "Переглянути таблицю даних",
	"components.administration.externalToolsSection.action.sync": "Доступність оновлення",
	...
	"components.administration.externalToolsSection.vidis.notification.success": "Медіа VIDIS успішно оновлено",
	...
	"components.administration.externalToolsSection.notification.created": "Інструмент створено успішно.",
	"components.administration.externalToolsSection.notification.deleted": "Інструмент успішно видалено.",
	"components.administration.externalToolsSection.notification.updated": "Інструмент успішно оновлено.",
	"components.administration.externalToolsSection.table.header.status": "статус",
	"components.administration.externalToolsSection.table.header.restrictedTo": "Обмежено",
	"components.administration.externalToolsSection.table.header.medium": "Управління ЗМІ",
	"components.administration.externalToolsSection.table.ariaLabel.mediumAvailable": "Зовнішній носій уповноважений",
	...
	"components.administration.provisioningOptions.class.label": "Синхронізація занять",
	"components.administration.provisioningOptions.course.description":
		"Активуйте цю опцію, якщо курси та уроки потрібно синхронізувати в {instance}.",
	"components.administration.provisioningOptions.course.label": "Синхронізація курсів / уроки",
	...
	"components.administration.provisioningOptions.otherGroups.label": "Синхронізація інших груп",
	...
	"components.administration.schoolYearChangeSection.info.part.two": " (Більше інформації про {0})",
	...
	"components.administration.schoolYearChangeSection.notification.start.success": "Фаза передачі розпочалася успішно",
	"components.administration.schoolYearChangeSection.title.step.one": "Наприкінці навчального року",
	...
	"components.administration.schoolYearChangeSection.step.one.button.startTransfer": "Почніть фазу передачі",
	"components.administration.schoolYearChangeSection.step.one.button.transferStarted": "Почалася фаза передачі",
	"components.administration.schoolYearChangeSection.title.step.two": "Близько літніх канікул",
	...
	"components.administration.schoolYearChangeSection.step.two.button": "Перевірте дані LDAP",
	"components.administration.schoolYearChangeSection.title.step.three": "Новий навчальний рік",
	...
	"components.administration.schoolYearChangeSection.step.three.button": "Кінцева фаза передачі",
	...
	"components.administration.schoolYearChangeSection.dialog.start.title": "Дійсно почати фазу передачі?",
	...
	"components.administration.schoolYearChangeSection.dialog.finish.title": "Дійсно фаза кінцевої передачі?",
	...
	"components.board.error.404": "Помилка 404 – Дошки з такою назвою не знайдено",
	"components.board.error.403": "Помилка 403 – На жаль, у вас немає дозволу на перегляд цього контенту ...",
	...
	"components.board.ai.source.card": "На основі цієї картки",
	"components.board.ai.source.column": "На основі всіх карток цієї колонки",
	"components.board.ai.preset.differentiate": "Диференціювати",
	"components.board.ai.preset.differentiate.hint":
		"Два варіанти одного завдання: один із більшою підтримкою, інший складніший.",
	"components.board.ai.preset.exercises": "Вправи",
	"components.board.ai.preset.exercises.hint":
		"Завдання зі зростанням складності та картка з підказками до розв'язків.",
	"components.board.ai.preset.simplify": "Спростити мову",
	"components.board.ai.preset.simplify.hint": "Той самий зміст короткими реченнями з поясненням термінів.",
	"components.board.ai.preset.selfCheck": "Самоперевірка",
	"components.board.ai.preset.selfCheck.hint": "Твердження «тепер я вмію …» для самоперевірки та короткі відповіді.",
	"components.board.ai.preset.free": "Власний запит",
	"components.board.ai.preset.free.hint": "Опишіть самі, які картки мають з'явитися.",
	"components.board.ai.prompt.label": "Завдання",
	"components.board.ai.prompt.placeholder": "напр. напиши три підсумкові запитання до змісту",
	"components.board.ai.generate": "Запропонувати картки",
	"components.board.ai.regenerate": "Запропонувати ще раз",
	"components.board.ai.insert": "Вставити {count} карток",
	"components.board.ai.error": "Не вдалося створити пропозицію. Спробуйте ще раз.",
	"components.board.ai.insertError": "Не всі картки вдалося вставити.",
	...
	"components.board.menu.externalToolElement": "Налаштування зовнішнього інструменту",
	...
	"components.board.menu.pollElement": "Налаштування опитування",
	"components.board.menu.deadlineElement": "Налаштування терміну",
	"components.board.menu.codeElement": "Налаштування коду",
	...
	"components.cardElement.recordingElement.waveform": "Форма хвилі запису",
	...
	"components.cardElement.codeElement": "Код",
	"components.cardElement.codeElement.language": "Мова",
	"components.cardElement.codeElement.lineNumbers": "Номери рядків",
	"components.cardElement.codeElement.highlighting": "Підсвічування синтаксису",
	"components.cardElement.codeElement.code": "Код",
	"components.cardElement.codeElement.copy": "Копіювати",
	"components.cardElement.codeElement.copied": "Код скопійовано",
	"components.cardElement.formulaElement": "Формула",
	"components.cardElement.formulaElement.latex": "LaTeX",
	"components.cardElement.formulaElement.empty": "Формулу ще не введено",
	"components.cardElement.formulaElement.invalid": "Не вдалося прочитати формулу",
	"components.cardElement.checklistElement": "Контрольний список",
	"components.cardElement.checklistElement.title": "Назва",
	"components.cardElement.checklistElement.item": "Пункт {index}",
	"components.cardElement.checklistElement.addItem": "Додати пункт",
	"components.cardElement.checklistElement.removeItem": "Видалити пункт {index}",
	"components.cardElement.checklistElement.empty": "Ще немає пунктів",
	"components.cardElement.checklistElement.progress": "виконано {done} з {total}",
	"components.cardElement.checklistElement.progressMode": "Прогрес",
	"components.cardElement.checklistElement.progressMode.shared": "Спільний для всіх",
	"components.cardElement.checklistElement.progressMode.perUser": "Особистий для кожного",
	"components.cardElement.checklistElement.modeResetHint": "Зміна режиму скидає вже поставлені позначки.",
	"components.cardElement.checklistElement.personal": "лише для вас",
	"components.cardElement.checklistElement.participants": "{count} розпочали",
	"components.board.settings.inherit": "Як у кімнаті",
	"components.board.settings.inheritedValue": "зараз: {value}",
	"components.board.settings.off": "Вимкнено",
	"components.elementTypeSelection.elements.deadlineElement.subtitle": "Термін",
	"components.elementTypeSelection.elements.codeElement.subtitle": "Код",
	"components.elementTypeSelection.elements.formulaElement.subtitle": "Формула",
	"components.elementTypeSelection.elements.checklistElement.subtitle": "Контрольний список",
	...
	"components.boardCard.settings.readersCanEdit": "Усі можуть редагувати",
	"components.boardCard.comment.placeholder": "Написати коментар",
	"components.boardCard.comment.hint": "Enter надсилає, Shift+Enter додає новий рядок",
	"components.boardCard.comment.submit": "Надіслати",
	"components.boardCard.comment.edited": "відредаговано",
	"components.boardCard.comment.removed": "Коментар відкликано",
	"components.boardCard.comment.removedByModerator": "Коментар видалено вчителем",
	"components.boardCard.comment.menu": "Дії з коментарем",
	"components.boardCard.comment.report": "Поскаржитися",
	...
	"components.board.reactionType.like.hint": "Один клік на людину, показано кількість.",
	"components.board.reactionType.star": "Зірки",
	"components.board.reactionType.star.hint": "Оцінка від однієї до п'яти зірок, показано середнє.",
	"components.board.reactionType.vote": "Голосування",
	"components.board.reactionType.vote.hint": "За або проти, показано різницю.",
	"components.boardCard.reaction.like": "Подобається",
	"components.boardCard.reaction.upvote": "За",
	"components.boardCard.reaction.downvote": "Проти",
	"components.boardCard.reaction.star": "{count} із 5 зірок",
	"components.boardCard.reaction.average": "{average} ({count})",
	"components.boardCard.reaction.noRating": "Ще без оцінок",
	...
	"components.board.notifications.errors.fileNameExists": "Файл з такою назвою вже існує.",
	"components.board.notifications.errors.fileServiceNotAvailable": "Файловий сервіс наразі недоступний.",
	...
	"components.board.screenReader.notification.boardVisibilityUpdated.published": "Дошку опублікував інший користувач.",
	...
	"components.cardElement.pollElement": "Опитування",
	"components.cardElement.pollElement.question": "Питання",
	"components.cardElement.pollElement.noQuestion": "Питання ще не поставлено",
	"components.cardElement.pollElement.option": "Відповідь {index}",
	"components.cardElement.pollElement.noOptionText": "Відповідь без тексту",
	"components.cardElement.pollElement.addOption": "Додати відповідь",
	"components.cardElement.pollElement.removeOption": "Видалити відповідь {index}",
	"components.cardElement.pollElement.multipleChoice": "Дозволити кілька відповідей",
	"components.cardElement.pollElement.anonymous": "Анонімно",
	"components.cardElement.pollElement.close": "Завершити опитування",
	"components.cardElement.pollElement.closed": "Завершено",
	"components.cardElement.pollElement.showResults": "Показувати результати",
	"components.cardElement.pollElement.showResults.always": "Одразу для всіх",
	"components.cardElement.pollElement.showResults.afterVote": "Після власного голосування",
	"components.cardElement.pollElement.showResults.onRelease": "Лише після відкриття вчителем",
	"components.cardElement.pollElement.resultsRelease": "Відкрити результати",
	"components.cardElement.pollElement.resultsWithdraw": "Приховати результати",
	"components.cardElement.pollElement.resultsAfterVote": "Результати з'являться після вашого голосу",
	"components.cardElement.pollElement.resultsAfterClose": "Результати ще не відкрито",
	"components.cardElement.pollElement.voterCount": "{count} учасників",
	"components.cardElement.pollElement.votes": "{count} голосів",
	"components.cardElement.pollElement.votedBy": "{count} проголосували відкрито",
	"components.cardElement.pollElement.share": "{percent} відсотків",
	"components.cardElement.pollElement.withdraw": "Відкликати голос",
	"components.cardElement.pollElement.voteResetHint": "Зміна відповідей або анонімності видаляє вже подані голоси.",
	"components.elementTypeSelection.elements.pollElement.subtitle": "Опитування",
	...
	"components.elementTypeSelection.elements.folderElement.subtitle": "Папка з файлами",
	...
	"components.externalTools.status.outdated": "Застаріла",
	"components.externalTools.status.unknown": "Незнайомець",
	"components.legacy.footer.accessibility.report": "Відгук про доступність",
	"components.legacy.footer.accessibility.statement": "Заява про доступність",
	"components.legacy.footer.ariaLabel": "Посилання, {itemName}",
	...
	"components.molecules.ContentCard.report.body": "Повідомити про вміст з ідентифікатором",
	"components.molecules.ContentCard.report.email": "inhalte{'@'}hpi-schul-cloud.de",
	"components.molecules.ContentCard.report.subject":
		"Шановна командо, я хотів(-ла) би повідомити про вміст, згаданий у темі, оскільки: [укажіть свої причини]",
	"components.molecules.ContentCardMenu.action.copy": "Копіювати до...",
	"components.molecules.ContentCardMenu.action.delete": "Видалити",
	"components.molecules.ContentCardMenu.action.report": "Надіслати звіт",
	...
	"components.molecules.label.column": "Оберіть розділ",
	"components.molecules.label.course": "Оберіть курс",
	...
	"components.molecules.import.columnBoard.options.selectCourse": "Оберіть курс",
	...
	"components.molecules.import.columnBoard.options.selectRoom": "Оберіть кімнату",
	...
	"components.molecules.import.columnBoard.question": "Будь ласка, виберіть дошку.",
	"components.molecules.import.courses.rename": "При необхідності назву курсу можна перейменувати: ",
	"components.molecules.import.courses.options.title": "Імпортувати курсу",
	"components.molecules.import.lessons.label": "Тема",
	"components.molecules.import.lessons.rename": "При необхідності назву теми можна перейменувати: ",
	...
	"components.molecules.import.lessons.options.title": "Тема імпорту",
	"components.molecules.import.lessons.question": "Куди слід імпортувати тему{title}?",
	"components.molecules.import.options.failure.backendError": "{name} не вдалося імпортувати.",
	...
	"components.molecules.importUsersMatch.notFound": "облікові записи не знайдено",
	"components.molecules.importUsersMatch.saveMatch": "Зберегти зв'язок",
	"components.molecules.importUsersMatch.search": "Пошук користувача",
	"components.molecules.importUsersMatch.subtitle.nbc":
		"Пізніше обліковий запис webbschule буде імпортовано в {instance}. Якщо ви хочете зв’язати обліковий запис із наявним обліковим записом {instance}, щоб зберегти дані користувача, виберіть тут обліковий запис {instance}.",
	"components.molecules.importUsersMatch.subtitle":
		"Пізніше обліковий запис webbschule буде імпортовано в {instance}. Якщо ви хочете зв’язати обліковий запис із наявним обліковим записом {instance}, щоб зберегти дані користувача, виберіть тут обліковий запис {instance}. В іншому випадку цей обліковий запис буде створено як новий.",
	"components.molecules.importUsersMatch.title": "Пов’яжіть обліковий запис {source} з обліковим записом {instance}",
	"components.molecules.importUsersMatch.unMatched.nbc": "немає.",
	"components.molecules.importUsersMatch.unMatched": "немає. Обліковий запис буде створено знову.",
	"components.molecules.importUsersMatch.write": "Введіть ім'я та прізвище",
	"components.molecules.importUsersMatch.externalRoleName.none": "Немає в наявності",
	"components.molecules.importUsersMatch.externalRoleName.schulconnex.teacher": "Учитель",
	"components.molecules.importUsersMatch.externalRoleName.schulconnex.student": "Студент",
	...
	"components.molecules.shareImport.options.restrictions.infoText.personalData": "Персональні дані",
	"components.molecules.shareImport.options.restrictions.infoText.courseFiles": "Файли в розділі Файли курсу",
	"components.molecules.shareImport.options.restrictions.infoText.etherpad": "Вміст із Etherpads",
	"components.molecules.shareImport.options.restrictions.infoText.whiteboard": "Вміст із Whiteboards",
	"components.molecules.shareImport.options.restrictions.infoText.geogebra": "Ідентифікатори Geogebra",
	"components.molecules.shareImport.options.restrictions.infoText.courseGroups": "Групи курсів",
	"components.molecules.shareImport.options.restrictions.infoText.roomMembershipsData":
		"Учасники кімнати та їхні дозволи",
	"components.molecules.share.options.tableHeader.InfoText": "Наступне не копіюється:",
	"components.molecules.share.courses.result.linkLabel": "Посилання на копію курсу",
	"components.molecules.share.lessons.mail.body": "Посилання на курс:",
	"components.molecules.share.lessons.mail.subject": "Теми, які можна імпортувати",
	...
	"components.molecules.TaskItemTeacher.lessonIsNotPublished": "тема не опублікований",
	"components.molecules.TaskItemTeacher.status": "{submitted}/{max} надіслано, {graded} оцінено",
	...
	"components.organisms.ContentCard.report.subject":
		"Шановна командо, я хотів(-ла) би повідомити про вміст, згаданий у темі, оскільки: [укажіть свої причини]",
	"components.organisms.DataFilter.add": "Додати фільтр",
	...
	"components.organisms.importUsers.legend": "Легенда",
	"components.organisms.importUsers.legendAdminMatched":
		"{source} Обліковий запис адміністратора, пов’язаний із користувачем {instance}.",
	"components.organisms.importUsers.legendAutoMatched":
		"Обліковий запис {source} автоматично пов’язано з користувачем {instance}.",
	"components.organisms.importUsers.legendFlag":
		"Записи, які слід позначити та, за потреби, перевірити пізніше, можна позначити прапорцем.",
	"components.organisms.importUsers.legendUnMatched":
		"{instance} Користувача не знайдено. Після завершення міграції новий обліковий запис користувача буде створено автоматично, щойно користувач {source} уперше ввійде до {instance}.",
	"components.organisms.importUsers.searchAdminMatched": "Пошук підключено адміністратором",
	"components.organisms.importUsers.searchAutoMatched": "Фільтрувати за автоматично зіставленими",
	"components.organisms.importUsers.searchClass": "Пошук класу",
	"components.organisms.importUsers.searchFirstName": "Пошук імені",
	"components.organisms.importUsers.searchFlagged": "Фільтрувати за позначеними",
	"components.organisms.importUsers.searchLastName": "Пошук прізвища",
	"components.organisms.importUsers.searchRole": "Пошук ролі",
	"components.organisms.importUsers.searchUnMatched": "Фільтрувати за неприв'язаними",
	"components.organisms.importUsers.searchUserName": "Пошук імені користувача",
	"components.organisms.importUsers.tableClasses": "Класи",
	"components.organisms.importUsers.tableFirstName": "Ім'я",
	"components.organisms.importUsers.tableFlag": "Позначка",
	"components.organisms.importUsers.tableLastName": "Прізвище",
	"components.organisms.importUsers.tableMatch": "Зіставити облікові записи",
	"components.organisms.importUsers.tableRoles": "Ролі",
	"components.organisms.importUsers.tableUserName": "Ім'я користувача",
	"components.organisms.LegacyFooter.contact": "Контакт",
	"components.organisms.LegacyFooter.job-offer": "Оголошення про вакансії",
	"components.organisms.Pagination.currentPage": "{start} з {end} до {total}",
	"components.organisms.Pagination.perPage.10": "10 на сторінці",
	"components.organisms.Pagination.perPage.100": "100 на сторінці",
	"components.organisms.Pagination.perPage.25": "25 на сторінці",
	"components.organisms.Pagination.perPage.5": "5 на сторінці",
	"components.organisms.Pagination.perPage.50": "50 на сторінці",
	"components.organisms.Pagination.perPage": "на сторінці",
	"components.organisms.Pagination.recordsPerPage": "Записів на сторінці",
	"components.organisms.Pagination.showTotalRecords": "Показати всі {total} записи (-ів)",
	"components.organisms.TasksDashboardMain.filter.substitute": "Завдання від викладачів на заміну",
	"components.organisms.TasksDashboardMain.fab.createTask": "Створити завдання",
	"components.organisms.TasksDashboardMain.tab.completed": "Завершено",
	"components.organisms.TasksDashboardMain.tab.current": "Поточні",
	...
	"components.roomForm.labels.feedback.reactions.like": "Подобається",
	"components.roomForm.labels.feedback.reactions.star": "Зірки (1–5)",
	"components.roomForm.labels.feedback.reactions.vote": "За і проти",
	...
	"feature-board-external-tool-element.alert.error.teacher":
		"Інструмент зараз неможливо запустити. Будь ласка, оновіть дошку або зверніться до адміністратора школи.",
	...
	"feature-copy.copyInfo.checkPrivacyAndCopyright":
		"Будь ласка, перевірте вміст на предмет авторських прав та конфіденційності.",
	"feature-copy.copyInfo.text.nextStep": "На наступному кроці буде створена копія {type}.",
	"feature-copy.copyInfo.text.alert.followingContent": "Наступне не буде скопійовано:",
	"feature-copy.copyInfo.text.alert.membersPermissions": "Учасники та дозволи {type}",
	"feature-copy.copyInfo.text.alert.courseFiles": "Файли в файлах курсу",
	"feature-copy.copyInfo.text.alert.courseGroup": "Групи курсу",
	"feature-copy.copyInfo.text.alert.Etherpad": "Вміст з Etherpads",
	"feature-copy.copyInfo.text.alert.whiteboard": "Вміст з дощок",
	"feature-copy.copyInfo.text.alert.geogebra": "ID Geogebra",
	"feature-copy.copyInfo.text.alert.protectedSettings": "Захищені налаштування зовнішніх інструментів",
	"feature-copy.inProgress.title.loading": "Триває тиражування...",
	...
	"feature-copy.copyInfo.type.task": "Завдання",
	"feature-copy.copyInfo.type.lesson": "Урок",
	"feature-copy.copyInfo.type.room": "Кімната",
	"feature-copy.copyInfo.type.card": "Картка",
	"feature-copy.copyInfo.type.ofCourse": "курсу",
	"feature-copy.copyInfo.type.ofBoard": "дошки",
	"feature-copy.copyInfo.type.ofTask": "завдання",
	...
	"global.topbar.MenuQrCode.qrHintText": "Переспрямовувати інших користувачів на цей сайт",
	"global.topbar.mobileMenu.ariaLabel": "Навігація сторінкою",
	"global.topbar.settings": "Параметри",
	"global.topbar.userMenu.ariaLabel": "Меню користувача для {userName}",
	"mixins.typeMeta.types.default": "Вміст",
	...
	"pages.dashboard.calendar.title": "Найближчі події",
	"pages.dashboard.calendar.subtitle": "Швидкий огляд майбутніх подій курсів і команд.",
	"pages.dashboard.calendar.showAll": "До огляду",
	"pages.dashboard.calendar.empty.title": "Немає майбутніх подій",
	"pages.dashboard.calendar.empty.text": "Події з’являться тут, щойно сервіс календаря їх надасть.",
	"pages.dashboard.calendar.openCourse": "Відкрити курс",
	"pages.dashboard.calendar.openTeam": "Відкрити команду",
	"pages.dashboard.calendar.openContext": "Відкрити контекст",
	"pages.calendar.title": "Календар",
	"pages.calendar.subtitle": "Усі події з календаря, курсів і команд.",
	"pages.calendar.empty": "Немає доступних подій.",
	"pages.calendar.today": "Сьогодні",
	"pages.calendar.past": "Минулі події",
	"pages.calendar.view.day": "День",
	"pages.calendar.view.week": "Тиждень",
	"pages.calendar.view.month": "Місяць",
	"pages.calendar.previous": "Назад",
	"pages.calendar.next": "Далі",
	"pages.calendar.addEvent": "Додати дату",
	"pages.calendar.confirmDelete": "Ти справді хочеш видалити цю дату?",
	"pages.calendar.deleteEvent": "Видалити дату",
	"pages.calendar.deleted": "Дату видалено.",
	"pages.calendar.form.createTitle": "Додати дату",
	"pages.calendar.form.description": "Опис",
	"pages.calendar.form.editTitle": "Редагувати дату",
	"pages.calendar.form.endBeforeStart": "Кінець має бути після початку.",
	"pages.calendar.form.error": "Не вдалося зберегти дату.",
	"pages.calendar.form.from": "Від",
	"pages.calendar.form.location": "Місце",
	"pages.calendar.form.locationPlaceholder": "напр. гімназія",
	"pages.calendar.form.required": "Будь ласка, заповніть.",
	"pages.calendar.form.title": "Назва",
	"pages.calendar.form.titlePlaceholder": "напр. тренування з гандболу",
	"pages.calendar.form.to": "До",
	"pages.accountSettings.title": "Ваш обліковий запис",
	"pages.accountSettings.profile": "Профіль",
	"pages.accountSettings.security": "Безпека",
	"pages.accountSettings.currentPassword": "Поточний пароль",
	"pages.accountSettings.passwordHint": "Зміни електронної пошти або пароля потрібно підтвердити поточним паролем.",
	"pages.accountSettings.ssoHint":
		"Ваші дані користувача автоматично синхронізуються системою управління ідентифікацією (IDM). Зміни в них можуть бути внесені тільки в системі-джерелі (наприклад, шкільний сервер або Schulportal), на якій базуються дані в IDM. Щоб внести зміни до даних користувача, будь ласка, зверніться до місцевого адміністратора вашої школи.",
	...
	"pages.news.overview.search": "Пошук новин",
	"pages.accountThirdPartyProviders.title": "Вхід в систему третіх сторін",
	"pages.accountThirdPartyProviders.empty": "Сторонні постачальники не використовуються",
	"pages.accountThirdPartyProviders.revoked": "Сторонній вхід видалено.",
	"pages.accountThirdPartyProviders.revokeError": "Не вдалося видалити сторонній вхід.",
	"pages.accountTeams.title": "Налаштування команди",
	"pages.accountTeams.visibilityTitle": "Видимість для запрошень",
	"pages.accountTeams.visibilityText":
		"Тут визначається, чи можна знайти вас у каталогах для запрошень до кімнат або команд.",
	"pages.accountTeams.nativeNote":
		"Цей вигляд перенесено нативно. Конкретне налаштування видимості буде підключено до відповідної backend-конфігурації в наступному зрізі.",
	"pages.dashboard.empty.news": "Немає останніх новин. Перегляньте розділ новин, щоб бути в курсі.",
	"pages.legacyViewMigration.title": "Застарілий вигляд перенесено",
	"pages.legacyViewMigration.description":
		"Цей застарілий вигляд більше не відкривається у старому клієнті. Шлях зареєстровано у списку міграції Nuxt і тепер його можна поступово реалізувати як нативний вигляд.",
	"pages.legacyViewMigration.requestedPath": "Запитаний шлях",
	"pages.legacyViewMigration.legacyView": "Застарілий вигляд",
	"pages.legacyViewMigration.legacyController": "Застарілий контролер",
	"pages.legacyViewMigration.note":
		"Доки нативний вигляд не завершено, скористайтеся оглядом або довідкою, щоб перейти до відповідної робочої області.",
	"pages.legacyViewMigration.toDashboard": "До огляду",
	"pages.legacyViewMigration.toHelp": "До довідки",
	"pages.releaseNotes.title": "Примітки до випуску",
	"pages.releaseNotes.empty": "Примітки до випуску ще недоступні.",
	"pages.releaseNotes.openSource": "Відкрити джерело",
	"pages.helpArticles.title": "Довідковий розділ",
	"pages.helpArticles.training": "Онлайн-відеокурси",
	"pages.helpArticles.liveFormats": "Живі формати",
	"pages.helpArticles.quickstartPdf": "PDF швидкого старту",
	"pages.helpArticles.documents": "Документи для завантаження",
	"pages.helpArticles.search": "пошук...",
	"pages.helpArticles.firstSteps.students": "Учні",
	"pages.helpArticles.firstSteps.teachers": "Викладачі",
	"pages.helpArticles.firstSteps.principal": "Директор школи",
	"pages.helpArticles.firstSteps": "Erste Schritte",
	"pages.helpArticles.usageHelp": "Nutzungshilfen",
	"pages.helpContact.title": "Контакт",
	"pages.helpContact.problem": "Проблема",
	"pages.helpContact.wish": "Запит",
	"pages.helpContact.problemArea": "Вибрати тему",
	"pages.helpContact.subject": "Короткий опис проблеми",
	"pages.helpContact.problemDescription": "Опис проблеми",
	"pages.helpContact.role": "У якості...",
	"pages.helpContact.desire": "Я хотів(-ла) би...",
	"pages.helpContact.benefit": "приблизно...",
	"pages.helpContact.acceptanceCriteria": "Критерії приймання",
	"pages.helpContact.device": "Проблема виникає на цьому пристрої",
	"pages.helpContact.replyEmail": "Адреса електронної пошти для будь-яких запитів",
	"pages.helpContact.consent":
		"Я погоджуюся, що для кращого розв'язання моєї проблеми може бути передана така інформація:",
	"pages.helpContact.sent": "Запит надіслано.",
	"pages.helpContact.sendError": "Не вдалося надіслати запит.",
	"pages.helpContact.formTitle": "Контактна форма",
	"pages.helpContact.feedbackKind": "Який відгук ви хотіли б надіслати нам?",
	"pages.helpContact.topicTitle": "Вибрати тему",
	"pages.helpContact.severalTopics": "Можливий вибір декількох тем",
	"pages.helpContact.required": "(oбов'язково)",
	"pages.helpContact.noProblemArea": "Треба вибрати проблемну зону.",
	"pages.helpContact.knownTitle": "Проблема вже відома?",
	"pages.helpContact.knownText":
		"Ви перевірили, чи ваша проблема вже відома? Це допомагає нам швидше розв'язувати проблеми, якщо ви ділитеся лише новими проблемами.",
	"pages.helpContact.knownStatus":
		"Крім того, можна перевірити нашу сторінку стану, щоб побачити, чи є у нас зараз проблеми з нашими технічними системами.",
	"pages.helpContact.supportTitle": "Зверніться до служби підтримки",
	"pages.helpContact.supportSubtitle": "Вашої проблеми немає в списку? Зверніться до нашої служби підтримки.",
	"pages.helpContact.supportSubtitleWish": "Бажаєте поширити запит? Зверніться до нашої служби підтримки.",
	"pages.helpContact.subjectWish": "Короткий опис запиту",
	"pages.helpContact.deviceWish": "Пристрій",
	"pages.helpContact.emailPlaceholder": "Адреса електронної пошти",
	"pages.helpContact.furtherInformation": "Додаткова інформація про ваш браузер та операційну систему",
	"pages.helpContact.consentWish":
		"Я погоджуюсь, що для кращої обробки мого запиту може бути передана наведена нижче інформація:",
	"pages.helpContact.consentBrowser": "Ім’я та версія браузера (наприклад, Firefox 69.0)",
	"pages.helpContact.consentOs": "Операційна система та версія (наприклад, Windows 10)",
	"pages.helpContact.submit": "Подати",
	"pages.helpContact.rolePlaceholder": "напр. учні, викладачі, адміністратори, двірники тощо.",
	"pages.helpContact.desirePlaceholder": "напр., можна легко знайти та змінити створене в системі завдання учня",
	"pages.helpContact.benefitPlaceholder": "напр., щоб оновити їх",
	"pages.helpContact.acceptancePlaceholder":
		"Наприклад, після входу в систему я досягаю контексту уроку максимум за два кроки, можу редагувати там завдання учня одним натисканням миші та, якщо потрібно, автоматично повідомляти учням про зміну.",
	"pages.helpContact.whichArea": "Якої області проєкту HPI Schul-Cloud стосується ваша тема?",
	"pages.helpConfluence.title": "Довідкова стаття",
	"pages.helpConfluence.hint": "Якщо стаття відображається некоректно, відкрийте її безпосередньо в документації.",
	"pages.helpConfluence.openExternal": "Відкрити статтю зовні",
	"pages.helpDocuments.title": "Документи для завантаження",
	"pages.helpDocuments.empty": "Немає доступних документів.",
	"pages.taskDetail.back": "До огляду завдань",
	"pages.taskDetail.description": "Опис",
	"pages.taskDetail.maxSubmissions": "Макс. здач",
	"pages.taskDetail.noDescription": "Опис відсутній.",
	"pages.taskDetail.notFound": "Завдання не знайдено.",
	"pages.taskDetail.submissions": "Здачі",
	"pages.taskDetail.submissions.empty": "Статуси здач ще недоступні.",
	"pages.taskDetail.tab.details": "Подробиці",
	"pages.taskDetail.tab.submissions": "Подання",
	"pages.taskDetail.toCourseFiles": "До файлів курсу",
	"pages.taskDetail.toCourse": "До курсу",
	"pages.taskDetail.till": "до",
	"pages.taskDetail.confirmDelete": "Ви впевнені, що хочете видалити «{name}»?",
	"pages.taskDetail.error": "Не вдалося.",
	"pages.taskDetail.feedback.files": "Файли, завантажені як коментарі/оцінки",
	"pages.taskDetail.feedback.none": "Коментарів поки що немає.",
	"pages.taskDetail.feedback.solvedPercent": "Ви правильно розв’язали {grade}%.",
	"pages.taskDetail.files.none": "Файлів немає.",
	"pages.taskDetail.files.upload": "Завантажити файли",
	"pages.taskDetail.finish": "Архів",
	"pages.taskDetail.grading.comment": "Зауваження щодо оцінювання",
	"pages.taskDetail.grading.error": "Не вдалося зберегти оцінку.",
	"pages.taskDetail.grading.files": "Завантажте виправлені файли",
	"pages.taskDetail.grading.grade": "рейтинг",
	"pages.taskDetail.grading.inPercent": "%",
	"pages.taskDetail.grading.saveAndSend": "Зберегти та відправити",
	"pages.taskDetail.grading.saved": "Рейтинг збережено!",
	"pages.taskDetail.lessonHidden": "Завдання не відображається, оскільки тема не опублікована",
	"pages.taskDetail.noDueDate": "Немає дати подання",
	"pages.taskDetail.print": "Видрукувати визначення завдання",
	"pages.taskDetail.restore": "Відновити",
	"pages.taskDetail.state.done": "Чудово! Ви виконали своє завдання!",
	"pages.taskDetail.state.late": "Запізно! Наступного разу постарайтеся бути уважнішими до свого часу.",
	"pages.taskDetail.submission.chooseTeamMembers": "Вибрати колег",
	"pages.taskDetail.submission.done": "Чудово! Ви виконали своє завдання!",
	"pages.taskDetail.submission.error": "Не вдалося зберегти роботу.",
	"pages.taskDetail.submission.fileUpload": "Подання файлу",
	"pages.taskDetail.submission.maxTeamSize": "Максимальний розмір команди — {max} учасників",
	"pages.taskDetail.submission.placeholder": "Створіть своє подання...",
	"pages.taskDetail.submission.saveDraft": "Зберегти чернетку",
	"pages.taskDetail.submission.saveFirst": "Спочатку збережи роботу як чернетку, потім зможеш завантажити файли.",
	"pages.taskDetail.submission.saved": "Чернетку збережено.",
	"pages.taskDetail.submission.submit": "Надіслати заявку",
	"pages.taskDetail.submission.submitted": "Роботу надіслано.",
	"pages.taskDetail.submission.teamSubmission": "Подання команд",
	"pages.taskDetail.submission.textDelivery": "Текстове подання",
	"pages.taskDetail.submissions.grade": "рейтинг",
	"pages.taskDetail.submissions.noSubmissionYetFrom": "Ще немає подання від:",
	"pages.taskDetail.submissions.noText": "Немає подання",
	"pages.taskDetail.submissions.none": "Немає доступних подань.",
	"pages.taskDetail.submissions.rating": "Коментар/оцінювання",
	"pages.taskDetail.submissions.show": "Показати",
	"pages.taskDetail.submissions.submitted": "Подані",
	"pages.taskDetail.submissions.submittedFiles": "Файли завантажені для подання",
	"pages.taskDetail.submissions.team": "Команда",
	"pages.taskDetail.tab.feedback": "Коментар/оцінювання",
	"pages.taskDetail.tab.submission": "Подання",
	"pages.taskEdit.availableDate": "Показується для учнів і може бути відредаговано з",
	"pages.taskEdit.course": "Курс",
	"pages.taskEdit.createTitle": "Додати завдання",
	"pages.taskEdit.description": "Визначення завдання",
	"pages.taskEdit.descriptionPlaceholder": "Поясніть чому...",
	"pages.taskEdit.draft": "Чернетка (видима лише для мене)",
	"pages.taskEdit.dueBeforeStart": "Дата початку має бути до дати подання!",
	"pages.taskEdit.dueDate": "Період обробки закінчується",
	"pages.taskEdit.editTitle": "Редагувати завдання",
	"pages.taskEdit.error": "Не вдалося зберегти завдання.",
	"pages.taskEdit.maxTeamMembers": "Максимальний розмір групи",
	"pages.taskEdit.name": "Назва",
	"pages.taskEdit.noCourse": "Немає призначень",
	"pages.taskEdit.noTopic": "Не вибрано жодної теми",
	"pages.taskEdit.publicSubmissions": "Подання учнів видно один одному",
	"pages.taskEdit.publicSubmissionsHint":
		"Якщо активувати цей варіант, подання всіх учасників курсу будуть доступні для всіх інших учнів курсу.",
	"pages.taskEdit.required": "Це поле обов'язкове.",
	"pages.taskEdit.saved": "Завдання збережено.",
	"pages.taskEdit.substitutionCannotChangeCourse": "(Замісні викладачі не мають права редагувати курс)",
	"pages.taskEdit.teamSubmissions": "Увімкнути групове подання",
	"pages.taskEdit.topic": "Тема",
	...
	"pages.administration.ldap.activate.dN": "Ім'я домену",
	"pages.administration.ldap.activate.email": "Електронна пошта",
	"pages.administration.ldap.activate.firstName": "Ім'я",
	"pages.administration.ldap.activate.lastName": "Прізвище",
	"pages.administration.ldap.activate.message":
		"Ваша конфігурація збережена. Синхронізація може тривати до кількох годин.",
	"pages.administration.ldap.activate.migrateExistingUsers.checkbox":
		"Використовуйте майстри міграції для об'єднання існуючих користувачів і користувачів LDAP",
	...
	"pages.administration.ldap.activate.migrateExistingUsers.title": "Міграція існуючих користувачів",
	"pages.administration.ldap.activate.ok": "Ок",
	"pages.administration.ldap.activate.roles": "Ролі",
	...
	"pages.administration.ldap.index.buttons.reset": "Скинути вхідні дані",
	"pages.administration.ldap.index.buttons.verify": "Перевірити",
	...
	"pages.administration.ldap.users.uid.title": "Атрибут uid",
	"pages.administration.ldap.users.uuid.info":
		"Подальше призначення відбувається через UUID користувача. Тому його не можна змінювати.",
	"pages.administration.ldap.users.uuid.title": "Атрибут uuid",
	"pages.administration.ldapEdit.roles.headLines.sectionDescription":
		"Надалі виявлені користувачі мають бути призначені попередньо визначеним ролям $longname",
	"pages.administration.ldapEdit.roles.headLines.title": "Ролі користувачів",
	"pages.administration.ldapEdit.roles.info.admin": "Наприклад: cn=admin,ou=rollen,o=schule,dc=de",
	"pages.administration.ldapEdit.roles.info.student": "Наприклад: cn=schueler,ou=rollen,o=schule,dc=de",
	"pages.administration.ldapEdit.roles.info.teacher": "Наприклад: cn=lehrer,ou=rollen,o=schule,dc=de",
	...
	"pages.administration.ldapEdit.roles.labels.radio.userAttribute": "Атрибут користувача",
	"pages.administration.ldapEdit.roles.labels.student": "Значення атрибуту для учня",
	"pages.administration.ldapEdit.roles.labels.teacher": "Значення атрибуту для викладача",
	"pages.administration.ldapEdit.roles.labels.user": "Значення атрибуту для користувача",
	"pages.administration.ldapEdit.roles.placeholder.admin": "Значення атрибуту для адміністратора",
	"pages.administration.ldapEdit.roles.placeholder.member": "Атрибут ролі",
	"pages.administration.ldapEdit.roles.placeholder.student": "Значення атрибуту для учня",
	"pages.administration.ldapEdit.roles.placeholder.teacher": "Значення атрибуту для викладача",
	"pages.administration.ldapEdit.roles.placeholder.user": "Значення атрибуту для користувача",
	"pages.administration.ldapEdit.validation.path": "Має відповідати дійсному формату шляху LDAP",
	"pages.administration.ldapEdit.validation.url": "Має відповідати дійсному формату URL-адреси",
	"pages.administration.migration.back": "Назад",
	"pages.administration.migration.clearAutoMatches": "Скинути автоматичні ярлики",
	"pages.administration.migration.backToAdministration": "Повернутися до адміністрації",
	"pages.administration.migration.brbSchulportal": "weBBSchule",
	"pages.administration.migration.cannotStart":
		"Міграція не може початися. Школа не перебуває в режимі міграції чи фазі переведення.",
	"pages.administration.migration.confirm":
		"Я підтверджую, що призначення локальних облікових записів користувачів було перевірено, і перенесення можна здійснити.",
	"pages.administration.migration.error": "Сталася помилка. Повторіть спробу пізніше.",
	"pages.administration.migration.finishTransferPhase": "Трансферфаза від мене",
	"pages.administration.migration.finishWizard": "Повний помічник з міграції",
	"pages.administration.migration.ldapSource": "LDAP",
	"pages.administration.migration.migrate": "Зберегти прив'язку облікового запису",
	"pages.administration.migration.nbc.migrate": "Виконати міграцію",
	"pages.administration.migration.next": "Далі",
	"pages.administration.migration.performingMigration": "Збереження прив'язки облікових записів...",
	"pages.administration.migration.startUserMigration": "Почніть міграцію облікових записів",
	...
	"pages.administration.migration.step4.bullets.classes": "З {source} ще не було імпортовано жодного класу.",
	"pages.administration.migration.step4.bullets.linkedUsers":
		"Користувачі, чиї облікові записи були пов'язані, вже можуть входити в систему, використовуючи свої дані доступу {source}. Однак, персональні дані цих користувачів (ПІБ, дата народження, ролі, класи тощо) ще не актуалізовані з {source}.",
	"pages.administration.migration.step4.bullets.newUsers":
		"Нові облікові записи користувачів поки що не створюються. Користувачі, які не мають облікового запису в {instance} і мають бути імпортовані майстром міграції, поки що не можуть увійти в систему.",
	"pages.administration.migration.step4.bullets.oldUsers":
		"Облікові записи неприв'язаних користувачів не були змінені і можуть бути видалені при необхідності (при необхідності зверніться до служби підтримки).",
	"pages.administration.migration.step4.endTransferphase":
		"Будь ласка, завершіть фазу передачі зараз, щоб школа була активована для синхронізації. Синхронізація відбувається щогодини.",
	"pages.administration.migration.step4.linkingFinished":
		"Відбулося зв'язування облікових записів користувачів {source} з обліковими записами користувачів dBildungscloud.",
	"pages.administration.migration.step4.nbc.linkingFinished":
		"Облікові записи користувачів {source} було пов’язано з обліковими записами користувачів {instance}. {totalMatched} облікових записів користувачів пов’язано.",
	"pages.administration.migration.step4.transferphase":
		"Зараз школа перебуває на етапі переведення (аналогічно зміні навчального року). На цій фазі синхронізація не проводиться. Це означає:",
	"pages.administration.migration.step4": "Фаза перенесення",
	"pages.administration.migration.step5.afterSync.bullet1":
		"Пов'язані облікові записи користувачів: Користувачі можуть увійти в систему, використовуючи свої облікові дані {source}. Персональні дані цих користувачів надходять з {source} (ПІБ, дата народження, роль, заняття тощо).",
	"pages.administration.migration.step5.afterSync.bullet2": "Створено нові облікові записи користувачів.",
	"pages.administration.migration.step5.afterSync":
		"Після запуску синхронізації зв'язування облікових записів користувачів {source} та {instance} буде завершено. Це означає:",
	"pages.administration.migration.step5.nbc.bullet1":
		"Пов’язані облікові записи користувачів: користувачі можуть входити за допомогою своїх облікових даних {source}. Особисті дані цих користувачів беруться з {source} і, якщо необхідно, оновлюються під час кожного процесу входу (ім’я, дата народження, роль, класи тощо).",
	"pages.administration.migration.step5.nbc.linkingFinished":
		"Вибрані облікові записи користувачів {instance} було пов’язано з відповідними обліковими записами користувачів {source}.",
	"pages.administration.migration.step5.syncReady1": "Наразі школа готова до запуску синхронізації.",
	...
	"pages.administration.migration.summary.firstParagraph": "Було зроблено такі призначення:",
	...
	"pages.administration.migration.title": "Перенести облікові записи користувачів із",
	...
	"pages.administration.school.index.authSystems.addLdap": "Додати систему LDAP",
	...
	"pages.administration.school.index.authSystems.type": "Тип",
	"pages.administration.school.index.back": "Для деяких налаштувань ",
	"pages.administration.school.index.backLink": "поверніться до старої сторінки адміністрування тут",
	"pages.administration.school.index.error.gracePeriodExceeded": "Пільговий період після завершення міграції минув",
	"pages.administration.school.index.error": "Під час завантаження школи сталася помилка",
	...
	"pages.administration.school.index.generalSettings.labels.cloudStorageProvider":
		"Постачальник послуг хмарного сховища",
	"pages.administration.school.index.generalSettings.labels.language": "Мова",
	"pages.administration.school.index.generalSettings.labels.nameOfSchool": "Назва школи",
	"pages.administration.school.index.generalSettings.labels.schoolYear": "Навчальний рік",
	"pages.administration.school.index.generalSettings.labels.schoolNumber": "Номер школи",
	"pages.administration.school.index.generalSettings.labels.timezone": "Часовий пояс",
	"pages.administration.school.index.generalSettings.labels.uploadSchoolLogo": "Завантажити логотип школи",
	...
	"pages.administration.school.index.generalSettings.save": "Зберегти налаштування",
	"pages.administration.school.index.generalSettings.save.success": "Загальні налаштування успішно збережено.",
	...
	"pages.administration.school.index.privacySettings.labels.aiTutor": "Активуйте репетитора ШІ в школі",
	...
	"pages.administration.school.index.privacySettings.longText.studentVisibilityBrandenburg":
		"Увімкнення цієї опції вмикає видимість всіх учнів цієї школи для кожного вчителя.",
	...
	"pages.administration.school.index.schoolIsCurrentlyDrawing": "Ваша школа зараз отримує",
	"pages.administration.school.index.schoolPolicy.cancel": "Скасувати",
	"pages.administration.school.index.schoolPolicy.delete.success": "Файл Політики конфіденційності успішно видалено.",
	"pages.administration.school.index.schoolPolicy.delete.text":
		"Якщо ви видалите цей файл, буде автоматично застосована Політика конфіденційності за замовчуванням.",
	"pages.administration.school.index.schoolPolicy.delete.title": "Видалити політику конфіденційності",
	"pages.administration.school.index.schoolPolicy.download": "Завантажте політику конфіденційності",
	"pages.administration.school.index.schoolPolicy.edit": "Редагувати політику конфіденційності",
	...
	"pages.administration.school.index.schoolPolicy.notUploadedYet": "Ще не завантажено",
	"pages.administration.school.index.schoolPolicy.replace": "Замінити",
	"pages.administration.school.index.schoolPolicy.success": "Новий файл успішно завантажено.",
	"pages.administration.school.index.schoolPolicy.uploadedOn": "Завантажено {date}",
	"pages.administration.school.index.schoolPolicy.validation.fileTooBig":
		"Розмір файлу перевищує 4 МБ. Будь ласка, зменшіть розмір файлу",
	"pages.administration.school.index.schoolPolicy.validation.notPdf":
		"Цей формат файлу не підтримується. Будь ласка, використовуйте тільки PDF",
	"pages.administration.school.index.termsOfUse.cancel": "Скасувати",
	"pages.administration.school.index.termsOfUse.delete.success": "Файл Умов використання успішно видалено.",
	"pages.administration.school.index.termsOfUse.delete.text":
		"Якщо ви видалите цей файл, будуть автоматично застосовані Умови використання за замовчуванням.",
	...
	"pages.administration.school.index.termsOfUse.notUploadedYet": "Ще не завантажено",
	"pages.administration.school.index.termsOfUse.replace": "Замінити",
	"pages.administration.school.index.termsOfUse.success": "Новий файл успішно завантажено.",
	"pages.administration.school.index.termsOfUse.uploadedOn": "Завантажено {date}",
	...
	"pages.administration.school.index.termsOfUse.validation.notPdf":
		"Цей формат файлу не підтримується. Будь ласка, використовуйте тільки PDF",
	"pages.administration.school.index.title": "Керувати школою",
	"pages.administration.school.index.usedFileStorage": "Використовуване файлове сховище у хмарі",
	"pages.administration.select": "вибрати",
	"pages.administration.selected": "вибрано",
	"pages.administration.sendMail.alreadyRegistered":
		"Реєстраційний лист не було надіслано, оскільки реєстрація вже відбулася",
	...
	"pages.administration.students.consent.input.missing": "Дата народження відсутня",
	"pages.administration.students.consent.print.title": "Реєстрацію успішно завершено",
	"pages.administration.students.consent.print": "Надрукувати список з даними доступу",
	"pages.administration.students.consent.steps.complete.info":
		"Переконайтеся, що дати народження всіх користувачів заповнені, і за необхідності додайте відсутні дані.",
	"pages.administration.students.consent.steps.complete.inputerror": "Відсутня дата народження",
	"pages.administration.students.consent.steps.complete.next": "Застосувати дані",
	"pages.administration.students.consent.steps.complete.warn":
		"Не всі користувачі мають дійсні дати народження. Спершу введіть відсутні дані про народження.",
	"pages.administration.students.consent.steps.complete": "Додати дані",
	"pages.administration.students.consent.steps.download.explanation":
		"Це паролі для початкового входу до шкільної хмари.\nДля першого входу потрібно вибрати новий пароль. Учні, яким виповнилося не менше 14 років, також повинні заявити про свою згоду при першому вході до системи.",
	"pages.administration.students.consent.steps.download.info":
		"Збережіть і надрукуйте список та роздайте його користувачам під час їхньої першої реєстрації.",
	"pages.administration.students.consent.steps.download.next": "Завантажити дані доступу",
	"pages.administration.students.consent.steps.download": "Завантажити дані доступу",
	"pages.administration.students.consent.steps.register.analog-consent": "аналогова форма згоди",
	"pages.administration.students.consent.steps.register.confirm.warn":
		"Підтвердьте, що ви отримали письмові форми згоди від батьків та учнів, та що ви ознайомилися з правилами отримання згоди.",
	"pages.administration.students.consent.steps.register.confirm":
		"Цим я підтверджую, що отримав(-ла) письмову {analogConsent} від батьків вищезгаданих учнів.",
	"pages.administration.students.consent.steps.register.info":
		"Перш ніж реєструватися від імені користувачів, перевірте, чи ви отримали згоду перерахованих студентів за допомогою супровідних матеріалів.",
	"pages.administration.students.consent.steps.register.next": "Зареєструвати користувачів",
	"pages.administration.students.consent.steps.register.print":
		"Тепер ви можете увійти в хмару за допомогою початкового пароля. Перейдіть до {hostName} та увійдіть, використовуючи наступні дані доступу:",
	"pages.administration.students.consent.steps.register.success": "Користувача успішно зареєстровано",
	"pages.administration.students.consent.steps.register": "Провести реєстрацію",
	"pages.administration.students.consent.steps.success.back": "Повернутися до огляду",
	"pages.administration.students.consent.steps.success.image.alt": "Надійне підключення графіки",
	"pages.administration.students.consent.steps.success": "Вітаємо, ви успішно завершили аналогову реєстрацію!",
	"pages.administration.students.consent.table.empty": "Усі вибрані користувачі вже надали згоду.",
	"pages.administration.students.consent.title": "Зареєструвати в аналоговому форматі",
	"pages.administration.students.fab.add": "Створити студента",
	"pages.administration.students.fab.import": "Імпорт учнів",
	"pages.administration.students.index.remove.confirm.message":
		"Ви бажаєте видалити цього учня / цю ученицю? | Ви бажаєте видалити цих учнів?",
	...
	"pages.administration.students.index.tableActions.email": "Надіслати посилання на реєстрацію електронною поштою",
	"pages.administration.students.index.tableActions.qr": "Видрукувати посилання на реєстрацію у вигляді QR-коду",
	"pages.administration.students.index.tableActions.registration": "Ручна реєстрація",
	"pages.administration.students.index.title": "Керувати учнями",
	"pages.administration.students.infobox.headline": "Повні реєстрації",
	"pages.administration.students.infobox.LDAP.helpsection": "Розділ довідки",
	"pages.administration.students.infobox.LDAP.paragraph-1":
		"Ваша школа отримує всі дані для входу з вихідної системи (LDAP або аналогічної). Користувачі можуть увійти в шкільну хмару за допомогою імені користувача та пароля з вихідної системи.",
	"pages.administration.students.infobox.LDAP.paragraph-2":
		"Коли ви ввійдете в систему вперше, вам буде запропоновано дати свою згоду, щоб завершити реєстрацію.",
	"pages.administration.students.infobox.LDAP.paragraph-3":
		"ВАЖЛИВО: Студентам віком до 16 років під час реєстрації потрібна згода батьків. У цьому випадку переконайтеся, що перший вхід в систему відбувся в присутності одного з батьків, як правило, вдома.",
	"pages.administration.students.infobox.LDAP.paragraph-4": "Дізнайтеся більше про реєстрацію в",
	"pages.administration.students.infobox.li-1":
		"Надсилайте посилання на реєстрацію через шкільну хмару на вказані адреси електронної пошти (також це можна зробити безпосередньо під час імпорту/створення)",
	"pages.administration.students.infobox.li-2":
		"Видрукуйте посилання для реєстрації у вигляді QR-листів, виріжте їх і роздайте користувачам (або їхнім батькам)",
	"pages.administration.students.infobox.li-3":
		"Відмовитися від збирання згод у цифровій формі. Натомість використовувати письмову форму та створювати початкові паролі для своїх користувачів (докладніше)",
	"pages.administration.students.infobox.more.info": "(більше інформації)",
	"pages.administration.students.infobox.paragraph-1":
		"У вас є такі варіанти, що допоможуть користувачам завершити реєстрацію:",
	"pages.administration.students.infobox.paragraph-2":
		"Для цього виберіть одного або кількох користувачів, наприклад, всіх учнів: усередині класу. Потім виконайте потрібну дію.",
	"pages.administration.students.infobox.paragraph-3":
		"Крім того, ви можете перейти в режим редагування профілю користувача та отримати індивідуальне посилання на реєстрацію, щоб надіслати його вручну вибраним вами способом.",
	"pages.administration.students.infobox.paragraph-4":
		"ВАЖЛИВО: Для учнів молодших 16 років у процесі реєстрації перш за все потрібна згода батьків або опікунів. У цьому разі ми рекомендуємо розповсюджувати реєстраційні посилання у вигляді листів з QR-кодами або знайти окремі посилання та надіслати їх батькам. Після отримання згоди батьків учні отримують стартовий пароль та можуть самостійно пройти останню частину реєстрації у будь-який час. У початковій школі популярною альтернативою використанню шкільної хмари є паперові форми.",
	"pages.administration.students.infobox.registrationOnly.headline": "Реєстраційна інформація",
	"pages.administration.students.infobox.registrationOnly.li-1":
		"Надсилання реєстраційних посилань на збережені адреси електронної пошти (також можливо безпосередньо під час імпорту/створення)",
	"pages.administration.students.infobox.registrationOnly.li-2":
		"Роздрукуйте посилання на реєстрацію як аркуші для QR-друку, виріжте їх і роздайте QR-бланки учням",
	"pages.administration.students.infobox.registrationOnly.li-3":
		"Виберіть одного або кількох користувачів, напр. усіх учнів класу, а потім виконайте потрібну дію",
	...
	"pages.administration.students.infobox.registrationOnly.paragraph-1":
		"При реєстрації студентів декларацію про згоду отримувати не потрібно. Використання Schul-Cloud Brandenburg регулюється Бранденбурзьким шкільним законом (§ 65 параграф 2 BbGSchulG).",
	"pages.administration.students.infobox.registrationOnly.paragraph-2":
		"Якщо школа отримує або отримує дані користувача через зовнішню систему, наведені вище параметри не можна використовувати. Потім відповідні зміни потрібно внести у вихідну систему.",
	"pages.administration.students.infobox.registrationOnly.paragraph-3":
		"В іншому випадку запрошення до реєстрації можна надіслати за посиланням із області хмарного адміністрування:",
	"pages.administration.students.legend.icon.success": "Реєстрацію завершено",
	"pages.administration.students.manualRegistration.steps.download.explanation":
		"Це паролі для початкового входу до шкільної хмари. Для першого входу потрібно вибрати новий пароль",
	"pages.administration.students.manualRegistration.steps.success": "Вітаємо, ви успішно пройшли аналогову реєстрацію!",
	"pages.administration.students.manualRegistration.title": "Ручна реєстрація",
	"pages.administration.students.new.checkbox.label": "Надіслати учню посилання на реєстрацію",
	"pages.administration.students.new.error": "Не вдалося додати учня. Можливо, адреса електронної пошти вже існує.",
	...
	"pages.administration.teachers.index.remove.confirm.message":
		"Ви бажаєте видалити цього вчителя? | Ви бажаєте видалити цих вчителів?",
	...
	"pages.administration.teachers.index.tableActions.qr": "Видрукувати посилання для реєстрації як QR-код",
	"pages.administration.teachers.index.title": "Керувати викладачами",
	"pages.administration.teachers.new.checkbox.label": "Надіслати викладачеві посилання на реєстрацію",
	"pages.administration.teachers.new.error": "Не вдалося додати вчителя. Можливо, адреса електронної пошти вже існує.",
	...
	"pages.files.overview.courseFiles": "Файли мого курсу",
	...
	"pages.files.personal.uploadError": "Не вдалося завантажити файл.",
	"pages.files.legacy.folders": "Каталог",
	"pages.files.legacy.files": "Файли",
	"pages.files.legacy.createFolder": "Створити новий каталог",
	"pages.files.legacy.newFolderTitle": "Новий каталог",
	"pages.files.legacy.folderName": "Назва каталогу",
	"pages.files.legacy.createFolderSubmit": "Створити каталог",
	"pages.files.legacy.renameFolder": "Перейменувати каталог",
	"pages.files.legacy.renameFile": "Перейменувати файл",
	"pages.files.legacy.renameDirTitle": "Перейменувати каталог",
	"pages.files.legacy.chooseNewName": "Виберіть нове ім'я:",
	"pages.files.legacy.deleteFile": "Видалити файл",
	"pages.files.legacy.deleteFolder": "Видалити каталог",
	"pages.files.legacy.assertDeletion": "Ви впевнені, що хочете видалити «{filename}»?",
	"pages.files.legacy.downloadFile": "Завантажити файл",
	"pages.files.legacy.shareFile": "Поширити файл",
	"pages.files.legacy.shareLinkTitle": "Поширити посилання",
	"pages.files.legacy.shareLinkHint": "Поширте наведене нижче посилання, щоб надати доступ до файлу.",
	"pages.files.legacy.editPermissions": "Редагувати права доступу до файлу",
	"pages.files.legacy.editPermissionsTitle": "Редагувати дозволи",
	"pages.files.legacy.roleUser": "Роль / користувач",
	"pages.files.legacy.read": "Читати",
	"pages.files.legacy.write": "Записати",
	"pages.files.legacy.noPermissions": "Немає дозволів на редагування.",
	"pages.files.legacy.permissionsError": "На жаль, під час отримання дозволів сталася помилка.",
	"pages.files.legacy.permissionsSaved": "Дозволи для файлу успішно змінено",
	"pages.files.legacy.renameDirSuccess": "Каталог успішно перейменовано!",
	"pages.files.legacy.renameFileSuccess": "Файл успішно перейменовано!",
	"pages.files.legacy.fileMoved": "Файл успішно переміщено!",
	"pages.files.legacy.fileBlocked": "Файл може містити шкідливий вміст",
	"pages.files.legacy.dangerousCode": "Зловмисний код",
	"pages.files.legacy.personalTitle": "Персональні файли",
	"pages.files.legacy.courseTitle": "Файли курсу",
	"pages.files.legacy.teamTitle": "Файли команди",
	"pages.files.legacy.sharedTitle": "Поширені файли",
	"pages.files.legacy.myPersonalData": "Мої персональні файли",
	"pages.files.legacy.filesFromMyCourse": "Файли з моїх курсів",
	"pages.files.legacy.filesFromMyTeam": "Файли моїх команд",
	"pages.files.legacy.filesSharedWithMe": "Файли, якими поділилися зі мною",
	"pages.files.legacy.noAccess": "Ви не маєте доступу до цього файлу!",
	"pages.files.legacy.selectFolder": "Вибрати каталог",
	"pages.files.legacy.uploadHint": "Розмістіть тут файли для завантаження або здійсніть пошук на комп’ютері",
	"pages.files.legacy.uploading": "Завантажено файли",
	"pages.files.legacy.toTeam": "До команди",
	"pages.files.legacy.toCourse": "До курсу",
	"pages.files.legacy.sortBy": "Сортувати за...",
	"pages.files.legacy.sort.createdAt": "Дата створення",
	"pages.files.legacy.sort.updatedAt": "Дата модифікації",
	"pages.files.legacy.sort.name": "Ім'я файлу",
	"pages.files.legacy.sort.size": "Розмір",
	"pages.files.legacy.openFolder": "відкрити каталог {name}",
	"pages.files.legacy.openFile": "відкрити файл {name}",
	"pages.files.legacy.close": "Закрити",
	"pages.files.legacy.uploadSuccess": "Файл(и) успішно збережено.",
	"pages.files.legacy.openError": "Помилка під час відкриття файлу",
	"pages.files.legacy.dirExists": "Каталог з такою назвою вже існує в тому самому каталозі!",
	"pages.files.legacy.sorting": "Сортування",
	"pages.files.legacy.role.teacher": "Викладач",
	"pages.files.legacy.role.student": "Учні",
	"pages.files.legacy.role.teammember": "Учасник",
	"pages.files.legacy.role.teamexpert": "Експерт",
	"pages.files.legacy.role.teamleader": "Лідер",
	"pages.files.legacy.role.teamadministrator": "Адміністратор",
	"pages.files.legacy.role.teamowner": "Власник",
	"pages.files.legacy.myPersonalDataContent":
		"Тут можна знайти всі ваші персональні файли. Тільки ви маєте доступ до цих файлів, але ви також можете поширити їх іншим користувачам.",
	"pages.files.legacy.filesSharedWithMeContent":
		"Тут можна знайти всі файли, якими з вами поділилися. Це файли, надані іншими користувачами.",
	"pages.files.legacy.copyLink": "Копіювати посилання",
	"pages.files.legacy.linkCopied": "Посилання скопійовано в буфер обміну",
	"pages.files.legacy.moveFile": "Перемістити файл",
	"pages.files.legacy.moveFolder": "Перемістити папку",
	"pages.files.legacy.moveError": "Не вдалося перемістити файл.",
	"pages.files.legacy.actionError": "Не вдалося виконати дію.",
	...
	"pages.room.copy.course.message.partiallyCopied": "Повністю скопіювати курс не вдалося.",
	...
	"pages.tasks.due": "Дедлайн",
	"pages.tasks.overdue": "Прострочено",
	...
	"pages.rooms.members.dialog.addExternalPerson.steps.email.error.userNotExternal":
		"Запрошення електронною поштою неможливе. Будь ласка, перевірте необхідні {link}.",
	"pages.rooms.members.dialog.addExternalPerson.steps.email.error.userNotExternal.requirements": "вимоги",
	...
	"pages.rooms.importCourse.importError":
		"На жаль, нам не вдалося імпортувати весь вміст курсу. Ми знаємо про помилку й виправимо її в найближчі місяці.",
	"pages.rooms.importCourse.importErrorButton": "Гаразд, зрозуміло",
	...
	"pages.rooms.importCourse.step_2": "Вставте код сюди, щоб імпортувати спільний курс.",
	...
	"pages.roomCreate.templates.title": "Із чого почнемо?",
	"pages.roomCreate.templates.subtitle":
		"Оберіть шаблон. Усе в ньому згодом можна перейменувати, перемістити та видалити.",
	"pages.roomCreate.templates.change": "Змінити шаблон",
	"pages.roomCreate.templates.preview.title": "Буде створено",
	...
	"pages.roomCreate.templates.element.text": "Текст",
	"pages.roomCreate.templates.element.link": "Посилання",
	"pages.roomCreate.templates.element.boardLink": "Посилання на розділ",
	"pages.roomCreate.templates.element.folder": "Тека файлів",
	"pages.roomCreate.templates.element.drawing": "Дошка для малювання",
	"pages.roomCreate.templates.element.collaborative": "Спільний текстовий документ",
	"pages.roomCreate.templates.element.videoConference": "Відеоконференція",
	"pages.roomCreate.templates.folder.material": "Тека матеріалів",
	"pages.roomCreate.templates.folder.results": "Тека для здачі робіт",
	"pages.roomCreate.templates.folder.parents": "Листи для батьків",
	"pages.roomCreate.templates.folder.minutes": "Протоколи",
	"pages.roomCreate.templates.subject.cards.links.text":
		"<p>Сюди пасують посилання на пояснювальні відео, тренувальні сайти та довідники.</p>",
	"pages.roomCreate.templates.project.cards.ideas.title": "Збір ідей",
	"pages.roomCreate.templates.project.cards.ideas.text": "<p>Зберіть і впорядкуйте перші ідеї на дошці.</p>",
	"pages.roomCreate.templates.classroom.cards.toOrganisation.title": "До організації класу",
	"pages.roomCreate.templates.team.cards.latest.conference": "Зустріч команди",
	...
	"pages.roomCreate.templates.params.weeks": "Кількість тижнів",
	"pages.roomCreate.templates.params.projectName": "Назва проєкту",
	"pages.roomCreate.templates.params.groups": "Кількість груп",
	"pages.roomCreate.templates.params.className": "Клас",
	"pages.roomCreate.templates.params.topic": "Тема",
	"pages.roomCreate.templates.weeklyPlan.columns.week": "Тиждень {index}",
	"pages.roomCreate.templates.project.cards.group.title": "Група {index}",
	"pages.roomCreate.templates.project.cards.group.text": "<p>Завдання, обов'язки та поточний стан групи {index}.</p>",
	"pages.roomCreate.templates.blank.title": "Порожня кімната",
	"pages.roomCreate.templates.blank.description": "Почати без шаблону та створити розділи самостійно.",
	"pages.roomCreate.templates.subject.title": "Предметна кімната",
	"pages.roomCreate.templates.subject.description":
		"Кімната для одного предмета на весь навчальний рік: організація, матеріали, завдання та дати.",
	"pages.roomCreate.templates.subject.roomName": "{subject} {grade}",
	"pages.roomCreate.templates.subject.boards.overview": "Огляд",
	"pages.roomCreate.templates.subject.columns.organisation": "Організаційне",
	"pages.roomCreate.templates.subject.columns.material": "Матеріали",
	"pages.roomCreate.templates.subject.columns.tasks": "Завдання",
	"pages.roomCreate.templates.subject.columns.dates": "Дати та контрольні",
	"pages.roomCreate.templates.subject.cards.welcome.title": "Вітаємо",
	"pages.roomCreate.templates.subject.cards.welcome.text":
		"<p>Вітаємо на предметі {subject}! Тут ви знайдете все важливе.</p><p>Замініть цей текст власним привітанням.</p>",
	"pages.roomCreate.templates.subject.cards.rules.title": "Правила та оцінювання",
	"pages.roomCreate.templates.subject.cards.rules.text":
		"<ul><li>Із чого складається оцінка?</li><li>Які матеріали потрібні?</li><li>Які правила діють на уроці?</li></ul>",
	"pages.roomCreate.templates.subject.cards.material.title": "Конспекти та робочі аркуші",
	"pages.roomCreate.templates.subject.cards.material.text":
		"<p>Завантажте файли або додайте посилання на матеріали.</p>",
	"pages.roomCreate.templates.subject.cards.links.title": "Добірка посилань",
	"pages.roomCreate.templates.subject.cards.currentTask.title": "Поточне завдання",
	"pages.roomCreate.templates.subject.cards.currentTask.text":
		"<p><strong>Завдання:</strong> …</p><p><strong>Термін здачі:</strong> …</p>",
	"pages.roomCreate.templates.subject.cards.nextDates.title": "Найближчі дати",
	"pages.roomCreate.templates.subject.cards.nextDates.text":
		"<ul><li>Контрольна робота: …</li><li>Екскурсія: …</li></ul>",
	"pages.roomCreate.templates.weeklyPlan.title": "Тижневий план",
	"pages.roomCreate.templates.weeklyPlan.description":
		"Тижневий ритм з одного погляду: цей тиждень, наступний, допоміжні матеріали та виконане.",
	"pages.roomCreate.templates.weeklyPlan.roomName": "Тижневий план {subject}",
	"pages.roomCreate.templates.weeklyPlan.boards.week": "Тижневий план",
	"pages.roomCreate.templates.weeklyPlan.columns.help": "Матеріали та допомога",
	"pages.roomCreate.templates.weeklyPlan.columns.done": "Виконано",
	"pages.roomCreate.templates.weeklyPlan.cards.goals.title": "Навчальні цілі",
	"pages.roomCreate.templates.weeklyPlan.cards.goals.text": "<ul><li>Я вмію …</li><li>Я вмію …</li></ul>",
	"pages.roomCreate.templates.weeklyPlan.cards.tasks.title": "Завдання тижня",
	"pages.roomCreate.templates.weeklyPlan.cards.tasks.text": "<ol><li>…</li><li>…</li></ol>",
	"pages.roomCreate.templates.weeklyPlan.cards.help.title": "Пояснення та відео",
	"pages.roomCreate.templates.weeklyPlan.cards.help.text": "<p>Тут зібрані матеріали для самостійної роботи.</p>",
	"pages.roomCreate.templates.weeklyPlan.cards.archive.title": "Архів",
	"pages.roomCreate.templates.weeklyPlan.cards.archive.text": "<p>Перетягуйте сюди виконані картки.</p>",
	"pages.roomCreate.templates.project.title": "Проєкт і групова робота",
	"pages.roomCreate.templates.project.description":
		"Від завдання проєкту до презентації – для проєктних тижнів і групових робіт.",
	"pages.roomCreate.templates.project.roomName": "{projectName}",
	"pages.roomCreate.templates.project.boards.project": "Дошка проєкту",
	"pages.roomCreate.templates.project.columns.briefing": "Завдання проєкту",
	"pages.roomCreate.templates.project.columns.todo": "Треба зробити",
	"pages.roomCreate.templates.project.columns.doing": "У роботі",
	"pages.roomCreate.templates.project.columns.done": "Готово",
	"pages.roomCreate.templates.project.columns.results": "Результати",
	"pages.roomCreate.templates.project.cards.goal.title": "Мета та ключове запитання",
	"pages.roomCreate.templates.project.cards.goal.text":
		"<p><strong>Ключове запитання:</strong> …</p><p><strong>Результат:</strong> …</p>",
	"pages.roomCreate.templates.project.cards.team.title": "Команда та ролі",
	"pages.roomCreate.templates.project.cards.team.text":
		"<ul><li>Керівництво проєктом: …</li><li>Пошук інформації: …</li><li>Презентація: …</li></ul>",
	"pages.roomCreate.templates.project.cards.schedule.title": "Графік",
	"pages.roomCreate.templates.project.cards.schedule.text":
		"<ul><li>Початок: …</li><li>Проміжний результат: …</li><li>Здача: …</li></ul>",
	"pages.roomCreate.templates.project.cards.presentation.title": "Презентація та відгуки",
	"pages.roomCreate.templates.project.cards.presentation.text": "<p>Збирайте результати, презентації та відгуки.</p>",
	"pages.roomCreate.templates.classroom.title": "Класна кімната",
	"pages.roomCreate.templates.classroom.description":
		"Для класного керівництва: новини, організація класу, дати та інформація для батьків.",
	"pages.roomCreate.templates.classroom.roomName": "Клас {className}",
	"pages.roomCreate.templates.classroom.boards.news": "Новини",
	"pages.roomCreate.templates.classroom.boards.organisation": "Організація класу",
	"pages.roomCreate.templates.classroom.columns.announcements": "Оголошення",
	"pages.roomCreate.templates.classroom.columns.duties": "Чергування",
	"pages.roomCreate.templates.classroom.columns.rules": "Правила та домовленості",
	"pages.roomCreate.templates.classroom.columns.dates": "Дати та екскурсії",
	"pages.roomCreate.templates.classroom.columns.parents": "Для батьків",
	"pages.roomCreate.templates.classroom.cards.welcome.title": "Вітаємо в нашому класі",
	"pages.roomCreate.templates.classroom.cards.welcome.text":
		"<p>Актуальна інформація для класу {className} – найважливіше зверху.</p>",
	"pages.roomCreate.templates.classroom.cards.thisWeek.title": "Цей тиждень",
	"pages.roomCreate.templates.classroom.cards.thisWeek.text": "<ul><li>Понеділок: …</li><li>Вівторок: …</li></ul>",
	"pages.roomCreate.templates.classroom.cards.dutyPlan.title": "Графік чергувань",
	"pages.roomCreate.templates.classroom.cards.dutyPlan.text":
		"<ul><li>Чергування біля дошки: …</li><li>Чергування з порядку: …</li></ul>",
	"pages.roomCreate.templates.classroom.cards.classRules.title": "Наші правила класу",
	"pages.roomCreate.templates.classroom.cards.classRules.text": "<ol><li>…</li><li>…</li></ol>",
	"pages.roomCreate.templates.classroom.cards.nextDates.title": "Найближчі дати",
	"pages.roomCreate.templates.classroom.cards.parentInfo.title": "Інформація для батьків",
	"pages.roomCreate.templates.classroom.cards.parentInfo.text":
		"<p>Батьківські збори, формуляри та контактні особи.</p>",
	"pages.roomCreate.templates.team.title": "Методичне об'єднання та команда",
	"pages.roomCreate.templates.team.description":
		"Співпраця в колективі: оголошення, матеріали, протоколи та обов'язки.",
	"pages.roomCreate.templates.team.roomName": "Методичне об'єднання {subject}",
	"pages.roomCreate.templates.team.boards.team": "Кімната команди",
	"pages.roomCreate.templates.team.columns.announcements": "Оголошення",
	"pages.roomCreate.templates.team.columns.material": "Матеріали та навчальна програма",
	"pages.roomCreate.templates.team.columns.minutes": "Протоколи та рішення",
	"pages.roomCreate.templates.team.columns.tasks": "Завдання та обов'язки",
	"pages.roomCreate.templates.team.cards.latest.title": "Актуальне",
	"pages.roomCreate.templates.team.cards.latest.text": "<p>Короткі новини для команди.</p>",
	"pages.roomCreate.templates.team.cards.curriculum.title": "Навчальна програма школи",
	"pages.roomCreate.templates.team.cards.curriculum.text":
		"<p>Навчальні плани, добірки матеріалів і домовленості щодо предмета.</p>",
	"pages.roomCreate.templates.team.cards.lastMeeting.title": "Остання зустріч",
	"pages.roomCreate.templates.team.cards.lastMeeting.text":
		"<p><strong>Дата:</strong> …</p><p><strong>Рішення:</strong> …</p>",
	"pages.roomCreate.templates.team.cards.responsibilities.title": "Хто що робить?",
	"pages.roomCreate.templates.team.cards.responsibilities.text":
		"<ul><li>Добірка матеріалів: …</li><li>Замовлення матеріалів: …</li></ul>",
	"pages.roomCreate.templates.selfStudy.title": "Модуль самостійного навчання",
	"pages.roomCreate.templates.selfStudy.description":
		"Навчальний шлях у чотири кроки: вступ, опрацювання, вправи та закріплення.",
	"pages.roomCreate.templates.selfStudy.roomName": "Модуль самостійного навчання {topic}",
	"pages.roomCreate.templates.selfStudy.boards.path": "Навчальний шлях",
	"pages.roomCreate.templates.selfStudy.columns.intro": "1 – Вступ",
	"pages.roomCreate.templates.selfStudy.columns.learn": "2 – Опрацювання",
	"pages.roomCreate.templates.selfStudy.columns.practice": "3 – Вправи",
	"pages.roomCreate.templates.selfStudy.columns.secure": "4 – Закріплення",
	"pages.roomCreate.templates.selfStudy.cards.hook.title": "Вступ",
	"pages.roomCreate.templates.selfStudy.cards.hook.text":
		"<p>Із чого учні починають вивчати {topic}: відео, зображення чи запитання?</p>",
	"pages.roomCreate.templates.selfStudy.cards.input.title": "Матеріали та вхідні дані",
	"pages.roomCreate.templates.selfStudy.cards.input.text":
		"<p>Тексти, відео та пояснення для самостійного опрацювання.</p>",
	"pages.roomCreate.templates.selfStudy.cards.exercises.title": "Вправи",
	"pages.roomCreate.templates.selfStudy.cards.exercises.text":
		"<ol><li>Базове завдання</li><li>Поглиблення</li><li>Додаткове завдання для тих, хто впорався швидше</li></ol>",
	"pages.roomCreate.templates.selfStudy.cards.check.title": "Самоперевірка",
	"pages.roomCreate.templates.selfStudy.cards.check.text":
		"<ul><li>Тепер я вмію: …</li><li>Мені ще потрібна допомога з: …</li></ul>",
	...
	"pages.roomDetails.fab.add.board": "Створити дошку",
	...
	"pages.rooms.members.add.students.studentAdmins": "Учні можуть додавати до кімнати лише учнів зі свого класу.",
	...
	"pages.rooms.members.actionMenu.selectedMembers": "Меню дій для {count} вибраних учасників",
	"pages.rooms.members.changePermission": "Змінити дозволи кімнат",
	"pages.rooms.members.changePermission.ariaLabel": "Змінити дозвіл кімнат для {memberFullName}",
	...
	"pages.rooms.members.resetSelection.ariaLabel": "Скинути вибраних членів зі списку",
	"pages.rooms.members.multipleRemove.ariaLabel": "Видалити кількох членів із кімнати",
	"pages.rooms.members.remove.confirmation":
		"{memberFullName} буде видалено з цієї кімнати. Ви впевнені, що хочете видалити?",
	"pages.rooms.members.multipleRemove.confirmation": "Видалити вибраних членів із кімнати?",
	...
	"pages.rooms.members.select.none": "Видалити всіх учасників кімнати з відбору",
	...
	"pages.rooms.members.roleChange.Roomviewer.label": "Доступ до зон кімнати та перегляд вмісту",
	"pages.rooms.members.roleChange.Roomeditor.label": "Створюйте та редагуйте контент",
	...
	"pages.rooms.members.roleChange.Roomowner.label": "Ті самі повноваження, що й «Керування», плюс видалення кімнати",
	"pages.rooms.members.roleChange.dialogTitle.handOver": "Дозвіл на кімнату «Власність» дійсно передано?",
	...
	"pages.rooms.members.handOverAlert.label": "Дозволи цієї кімнати передаються {memberFullName}.",
	...
	"pages.rooms.members.invitationTable.multipleDelete.confirmation": "Видалити вибрані посилання на запрошення?",
	"pages.rooms.members.invitationTable.delete.confirmation": "Видалити посилання на запрошення '{invitation}'?",
	"pages.rooms.members.invitationTable.shareButton.ariaLabel": "Поділіться посиланням на запрошення „{linkTitle}“",
	"pages.rooms.members.confirmationTable.menus.confirm.label": "Підтвердити заявку на участь",
	"pages.rooms.members.confirmationTable.menus.reject.label": "Відхилити запит на реєстрацію",
	"pages.rooms.members.confirmationTable.notification.confirm": "{fullName} був доданий як член кімнати.",
	"pages.rooms.members.confirmationTable.notification.reject": "Запит {fullName} на приєднання було відхилено.",
	...
	"pages.rooms.members.confirmationTable.notification.reject.multiple":
		"Вибрані особи були додані до кімнати як учасники.",
	"pages.rooms.members.confirmationTable.actionMenu.ariaLabel": "Меню дій для {fullName}",
	...
	"pages.rooms.administration.table.header.totalMember": "Загальна кількість учасників",
	"pages.rooms.administration.table.header.internalMember": "Внутрішні учасники",
	...
	"pages.rooms.administration.table.row.actionMenu.ariaLabel": "Меню дій для кімнати “{roomName}”",
	"pages.rooms.administration.table.actionMenu.delete": "Видалити кімнату",
	"pages.rooms.administration.table.actionMenu.manageRoom": "Керувати учасниками кімнати",
	"pages.rooms.administration.error.load": "Не вдалося завантажити список кімнат.",
	...
	"pages.tool.apiError.tool_param_duplicate":
		"Цей інструмент має принаймні один повторюваний параметр. Зверніться до служби підтримки.",
	"pages.tool.apiError.tool_param_required":
		"Вхідні дані для обов’язкових параметрів для конфігурації цього інструменту все ще відсутні. Будь ласка, введіть відсутні значення.",
	...
	"pages.tool.context.displayNameDescription": "Відображуване ім’я інструменту можна замінити та має бути унікальним",
	...
	"pages.tool.description.secondParagraph": "Видалення конфігурації видаляє інструмент із курсу.",
	"pages.tool.description.moreInformation": "Більше інформації можна знайти в нашому {0}.",
	"pages.tool.description.moreInformation.link": "Розділ довідки щодо зовнішніх інструментів",
	...
	"pages.userMigration.error.description.support": "Зверніться безпосередньо до адміністратора або {0}.",
	...
	"pages.userMigration.error.schoolNumberMismatch.information": "Будь ласка, Передайте цю інформацію:",
	...
	"pages.userMigration.success.description": "Переміщення вашого облікового запису до {targetSystem} завершено.",
	"pages.userMigration.success.description.loginAgain": "Зареєструйтеся знову.",
	"pages.userMigration.success.login": "Iniciar sesión a través de {targetSystem}",
	"pages.userMigration.success.title": "Успішна міграція вашої системи реєстрації",
	...
	"error.ws.connectionLost": "Зв'язок було перервано. Спробуйте відновити зв'язок...",
	"error.ws.connectionLost.back": "Повернутися до огляду",
	...
	"utils.adminFilter.consent.missing": "недоступно",
	"utils.adminFilter.consent.ok": "повністю",
	"utils.adminFilter.consent.parentsAgreed": "згоду надали лише батьки",
	"utils.adminFilter.consent.title": "Реєстрації",
	"utils.adminFilter.consent": "Форма згоди:",
	"utils.adminFilter.date.created": "Створено між",
	"utils.adminFilter.date.label.from": "Дата від",
	"utils.adminFilter.date.label.until": "Дата до",
	"utils.adminFilter.date.title": "Дата створення",
	"utils.adminFilter.lastMigration.label.from": "Востаннє перенесено з",
	"utils.adminFilter.lastMigration.label.until": "Востаннє перенесено до",
	"utils.adminFilter.lastMigration.title": "Востаннє перенесено",
	"utils.adminFilter.outdatedSince.label.from": "Застаріло з тих пір від",
	"utils.adminFilter.outdatedSince.label.until": "Застаріло з тих пір до",
	"utils.adminFilter.outdatedSince.title": "Застаріло з тих пір",
	"utils.adminFilter.placeholder.class": "Фільтрувати за класом...",
	"utils.adminFilter.placeholder.complete.lastname": "Фільтрувати за повним прізвищем...",
	"utils.adminFilter.placeholder.complete.name": "Фільтрувати за повним іменем...",
	...
	"feature.media-shelf.emptyState": "Наразі немає медіафайлів, доступних для використання",
	...
	"pages.folder.delete-multiple-confirmation": "Чи справді перемістити всі {total} файли до кошика?",
	"pages.folder.delete-confirmation": "Чи справді перемістити файл {name} у кошик?",
	...
	"pages.folder.trash.link": "Кошик",
	"pages.folder.trash.title": "Кошик: {folderName}",
