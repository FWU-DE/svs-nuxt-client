export default {
	...
	"global.sidebar.item.nostrSearch": "Пошук у Nostr",
	...
	"pages.nostrSearch.title": "Пошук у Nostr",
	"pages.nostrSearch.subtitle": "Шукайте відкриті освітні ресурси, нотатки та профілі в мережі Nostr.",
	"pages.nostrSearch.searchLabel": "Пошуковий запит",
	"pages.nostrSearch.searchAction": "Шукати",
	"pages.nostrSearch.mode.notes": "Нотатки",
	"pages.nostrSearch.mode.profiles": "Профілі",
	"pages.nostrSearch.disclaimer":
		"Результати надходять із публічних релеїв Nostr; ні школа, ні хмара їх не модерують і не перевіряють.",
	"pages.nostrSearch.empty": "Немає результатів. Спробуйте інший запит або додайте більше релеїв.",
	"pages.nostrSearch.resultCount": "{count} результатів",
	"pages.nostrSearch.error.tooShort": "Введіть щонайменше два символи.",
	"pages.nostrSearch.error.noRelays": "Жоден релей не активний. Увімкніть принаймні один.",
	"pages.nostrSearch.error.allRelaysFailed": "Не вдалося зʼєднатися з жодним релеєм. Спробуйте пізніше.",
	"pages.nostrSearch.relays.title": "Релеї",
	"pages.nostrSearch.relays.summary": "{active} з {total} активні",
	"pages.nostrSearch.relays.description":
		"Nostr не має центрального індексу: пошук охоплює лише ті релеї, до яких звертається. Не кожен релей підтримує повнотекстовий пошук (NIP-50).",
	"pages.nostrSearch.relays.toggle": "Увімкнути або вимкнути релей {relay}",
	"pages.nostrSearch.relays.remove": "Видалити релей {relay}",
	"pages.nostrSearch.relays.add": "Додати",
	"pages.nostrSearch.relays.addLabel": "Адреса релею (wss://)",
	"pages.nostrSearch.relays.invalid": "Введіть дійсну адресу wss://, якої ще немає у списку.",
	"pages.nostrSearch.relays.reset": "Скинути",
	"pages.nostrSearch.relay.state.searching": "Триває пошук …",
	"pages.nostrSearch.relay.state.matches": "{count} результатів",
	"pages.nostrSearch.relay.state.noSearchSupport": "Без повнотекстового пошуку (NIP-50)",
	"pages.nostrSearch.relay.error.unreachable": "Недоступний",
	"pages.nostrSearch.relay.error.timeout": "Немає відповіді",
	"pages.nostrSearch.relay.error.rejected": "Запит відхилено",
	"pages.nostrSearch.result.open": "Відкрити",
	"pages.nostrSearch.result.copy": "Копіювати ID",
	"pages.nostrSearch.result.copied": "Скопійовано",
	"pages.nostrSearch.mode.resources": "Освітні ресурси",
	"pages.nostrSearch.result.note": "Нотатка",
	"pages.nostrSearch.result.free": "Вільний доступ",
	"pages.nostrSearch.result.addToBoard": "На дошку",
	"pages.nostrSearch.board.title": "Додати на дошку",
	"pages.nostrSearch.board.description": "«{title}» буде додано як нову картку.",
	"pages.nostrSearch.board.room": "Кімната",
	"pages.nostrSearch.board.board": "Дошка",
	"pages.nostrSearch.board.empty": "У цій кімнаті немає дошки, яку ви можете редагувати.",
	"pages.nostrSearch.board.confirm": "Додати",
	"pages.nostrSearch.board.success": "Картку створено.",
	"pages.nostrSearch.board.open": "Відкрити дошку",
	"pages.nostrSearch.board.error.rooms": "Не вдалося завантажити кімнати.",
	"pages.nostrSearch.board.error.boards": "Не вдалося завантажити дошки цієї кімнати.",
	"pages.nostrSearch.board.error.add": "Не вдалося створити картку.",
	"pages.nostrSearch.board.label.source": "Джерело",
	"pages.nostrSearch.board.label.license": "Ліцензія",
	"pages.nostrSearch.board.label.via": "Знайдено через пошук у Nostr",
	"pages.nostrSearch.board.label.fallbackTitle": "Знахідка з пошуку в Nostr",
