export default {
	...
	"global.sidebar.item.formerMemberships": "Колишні членства",
	...
	"pages.formerMemberships.title": "Колишні членства",
	"pages.formerMemberships.info":
		"Після зміни школи ви втратили доступ до наведених нижче курсів/кімнат. Тут ви можете забрати копію до вашої поточної школи або відхилити запис.",
	"pages.formerMemberships.table.name": "Назва",
	"pages.formerMemberships.table.type": "Тип",
	"pages.formerMemberships.reclaim.action": "Відновити",
	"pages.formerMemberships.reclaim.confirmation":
		"Забрати копію «{itemName}» до вашої поточної школи? Оригінал залишиться без змін.",
	"pages.formerMemberships.reclaim.success": "Копію «{itemName}» додано до вашої поточної школи.",
	"pages.formerMemberships.reclaim.error": "Не вдалося створити копію.",
	"pages.formerMemberships.reclaim.noLongerAvailable": "«{itemName}» більше не існує і не може бути скопійовано.",
	"pages.formerMemberships.discard.action": "Відхилити",
	"pages.formerMemberships.discard.confirmation": "Відхилити «{itemName}»? Цю дію неможливо скасувати.",
	"pages.formerMemberships.discard.success": "«{itemName}» відхилено.",
	"pages.formerMemberships.discard.error": "Не вдалося відхилити «{itemName}».",
	"pages.formerMemberships.dashboardBanner.dismiss": "Більше не показувати",
