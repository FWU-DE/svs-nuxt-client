export default {
	...
	"pages.files.personal.missingContext": "Особисті файли неможливо завантажити без контексту користувача та школи.",
	"pages.files.personal.title": "Персональні файли",
	"pages.files.personal.uploadHint": "Розмістіть тут файли для завантаження або здійсніть пошук на комп’ютері",
	"pages.files.personal.sortBy": "Сортувати за...",
	"pages.files.personal.sortOrder": "Сортування",
	"pages.files.personal.sort.createdAt": "Дата створення",
	"pages.files.personal.sort.updatedAt": "Дата модифікації",
	"pages.files.personal.sort.name": "Ім'я файлу",
	"pages.files.personal.sort.size": "Розмір",
	"pages.files.personal.download": "Завантажити файл",
