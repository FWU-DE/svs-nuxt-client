export default {
	...
	"pages.helpContact.consent": "Я погоджуюся, що для кращого розв'язання моєї проблеми може бути передана така інформація:",
	...
	"pages.helpContact.knownText": "Ви перевірили, чи ваша проблема вже відома? Це допомагає нам швидше розв'язувати проблеми, якщо ви ділитеся лише новими проблемами.",
	"pages.helpContact.knownStatus": "Крім того, можна перевірити нашу <a href=\"https://status.hpi-schul-cloud.de\">сторінку стану</a>, щоб побачити, чи є у нас зараз проблеми з нашими технічними системами.",
	...
	"pages.helpContact.consentWish": "Я погоджуюсь, що для кращої обробки мого запиту може бути передана наведена нижче інформація:",
	...
	"pages.helpContact.acceptancePlaceholder": "Наприклад, після входу в систему я досягаю контексту уроку максимум за два кроки, можу редагувати там завдання учня одним натисканням миші та, якщо потрібно, автоматично повідомляти учням про зміну.",
