export default {
	...
	"feature.quickNav.placeholder": "Шукати, перейти або створити",
	"feature.quickNav.results": "Результати пошуку",
	"feature.quickNav.empty": "Нічого не знайдено.",
	"feature.quickNav.failed": "Не вдалося виконати пошук кімнат, курсів і людей.",
	"feature.quickNav.group.navigation": "Перейти до",
	"feature.quickNav.group.roomsAndCourses": "Кімнати та курси",
	"feature.quickNav.group.people": "Люди",
	"feature.quickNav.group.actions": "Дії",
	"feature.quickNav.hint.move": "↑ ↓ вибрати",
	"feature.quickNav.hint.open": "↵ відкрити",
	"feature.quickNav.hint.close": "Esc закрити",
