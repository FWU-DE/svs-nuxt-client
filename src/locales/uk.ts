export default {
	...
	"pages.helpContact.problem": "Повідомити про проблему",
	"pages.helpContact.wish": "Надіслати побажання",
	"pages.helpContact.problemArea": "Тематична область",
	"pages.helpContact.subject": "Короткий опис",
	"pages.helpContact.problemDescription": "Опис проблеми",
	"pages.helpContact.role": "У ролі",
	"pages.helpContact.desire": "Я хотів(-ла) би",
	"pages.helpContact.benefit": "Користь",
	"pages.helpContact.acceptanceCriteria": "Критерії прийняття",
	"pages.helpContact.device": "Пристрій",
	"pages.helpContact.replyEmail": "Електронна пошта для відповіді",
	"pages.helpContact.consent": "Я погоджуюся на надсилання додаткової технічної інформації.",
