export default {
	...
	"components.board.ai.preset.material.hint":
		"Search open educational resources from amb and oersi and insert them as cards with a link.",
	...
	"components.board.ai.search.relays": "Searched in the amb relay and the oersi relay.",
