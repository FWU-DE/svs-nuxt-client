export default {
	...
	"pages.accountSettings.ssoHint":
		"This account is managed by a central identity provider. Profile data cannot be changed here.",
	...
	"pages.accountThirdPartyProviders.empty": "No third-party logins are being used.",
	...
	"pages.accountTeams.title": "Room and team settings",
	...
	"pages.files.overview.personalFiles.description": "Manage your own files and folders.",
	"pages.files.overview.courseFiles.description": "Open files from courses and course rooms.",
	"pages.files.overview.sharedFiles.description": "View files shared with you.",
