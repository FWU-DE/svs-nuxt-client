export default {
	...
	"common.actions.show.all": "Show all",
	...
	"common.actions.reset.filter": "Reset filter",
	...
	"common.labels.moreInfo": "More information",
	...
	"common.labels.complete.firstName": "Full first name",
	...
	"common.labels.migrated.tooltip": "Shows when account migration was completed",
	...
	"common.labels.repeat.email": "New e-mail",
	...
	"common.medium.alert.incomplete": "Configuration of medium not current or incomplete.",
	...
	"common.notifications.errors.notImported": "{type} could not be imported.",
	...
	"common.placeholder.firstName": "Klara",
	"common.placeholder.lastName": "Case",
	"common.placeholder.password.confirmation": "Confirm with password",
	"common.placeholder.password.current": "Current password",
	"common.placeholder.password.new.confirmation": "Repeat new password",
	"common.placeholder.password.new": "New password",
	"common.placeholder.repeat.email": "Repeat e-mail address",
	"common.roleName.administrator": "Administrator",
	"common.roleName.expert": "Expert",
	"common.roleName.externalPerson": "External Person",
	...
	"common.validation.tooLong": "The text you entered exceeds the maximum length of {maxLength} characters.",
	"common.validation.fileTooBig": "The file must not exceed {maxSize} KB.",
	"common.validation.tooShort": "The text you entered is below the minimum length of {minLength} characters.",
	...
	"common.words.color.blue-grey": "Blue grey",
	"common.words.color.brown": "Brown",
	"common.words.color.green": "Green",
	"common.words.color.light-blue": "Light blue",
	...
	"common.words.copiedToClipboard.failure": "Failed to copy to the clipboard. Please try it manually.",
	"common.words.copyLinkToClipboard.success": "Link copied to clipboard",
	"common.words.copyLinkToClipboard.failure": "Link could not be copied to clipboard",
	...
	"common.words.member": "Member | Members",
	"common.words.no": "No",
	...
	"components.administrationSection.description.moreInformation.link": "available here",
	...
	"components.administration.adminMigrationSection.endWarningCard.check":
		"I confirm the completion of the migration. After the waiting period of {gracePeriod} days at the earliest, the old login system will finally be switched off and accounts that have not been migrated will be deleted.",
	...
	"components.administration.adminMigrationSection.headers": "Account migration to moin.schule",
	...
	"components.administration.adminMigrationSection.mandatorySwitch.label": "Migration mandatory",
	"components.administration.adminMigrationSection.migrationActive": "Account migration is active.",
	"components.administration.adminMigrationSection.migrationEnableButton.label": "Start migration",
	"components.administration.adminMigrationSection.migrationEndButton.label": "Complete migration",
	...
	"components.administration.adminMigrationSection.migrationWizardButton.label": "Open migration wizard",
	...
	"components.administration.adminMigrationSection.showOutdatedUsers.label": "Show outdated user accounts",
	"components.administration.adminMigrationSection.startWarningCard.agree": "Start",
	"components.administration.adminMigrationSection.startWarningCard.disagree": "Abort",
	...
	"components.administration.externalToolsSection.action.showDatasheet": "View data sheet",
	"components.administration.externalToolsSection.action.sync": "Update availability",
	...
	"components.administration.externalToolsSection.description.secondParagraph.link": "Help section on external tools",
	...
	"components.administration.externalToolsSection.vidis.notification.success": "VIDIS media updated successfully",
	...
	"components.administration.externalToolsSection.notification.created": "Tool was created successfully.",
	"components.administration.externalToolsSection.notification.deleted": "Tool was successfully deleted.",
	"components.administration.externalToolsSection.notification.updated": "Tool has been updated successfully.",
	"components.administration.externalToolsSection.table.header.status": "Status",
	"components.administration.externalToolsSection.table.header.restrictedTo": "Restricted to",
	"components.administration.externalToolsSection.table.header.medium": "Media management",
	"components.administration.externalToolsSection.table.ariaLabel.mediumAvailable": "External medium authorized",
	"components.administration.externalToolsSection.table.ariaLabel.mediumUnavailable": "External medium not authorized",
	...
	"components.administration.provisioningOptions.class.label": "Synchronization of classes",
	"components.administration.provisioningOptions.course.description":
		"Activate this option if courses/lessons should be synchronized into the {instance}.",
	"components.administration.provisioningOptions.course.label": "Synchronization of courses/lessons",
	...
	"components.administration.provisioningOptions.otherGroups.label": "Synchronization of other groups",
	...
	"components.administration.schoolYearChangeSection.info.part.two": " (more information on the {0})",
	...
	"components.administration.schoolYearChangeSection.notification.start.success": "Transfer phase started successfully",
	"components.administration.schoolYearChangeSection.title.step.one": "End of the school year",
	...
	"components.administration.schoolYearChangeSection.step.one.button.startTransfer": "Start transfer period",
	"components.administration.schoolYearChangeSection.step.one.button.transferStarted": "Transfer phase started",
	"components.administration.schoolYearChangeSection.title.step.two": "Around the summer holidays",
	...
	"components.administration.schoolYearChangeSection.step.two.button": "Check LDAP-data",
	"components.administration.schoolYearChangeSection.title.step.three": "New school year",
	...
	"components.administration.schoolYearChangeSection.step.three.button": "End transfer phase",
	...
	"components.administration.schoolYearChangeSection.dialog.start.title": "Really start the transfer phase?",
	...
	"components.board.error.404": "Error 404 – Board with this name was not found",
	"components.board.error.403": "Error 403 – Unfortunately, you do not have permission to view this content ...",
	"components.board.menu.board": "Board settings",
	"components.board.ai.action": "Add with ai",
	"components.board.ai.preset.material": "Find material",
	"components.board.ai.preset.material.hint": "Search open educational resources and insert them as cards with a link.",
	"components.board.ai.search.label": "Search term",
	...
	"components.board.ai.source.card": "Based on this card",
	"components.board.ai.source.column": "Based on every card of this column",
	"components.board.ai.preset.differentiate": "Differentiate",
	"components.board.ai.preset.differentiate.hint":
		"Two versions of the same task: one with more support, one more demanding.",
	"components.board.ai.preset.exercises": "Practice tasks",
	"components.board.ai.preset.exercises.hint": "Tasks of rising difficulty, plus a card with solution hints.",
	"components.board.ai.preset.simplify": "Simplify language",
	"components.board.ai.preset.simplify.hint":
		"The same content in short sentences with terms explained - for language learners and inclusive teaching.",
	"components.board.ai.preset.selfCheck": "Self-check",
	"components.board.ai.preset.selfCheck.hint":
		"Statements like I can now … to check yourself against, plus short answers.",
	"components.board.ai.preset.free": "Free instruction",
	"components.board.ai.preset.free.hint": "Describe the cards you want yourself.",
	"components.board.ai.prompt.label": "Instruction",
	"components.board.ai.prompt.placeholder": "e.g. write three exit ticket questions on this content",
	"components.board.ai.generate": "Suggest cards",
	"components.board.ai.regenerate": "Suggest again",
	"components.board.ai.insert": "Insert {count} cards",
	"components.board.ai.error": "The suggestion could not be created. Please try again.",
	"components.board.ai.insertError": "Not all cards could be inserted.",
	...
	"components.board.menu.pollElement": "Poll settings",
	"components.board.menu.deadlineElement": "Deadline settings",
	"components.board.menu.codeElement": "Code settings",
	...
	"components.cardElement.recordingElement.waveform": "Waveform of the recording",
	...
	"components.cardElement.deadlineElement.past": "{time}",
	"components.cardElement.codeElement": "Code",
	"components.cardElement.codeElement.language": "Language",
	"components.cardElement.codeElement.lineNumbers": "Line numbers",
	"components.cardElement.codeElement.highlighting": "Syntax highlighting",
	"components.cardElement.codeElement.code": "Code",
	"components.cardElement.codeElement.copy": "Copy",
	"components.cardElement.codeElement.copied": "Code copied",
	"components.cardElement.formulaElement": "Formula",
	"components.cardElement.formulaElement.latex": "LaTeX",
	"components.cardElement.formulaElement.empty": "No formula entered yet",
	"components.cardElement.formulaElement.invalid": "The formula could not be read",
	"components.cardElement.checklistElement": "Checklist",
	"components.cardElement.checklistElement.title": "Label",
	"components.cardElement.checklistElement.item": "Item {index}",
	"components.cardElement.checklistElement.addItem": "Add item",
	"components.cardElement.checklistElement.removeItem": "Remove item {index}",
	"components.cardElement.checklistElement.empty": "No items yet",
	"components.cardElement.checklistElement.progress": "{done} of {total} done",
	"components.cardElement.checklistElement.progressMode": "Progress",
	"components.cardElement.checklistElement.progressMode.shared": "Shared by everyone",
	"components.cardElement.checklistElement.progressMode.perUser": "Personal for each person",
	"components.cardElement.checklistElement.modeResetHint": "Switching clears the ticks made so far.",
	"components.cardElement.checklistElement.personal": "only for you",
	"components.cardElement.checklistElement.participants": "{count} have started",
	"components.board.settings.inherit": "Follow the room",
	"components.board.settings.inheritedValue": "currently: {value}",
	"components.board.settings.off": "Off",
	"components.elementTypeSelection.elements.deadlineElement.subtitle": "Deadline",
	"components.elementTypeSelection.elements.codeElement.subtitle": "Code",
	"components.elementTypeSelection.elements.formulaElement.subtitle": "Formula",
	"components.elementTypeSelection.elements.checklistElement.subtitle": "Checklist",
	...
	"components.boardCard.settings.readersCanEdit": "Everyone may edit",
	"components.boardCard.comment.placeholder": "Write a comment",
	"components.boardCard.comment.hint": "Enter sends, Shift+Enter adds a line break",
	"components.boardCard.comment.submit": "Send",
	"components.boardCard.comment.edited": "edited",
	"components.boardCard.comment.removed": "Comment withdrawn",
	"components.boardCard.comment.removedByModerator": "Comment removed by a teacher",
	"components.boardCard.comment.menu": "Comment actions",
	"components.boardCard.comment.report": "Report",
	...
	"components.board.reactionType.like.hint": "One click per person, the count is shown.",
	"components.board.reactionType.star": "Stars",
	"components.board.reactionType.star.hint": "A rating from one to five stars, the average is shown.",
	"components.board.reactionType.vote": "Vote",
	"components.board.reactionType.vote.hint": "Agree or disagree, the net score is shown.",
	"components.boardCard.reaction.like": "Like",
	"components.boardCard.reaction.upvote": "Agree",
	"components.boardCard.reaction.downvote": "Disagree",
	"components.boardCard.reaction.star": "{count} out of 5 stars",
	"components.boardCard.reaction.average": "{average} ({count})",
	"components.boardCard.reaction.noRating": "No rating yet",
	...
	"components.board.notifications.errors.fileNameExists": "A file with this name already exists.",
	"components.board.notifications.errors.fileServiceNotAvailable": "The file service is currently not available.",
	...
	"components.cardElement.pollElement": "Poll",
	"components.cardElement.pollElement.question": "Question",
	"components.cardElement.pollElement.noQuestion": "No question asked yet",
	"components.cardElement.pollElement.option": "Answer {index}",
	"components.cardElement.pollElement.noOptionText": "Answer without text",
	"components.cardElement.pollElement.addOption": "Add answer",
	"components.cardElement.pollElement.removeOption": "Remove answer {index}",
	"components.cardElement.pollElement.multipleChoice": "Allow multiple answers",
	"components.cardElement.pollElement.anonymous": "Anonymous",
	"components.cardElement.pollElement.close": "Close poll",
	"components.cardElement.pollElement.closed": "Closed",
	"components.cardElement.pollElement.showResults": "Show results",
	"components.cardElement.pollElement.showResults.always": "Immediately, to everyone",
	"components.cardElement.pollElement.showResults.afterVote": "After casting an own vote",
	"components.cardElement.pollElement.showResults.onRelease": "Only after the teacher releases them",
	"components.cardElement.pollElement.resultsRelease": "Release results",
	"components.cardElement.pollElement.resultsWithdraw": "Withdraw release",
	"components.cardElement.pollElement.resultsAfterVote": "Results become visible after you vote",
	"components.cardElement.pollElement.resultsAfterClose": "Results not released yet",
	"components.cardElement.pollElement.voterCount": "{count} participants",
	"components.cardElement.pollElement.votes": "{count} votes",
	...
	"components.elementTypeSelection.elements.folderElement.subtitle": "File folder",
	...
	"components.externalTools.status.outdated": "Outdated",
	"components.externalTools.status.unknown": "Unknown",
	...
	"components.legacy.footer.security": "Security",
	"components.legacy.footer.status": "Status",
	"components.legacy.footer.terms": "Terms of Use",
	"components.molecules.AddContentModal": "Add to course",
	"components.molecules.adminfooterlegend.title": "Legend",
	"components.molecules.admintablelegend.externalSync":
		"Some or all of your user data is synchronized with an external data source (LDAP, IDM, etc.). It is therefore not possible to edit the table manually with the School-Cloud. Creating new students or teachers is also just possible in the source system. Find more information in the",
	...
	"components.molecules.ContentCard.report.body": "Report the content with the ID",
	"components.molecules.ContentCard.report.email": "inhalte{'@'}hpi-schul-cloud.de",
	"components.molecules.ContentCard.report.subject":
		"Dear team, I would like to report the content mentioned in the subject because: [state your reasons here]",
	"components.molecules.ContentCardMenu.action.copy": "Copy to...",
	"components.molecules.ContentCardMenu.action.delete": "Delete",
	"components.molecules.ContentCardMenu.action.report": "Report",
	...
	"components.molecules.import.columnBoard.options.selectCourse": "Select course",
	...
	"components.molecules.import.lessons.rename": "If necessary, the name of the topic can be renamed: ",
	...
	"components.molecules.import.room.rename": "If necessary, the name of the room can be renamed: ",
	"components.molecules.import.tasks.label": "Task",
	"components.molecules.import.tasks.options.selectCourse.infoText":
		"The course into which the task should be imported must be selected below.",
	...
	"components.molecules.import.tasks.rename": "If necessary, the name of the task can be renamed: ",
	...
	"components.molecules.importUsersMatch.saveMatch": "Save relation",
	"components.molecules.importUsersMatch.search": "Search user",
	"components.molecules.importUsersMatch.subtitle.nbc":
		"The {source} account will be imported into the {instance} later. If the {source} account should be linked to an existing {instance} account, you can select the {instance} account here.",
	"components.molecules.importUsersMatch.subtitle":
		"The {source} account will be imported into the {instance} later. If the {source} account should be linked to an existing {instance} account, you can select the {instance} account here. Otherwise a new account will be created.",
	"components.molecules.importUsersMatch.title": "Link {source} account to {instance} account",
	"components.molecules.importUsersMatch.unMatched.nbc": "None.",
	"components.molecules.importUsersMatch.unMatched": "None. Account will be newly created.",
	"components.molecules.importUsersMatch.write": "Input first and last name",
	"components.molecules.importUsersMatch.externalRoleName.none": "Not available",
	"components.molecules.importUsersMatch.externalRoleName.schulconnex.teacher": "Teacher",
	"components.molecules.importUsersMatch.externalRoleName.schulconnex.student": "Student",
	...
	"components.molecules.shareImport.options.restrictions.infoText.courseFiles": "Files under Course Files",
	"components.molecules.shareImport.options.restrictions.infoText.etherpad": "Content from Etherpads",
	"components.molecules.shareImport.options.restrictions.infoText.whiteboard": "Content from Whiteboards",
	"components.molecules.shareImport.options.restrictions.infoText.geogebra": "Geogebra IDs",
	"components.molecules.shareImport.options.restrictions.infoText.courseGroups": "Course groups",
	"components.molecules.shareImport.options.restrictions.infoText.roomMembershipsData": "Room members and permissions",
	"components.molecules.share.options.tableHeader.InfoText": "The following will not be copied:",
	...
	"components.molecules.share.columnBoard.result.linkLabel": "Link to Board copy",
	...
	"components.molecules.TaskItemMenu.finish": "Finish",
	"components.molecules.TaskItemMenu.labels.createdAt": "Created",
	"components.molecules.TaskItemTeacher.graded": "Graded",
	"components.molecules.TaskItemTeacher.lessonIsNotPublished": "Topic not published",
	"components.molecules.TaskItemTeacher.status": "{submitted}/{max} submitted, {graded} graded",
	...
	"components.organisms.ContentCard.report.subject":
		"Dear team, I would like to report the content mentioned in the subject, da: [please put here your reasons]",
	"components.organisms.DataFilter.add": "Add filter",
	...
	"components.organisms.importUsers.legend": "Legend",
	"components.organisms.importUsers.legendAdminMatched":
		"{source} account was manually linked to the {instance} account by an administrator.",
	"components.organisms.importUsers.legendAutoMatched": "{source} was automatically linked to the {instance} account.",
	"components.organisms.importUsers.legendFlag":
		"Entries that should be marked and, if necessary, checked later can be marked with a flag.",
	"components.organisms.importUsers.legendUnMatched":
		"{instance} account was not found. After the migration is completed, a new user account will be created automatically as soon as the {source} user logs in to {instance} for the first time.",
	"components.organisms.importUsers.searchAdminMatched": "Filter for admin matched",
	"components.organisms.importUsers.searchAutoMatched": "Filter for automatically matched",
	"components.organisms.importUsers.searchClass": "Search class",
	"components.organisms.importUsers.searchFirstName": "Search for first name",
	"components.organisms.importUsers.searchFlagged": "Filter by flagged",
	"components.organisms.importUsers.searchLastName": "Search for last name",
	"components.organisms.importUsers.searchRole": "Select role",
	"components.organisms.importUsers.searchUnMatched": "Filter for not binded",
	"components.organisms.importUsers.searchUserName": "Search for username",
	"components.organisms.importUsers.tableClasses": "Classes",
	"components.organisms.importUsers.tableFirstName": "First name",
	"components.organisms.importUsers.tableFlag": "Flag",
	"components.organisms.importUsers.tableLastName": "Last name",
	"components.organisms.importUsers.tableMatch": "Match accounts",
	"components.organisms.importUsers.tableRoles": "Roles",
	"components.organisms.importUsers.tableUserName": "Username",
	"components.organisms.LegacyFooter.contact": "Contact",
	"components.organisms.LegacyFooter.job-offer": "Job advertisements",
	"components.organisms.Pagination.currentPage": "{start} to {end} from {total}",
	"components.organisms.Pagination.perPage.10": "10 per page",
	"components.organisms.Pagination.perPage.100": "100 per page",
	"components.organisms.Pagination.perPage.25": "25 per page",
	"components.organisms.Pagination.perPage.5": "5 per page",
	"components.organisms.Pagination.perPage.50": "50 per page",
	"components.organisms.Pagination.perPage": "per page",
	"components.organisms.Pagination.recordsPerPage": "Entries per page",
	"components.organisms.Pagination.showTotalRecords": "Show all {total} entries",
	"components.organisms.TasksDashboardMain.filter.substitute": "Tasks from substitutes",
	"components.organisms.TasksDashboardMain.fab.createTask": "Create task",
	"components.organisms.TasksDashboardMain.tab.completed": "Completed",
	"components.organisms.TasksDashboardMain.tab.current": "Current",
	...
	"components.roomForm.labels.feedback.reactions.like": "Like",
	"components.roomForm.labels.feedback.reactions.star": "Stars (1–5)",
	"components.roomForm.labels.feedback.reactions.vote": "Up and down votes",
	...
	"feature-copy.copyInfo.text.nextStep": "In the next step, a copy of the {type} will be created.",
	"feature-copy.copyInfo.text.alert.followingContent": "The following will not be copied:",
	"feature-copy.copyInfo.text.alert.membersPermissions": "{type} members and permissions",
	"feature-copy.copyInfo.text.alert.courseFiles": "Files under course files",
	"feature-copy.copyInfo.text.alert.courseGroup": "Course groups",
	"feature-copy.copyInfo.text.alert.Etherpad": "Content from Etherpads",
	"feature-copy.copyInfo.text.alert.whiteboard": "Content from whiteboards",
	"feature-copy.copyInfo.text.alert.geogebra": "Geogebra IDs",
	"feature-copy.copyInfo.text.alert.protectedSettings": "Protected settings of external tools",
	"feature-copy.inProgress.title.loading": "Duplication is in progress...",
	...
	"feature-copy.copyInfo.type.task": "Task",
	"feature-copy.copyInfo.type.lesson": "Lesson",
	"feature-copy.copyInfo.type.room": "Room",
	"feature-copy.copyInfo.type.card": "Card",
	"feature-copy.copyInfo.type.ofCourse": "of the course",
	"feature-copy.copyInfo.type.ofBoard": "of the board",
	"feature-copy.copyInfo.type.ofTask": "of the task",
	...
	"feature-course-sync.StartExistingCourseSyncDialog.success": "User group successfully synchronized",
	...
	"global.topbar.language.select": "Language selection",
	"global.topbar.language.selectedLanguage": "Selected language",
	"global.topbar.loggedOut.actions.blog": "Blog",
	"global.topbar.loggedOut.actions.faq": "FAQ",
	"global.topbar.loggedOut.actions.steps": "First steps",
	"global.topbar.MenuQrCode.print": "Print",
	"global.topbar.MenuQrCode.qrHintText": "Navigate other users to this site",
	"global.topbar.mobileMenu.ariaLabel": "Page navigation",
	"global.topbar.settings": "Settings",
	"global.topbar.userMenu.ariaLabel": "User menu for {userName}",
	"mixins.typeMeta.types.default": "Content",
	...
	"pages.dashboard.calendar.title": "Upcoming events",
	"pages.dashboard.calendar.subtitle": "A direct view of upcoming course and team events.",
	"pages.dashboard.calendar.showAll": "Go to overview",
	"pages.dashboard.calendar.empty.title": "No upcoming events",
	"pages.dashboard.calendar.empty.text": "Events will appear here as soon as the calendar service provides them.",
	"pages.dashboard.calendar.openCourse": "Open course",
	"pages.dashboard.calendar.openTeam": "Open team",
	"pages.dashboard.calendar.openContext": "Open context",
	"pages.calendar.title": "Calendar",
	"pages.calendar.subtitle": "All events from calendar, course, and team contexts.",
	"pages.calendar.empty": "No events are available.",
	"pages.calendar.today": "Today",
	"pages.calendar.past": "Past events",
	"pages.calendar.view.day": "Day",
	"pages.calendar.view.week": "Week",
	"pages.calendar.view.month": "Month",
	"pages.calendar.previous": "Previous",
	"pages.calendar.next": "Next",
	"pages.calendar.addEvent": "Add date",
	"pages.calendar.confirmDelete": "Do you really want to delete this date?",
	"pages.calendar.deleteEvent": "Delete date",
	"pages.calendar.deleted": "Date deleted.",
	"pages.calendar.form.createTitle": "Add date",
	"pages.calendar.form.description": "Description",
	"pages.calendar.form.editTitle": "Edit date",
	"pages.calendar.form.endBeforeStart": "The end must be after the start.",
	"pages.calendar.form.error": "The date could not be saved.",
	"pages.calendar.form.from": "From",
	"pages.calendar.form.location": "Place",
	"pages.calendar.form.locationPlaceholder": "e.g. gymnasium",
	"pages.calendar.form.required": "Please fill in.",
	"pages.calendar.form.title": "Title",
	"pages.calendar.form.titlePlaceholder": "e.g. handball training",
	"pages.calendar.form.to": "To",
	"pages.accountSettings.title": "Your account",
	"pages.accountSettings.profile": "Profile",
	"pages.accountSettings.security": "Security",
	"pages.accountSettings.currentPassword": "Current password",
	"pages.accountSettings.passwordHint": "Changes to email or password must be confirmed with the current password.",
	"pages.accountSettings.ssoHint":
		"Your user data is automatically synchronized by a identity management (IDM) system. Changes to it can only be made in the source system (e.g. school server or Schulportal) that the data in the IDM is based on. Please contact the local admin of your school to make changes to your user data.",
	...
	"pages.news.overview.search": "Search for news",
	"pages.accountThirdPartyProviders.title": "Third party logins",
	"pages.accountThirdPartyProviders.empty": "No third party providers used",
	"pages.accountThirdPartyProviders.revoked": "Third-party login removed.",
	"pages.accountThirdPartyProviders.revokeError": "Third-party login could not be removed.",
	"pages.accountTeams.title": "Team settings",
	"pages.accountTeams.visibilityTitle": "Invitation visibility",
	"pages.accountTeams.visibilityText":
		"This controls whether you can be found in directories for room or team invitations.",
	"pages.accountTeams.nativeNote":
		"This view has been migrated natively. The concrete visibility setting will be connected to the matching backend configuration in a follow-up slice.",
	"pages.dashboard.empty.news": "So far there is no news.",
	"pages.legacyViewMigration.title": "Legacy view migrated",
	"pages.legacyViewMigration.description":
		"This legacy view is no longer opened in the old client. The path is registered in the Nuxt migration list and can now be implemented step by step as a native view.",
	"pages.legacyViewMigration.requestedPath": "Requested path",
	"pages.legacyViewMigration.legacyView": "Legacy view",
	"pages.legacyViewMigration.legacyController": "Legacy controller",
	"pages.legacyViewMigration.note":
		"Until the native view is complete, use the overview or help page to switch to the matching workspace.",
	"pages.legacyViewMigration.toDashboard": "Go to overview",
	"pages.legacyViewMigration.toHelp": "Go to help",
	"pages.releaseNotes.title": "Release notes",
	"pages.releaseNotes.empty": "No release notes are available yet.",
	"pages.releaseNotes.openSource": "Open source",
	"pages.helpArticles.title": "Help articles",
	"pages.helpArticles.training": "Online video courses",
	"pages.helpArticles.liveFormats": "Live formats",
	"pages.helpArticles.quickstartPdf": "Quick start PDF",
	"pages.helpArticles.documents": "Documents for download",
	"pages.helpArticles.search": "search...",
	"pages.helpArticles.firstSteps.students": "Students",
	"pages.helpArticles.firstSteps.teachers": "Teachers",
	"pages.helpArticles.firstSteps.principal": "Principal",
	"pages.helpArticles.firstSteps": "Erste Schritte",
	"pages.helpArticles.usageHelp": "Nutzungshilfen",
	"pages.helpContact.title": "Contact",
	"pages.helpContact.problem": "Problem",
	"pages.helpContact.wish": "Request",
	"pages.helpContact.problemArea": "Select topic",
	"pages.helpContact.subject": "Brief description of the problem",
	"pages.helpContact.problemDescription": "Problem description",
	"pages.helpContact.role": "As...",
	"pages.helpContact.desire": "I would like to...",
	"pages.helpContact.benefit": "around ...",
	"pages.helpContact.acceptanceCriteria": "Acceptance criteria",
	"pages.helpContact.device": "The problem occurs on this device",
	"pages.helpContact.replyEmail": "E-mail address for any queries",
	"pages.helpContact.consent":
		"I agree that the following information may transferred for better handling of my problem:",
	"pages.helpContact.sent": "Request sent.",
	"pages.helpContact.sendError": "Request could not be sent.",
	"pages.helpContact.formTitle": "Contact form",
	"pages.helpContact.feedbackKind": "What kind of feedback would you like to send us?",
	"pages.helpContact.topicTitle": "Select topic",
	"pages.helpContact.severalTopics": "Selection of several topics is possible",
	"pages.helpContact.required": "(required)",
	"pages.helpContact.noProblemArea": "You have to choose a problem area.",
	"pages.helpContact.knownTitle": "Is the problem already known?",
	"pages.helpContact.knownText":
		"Have you checked if your problem is already known? It helps us to solve problems faster if only new issues are shared.",
	"pages.helpContact.knownStatus":
		"Additionally you can check our status page to see, if we currently have problems with our technical systems.",
	"pages.helpContact.supportTitle": "Contact support",
	"pages.helpContact.supportSubtitle": "Your problem isn't listed? Contact our support team.",
	"pages.helpContact.supportSubtitleWish": "Do you want to share a request? Please contact our support team.",
	"pages.helpContact.subjectWish": "Brief description of the request",
	"pages.helpContact.deviceWish": "Device",
	"pages.helpContact.emailPlaceholder": "E-mail address",
	"pages.helpContact.furtherInformation": "Further information about your browser and operating system",
	"pages.helpContact.consentWish":
		"I agree that the following information may be transferred for better handling of my request:",
	"pages.helpContact.consentBrowser": "Browser name and version (e.g. Firefox 69.0)",
	"pages.helpContact.consentOs": "Operating system and version (e.g. Windows 10)",
	"pages.helpContact.submit": "Submit",
	"pages.helpContact.rolePlaceholder": "e.g. students, teachers, administrators, janitors, etc.",
	"pages.helpContact.desirePlaceholder": "e.g. can easily find and change a student task created in the system",
	"pages.helpContact.benefitPlaceholder": "e.g. to update them",
	"pages.helpContact.acceptancePlaceholder":
		"For example, after logging in to the system, I reach the lesson context in maximum two steps, can edit the student task there with a click and, if necessary, automatically inform the students about the change.",
	"pages.helpContact.whichArea": "Which area of {{shortTitle}} does your topic concern?",
	"pages.helpConfluence.title": "Help article",
	"pages.helpConfluence.hint": "If the article is not displayed correctly, open it directly in the documentation.",
	"pages.helpConfluence.openExternal": "Open article externally",
	"pages.helpDocuments.title": "Documents for download",
	"pages.helpDocuments.empty": "No documents are available.",
	"pages.taskDetail.back": "Back to tasks",
	"pages.taskDetail.description": "Description",
	"pages.taskDetail.maxSubmissions": "Max. submissions",
	"pages.taskDetail.noDescription": "No description available.",
	"pages.taskDetail.notFound": "Task was not found.",
	"pages.taskDetail.submissions": "Submissions",
	"pages.taskDetail.submissions.empty": "No submission status is available yet.",
	"pages.taskDetail.tab.details": "Details",
	"pages.taskDetail.tab.submissions": "Submissions",
	"pages.taskDetail.toCourseFiles": "To the course files",
	"pages.taskDetail.toCourse": "To the course",
	"pages.taskDetail.till": "till",
	"pages.taskDetail.confirmDelete": "Are you sure you want to delete '{name}'?",
	"pages.taskDetail.error": "That did not work.",
	"pages.taskDetail.feedback.files": "Files uploaded as comments/grading",
	"pages.taskDetail.feedback.none": "No comments available yet.",
	"pages.taskDetail.feedback.solvedPercent": "You have solved {grade}% correctly.",
	"pages.taskDetail.files.none": "No files.",
	"pages.taskDetail.files.upload": "Upload files",
	"pages.taskDetail.finish": "Finish",
	"pages.taskDetail.grading.comment": "Grading remarks",
	"pages.taskDetail.grading.error": "The grading could not be saved.",
	"pages.taskDetail.grading.files": "Upload corrected files",
	"pages.taskDetail.grading.grade": "rating",
	"pages.taskDetail.grading.inPercent": "%",
	"pages.taskDetail.grading.saveAndSend": "Save and send",
	"pages.taskDetail.grading.saved": "Rating has been saved!",
	"pages.taskDetail.lessonHidden": "Task not visible, because topic is unpublished",
	"pages.taskDetail.noDueDate": "No submission date",
	"pages.taskDetail.print": "Print task definition",
	"pages.taskDetail.restore": "Restore",
	"pages.taskDetail.state.done": "Great! You've completed your task!",
	"pages.taskDetail.state.late": "Too late! Next time, try to be more careful with your time.",
	"pages.taskDetail.submission.chooseTeamMembers": "Select colleagues",
	"pages.taskDetail.submission.done": "Great! You've completed your task!",
	"pages.taskDetail.submission.error": "The submission could not be saved.",
	"pages.taskDetail.submission.fileUpload": "File submission",
	"pages.taskDetail.submission.maxTeamSize": "The maximum team size is {max} members",
	"pages.taskDetail.submission.placeholder": "Create your submission...",
	"pages.taskDetail.submission.saveDraft": "Save draft",
	"pages.taskDetail.submission.saveFirst": "Save your submission as a draft first, then you can upload files.",
	"pages.taskDetail.submission.saved": "Draft saved.",
	"pages.taskDetail.submission.submit": "Send submission",
	"pages.taskDetail.submission.submitted": "Submission sent.",
	"pages.taskDetail.submission.teamSubmission": "Team submission",
	"pages.taskDetail.submission.textDelivery": "Text submission",
	"pages.taskDetail.submissions.grade": "rating",
	"pages.taskDetail.submissions.noSubmissionYetFrom": "No submission yet from:",
	"pages.taskDetail.submissions.noText": "No submission",
	"pages.taskDetail.submissions.none": "No submissions available.",
	"pages.taskDetail.submissions.rating": "Comment/Grading",
	"pages.taskDetail.submissions.show": "Show",
	"pages.taskDetail.submissions.submitted": "Submitted",
	"pages.taskDetail.submissions.submittedFiles": "Files uploaded for submission",
	"pages.taskDetail.submissions.team": "Team",
	"pages.taskDetail.tab.feedback": "Comment/Grading",
	"pages.taskDetail.tab.submission": "Submission",
	"pages.taskEdit.availableDate": "Visible for students and to be edited from",
	"pages.taskEdit.course": "Course",
	"pages.taskEdit.createTitle": "Add task",
	"pages.taskEdit.description": "Task definition",
	"pages.taskEdit.descriptionPlaceholder": "Explain why ...",
	"pages.taskEdit.draft": "Draft (not visibible to students)",
	"pages.taskEdit.dueBeforeStart": "The start date must be before the submission date!",
	"pages.taskEdit.dueDate": "Processing period ends on",
	"pages.taskEdit.editTitle": "Edit task",
	"pages.taskEdit.error": "The task could not be saved.",
	"pages.taskEdit.maxTeamMembers": "Maximum group size",
	"pages.taskEdit.name": "Title",
	"pages.taskEdit.noCourse": "No assignment",
	"pages.taskEdit.noTopic": "No topics selected",
	"pages.taskEdit.publicSubmissions": "Student submissions visible to each other",
	"pages.taskEdit.publicSubmissionsHint":
		"By activating this option, the submissions of all course participants will be visible to all other students in the course.",
	"pages.taskEdit.required": "This field is required.",
	"pages.taskEdit.saved": "Task saved.",
	"pages.taskEdit.substitutionCannotChangeCourse": "(Substitute teachers are not allowed to edit the course)",
	"pages.taskEdit.teamSubmissions": "Enable group submission",
	"pages.taskEdit.topic": "Topic",
	...
	"pages.administration.ldap.activate.dN": "Domain-Name",
	"pages.administration.ldap.activate.email": "E-mail",
	"pages.administration.ldap.activate.firstName": "First Name",
	"pages.administration.ldap.activate.lastName": "Last Name",
	"pages.administration.ldap.activate.message":
		"Your configuration is saved. The synchronization can take up to a few hours.",
	"pages.administration.ldap.activate.migrateExistingUsers.checkbox":
		"Use migration assistant to link existing user accounts and LDAP user accounts",
	...
	"pages.administration.ldap.activate.migrateExistingUsers.title": "Migrate existing user accounts",
	"pages.administration.ldap.activate.ok": "Ok",
	"pages.administration.ldap.activate.roles": "Roles",
	"pages.administration.ldap.activate.uid": "UID",
	"pages.administration.ldap.activate.uuid": "UUID",
	"pages.administration.ldap.classes.activate.import": "Activate import for classes",
	"pages.administration.ldap.classes.hint":
		"Each LDAP system uses different attributes to represent classes. Please help us to map the attributes of your classes. We have made some useful default settings that you can adjust here at any time.",
	"pages.administration.ldap.classes.notice.title": "Attribute display name",
	"pages.administration.ldap.classes.participant.title": "Attribute participant",
	...
	"pages.administration.ldap.connection.basis.path.info":
		"All users and classes must be accessible under the base path.",
	"pages.administration.ldap.connection.basis.path": "Basic path of the school",
	"pages.administration.ldap.connection.search.user.info":
		"Complete user DN incl. root path of user, who has access to all user information.",
	"pages.administration.ldap.connection.search.user.password": "Password Search user",
	"pages.administration.ldap.connection.search.user": "Search user",
	"pages.administration.ldap.connection.server.info":
		"Make sure the server is reachable using the secure ldaps:// protocol.",
	"pages.administration.ldap.connection.server.url": "Server URL",
	"pages.administration.ldap.connection.title": "Connection",
	"pages.administration.ldap.errors.configuration": "Invalid configuration object",
	"pages.administration.ldap.errors.credentials": "Wrong search-user credentials",
	"pages.administration.ldap.errors.path": "Wrong search or base path",
	"pages.administration.ldap.index.buttons.reset": "Reset inputs",
	"pages.administration.ldap.index.buttons.verify": "Verify",
	"pages.administration.ldap.index.title": "LDAP Configuration",
	"pages.administration.ldap.index.verified": "The verification was successfull",
	"pages.administration.ldap.save.example.class": "Example class",
	"pages.administration.ldap.save.example.synchronize": "Activate synchronisation",
	"pages.administration.ldap.save.example.user": "Example user",
	"pages.administration.ldap.save.subtitle":
		"In the following, you can check with examples, whether we have assigned the attributes correctly.",
	"pages.administration.ldap.save.title": "Following data sets are ready for synchronisation",
	"pages.administration.ldap.subtitle.help": "You can find more information in our ",
	"pages.administration.ldap.subtitle.helping.link": "LDAP configuration help section.",
	"pages.administration.ldap.subtitle.one":
		"Any changes to the following configuration may result in the login failing for you and all users at your school. Therefore, only make changes, if you are aware of the consequences. Some sections are read-only.",
	"pages.administration.ldap.subtitle.two":
		"After verification you can preview the read out content. Users, who are missing one of the required attributes, will not be synchronized.",
	"pages.administration.ldap.title": "Configuration User-Sync & Login through LDAP",
	"pages.administration.ldap.users.domain.title": "Domain title (path in LDAP)",
	"pages.administration.ldap.users.hint":
		"Every LDAP system uses different attributes to represent a user. Please help us to correctly assign attributes to users. We have set some default settings, which you can adjust here any time.",
	"pages.administration.ldap.users.path.email": "Attribute value email",
	"pages.administration.ldap.users.path.firstname": "Attribute value first name",
	"pages.administration.ldap.users.path.lastname": "Attribute value last name",
	"pages.administration.ldap.users.path.title": "User path(s)",
	"pages.administration.ldap.users.title.info":
		"In the following input field you have to specify, where we find users and how they are structured. By adding two semicolons (;;) you can add multiple user paths separately.",
	"pages.administration.ldap.users.title": "User",
	"pages.administration.ldap.users.uid.info":
		"The login name, that is used later, can only exist once in your LDAP system at the same time.",
	"pages.administration.ldap.users.uid.title": "Attribute uid",
	"pages.administration.ldap.users.uuid.info":
		"The user-uuid is used for assignment later. Therefore it can't be changed.",
	"pages.administration.ldap.users.uuid.title": "Attribute uuid",
	"pages.administration.ldapEdit.roles.headLines.sectionDescription":
		"In the following, the found users must be assigned to the predefined $longname roles.",
	"pages.administration.ldapEdit.roles.headLines.title": "User Roles",
	"pages.administration.ldapEdit.roles.info.admin": "E.g.: cn=admin,ou=rollen,o=schule,dc=de",
	"pages.administration.ldapEdit.roles.info.student": "E.g.: cn=schueler,ou=rollen,o=schule,dc=de",
	"pages.administration.ldapEdit.roles.info.teacher": "E.g.: cn=lehrer,ou=rollen,o=schule,dc=de",
	"pages.administration.ldapEdit.roles.info.user": "E.g.: cn=ehemalige,ou=rollen,o=schule,dc=de",
	"pages.administration.ldapEdit.roles.labels.admin": "Attribute value for admin",
	"pages.administration.ldapEdit.roles.labels.member": "Role Attribute",
	"pages.administration.ldapEdit.roles.labels.noSchoolCloud": "Ignore user attribute value",
	"pages.administration.ldapEdit.roles.labels.radio.description":
		"Is the user role stored textually in the user attribute or is there an LDAP group for the respective user roles?",
	"pages.administration.ldapEdit.roles.labels.radio.ldapGroup": "LDAP Group",
	"pages.administration.ldapEdit.roles.labels.radio.userAttribute": "User attribute",
	"pages.administration.ldapEdit.roles.labels.student": "Attribute value for student",
	"pages.administration.ldapEdit.roles.labels.teacher": "Attribute value for teacher",
	"pages.administration.ldapEdit.roles.labels.user": "Ignore attribute value for user",
	"pages.administration.ldapEdit.roles.placeholder.admin": "Attribute value for admin",
	"pages.administration.ldapEdit.roles.placeholder.member": "Role Attribute",
	"pages.administration.ldapEdit.roles.placeholder.student": "Attribute value for student",
	"pages.administration.ldapEdit.roles.placeholder.teacher": "Attribute value for teacher",
	"pages.administration.ldapEdit.roles.placeholder.user": "Ignore attribute value for user",
	"pages.administration.ldapEdit.validation.path": "Please match LDAP path format",
	"pages.administration.ldapEdit.validation.url": "Please match a valid URL format",
	"pages.administration.migration.back": "Back",
	"pages.administration.migration.clearAutoMatches": "Reset automatic accounts links",
	"pages.administration.migration.backToAdministration": "Back to administration",
	"pages.administration.migration.brbSchulportal": "weBBSchule",
	"pages.administration.migration.cannotStart":
		"Migration cannot begin. The school is not in migration mode or in the transfer phase.",
	"pages.administration.migration.confirm":
		"I confirm the assignment of the local user accounts has been verified and the migration can be carried out.",
	"pages.administration.migration.error": "There was an error. Please try again latter.",
	...
	"pages.administration.migration.performingMigration": "Saving the accounts link...",
	"pages.administration.migration.startUserMigration": "Start accounts migration",
	"pages.administration.migration.matchByPreferredName": "Prefer nicknames for automatic account linking",
	...
	"pages.administration.migration.step4.bullets.classes": "No classes have been imported from the {source} yet.",
	"pages.administration.migration.step4.bullets.linkedUsers":
		"Users whose accounts have been linked can already log in with their {source} credentials. However, the personal data of these users (name, date of birth, roles, classes, etc.) has not yet been updated from {source}.",
	"pages.administration.migration.step4.bullets.newUsers":
		"No new user accounts have been created yet. Users who did not have a user account in the {instance} and are to be imported by the migration wizard cannot log in yet.",
	"pages.administration.migration.step4.bullets.oldUsers":
		"Unlinked user accounts have not been changed and can be deleted if necessary (please contact support if necessary).",
	"pages.administration.migration.step4.endTransferphase":
		"Please finish the transfer phase now so that the school is activated for the sync run. The sync run takes place every hour.",
	"pages.administration.migration.step4.linkingFinished":
		"The linking of the {source} user accounts with the dBildungscloud user accounts has taken place.",
	"pages.administration.migration.step4.nbc.linkingFinished":
		"The {source} user accounts have been linked to the {instance} user accounts. {totalMatched} user accounts have been linked.",
	"pages.administration.migration.step4.transferphase":
		"The school is now in the transfer phase (analogous to the change of school year). In this phase, no sync run is carried out. This means:",
	"pages.administration.migration.step4": "Transfer phase",
	"pages.administration.migration.step5.afterSync.bullet1":
		"Linked user accounts: Users can log in with their {source} credentials. The personal data of these users is fed from the {source} (name, date of birth, role, classes, etc.).",
	"pages.administration.migration.step5.afterSync.bullet2": "New user accounts have been created.",
	"pages.administration.migration.step5.afterSync":
		"After a successful sync run, the linking of {source} and {instance} user accounts is complete. This means:",
	"pages.administration.migration.step5.nbc.bullet1":
		"Linked user accounts: Users can log in with their {source} credentials. The personal data of these users is taken from {source} and, if necessary, updated with every login process (name, date of birth, role, classes, etc.).",
	"pages.administration.migration.step5.nbc.linkingFinished":
		"The selected {instance} user accounts have been linked to the corresponding {source} user accounts.",
	"pages.administration.migration.step5.syncReady1": "The school is now enabled for the Sync run.",
	...
	"pages.administration.migration.summary.firstParagraph": "The following assignments were made:",
	...
	"pages.administration.school.index.authSystems.deleteAuthSystem": "Delete Authentification",
	"pages.administration.school.index.authSystems.edit": "Edit {system}",
	"pages.administration.school.index.authSystems.loginLinkLabel": "Login-Link of your school",
	"pages.administration.school.index.authSystems.title": "Authentification",
	"pages.administration.school.index.authSystems.type": "Type",
	"pages.administration.school.index.back": "For some settings go ",
	"pages.administration.school.index.backLink": "back to the old administration page here",
	"pages.administration.school.index.error.gracePeriodExceeded":
		"The grace period after finishing migration has expired",
	...
	"pages.administration.school.index.generalSettings.labels.language": "Language",
	"pages.administration.school.index.generalSettings.labels.nameOfSchool": "Name of the school",
	"pages.administration.school.index.generalSettings.labels.schoolYear": "School year",
	"pages.administration.school.index.generalSettings.labels.schoolNumber": "School number",
	"pages.administration.school.index.generalSettings.labels.timezone": "Timezone",
	"pages.administration.school.index.generalSettings.labels.uploadSchoolLogo": "Upload school logo",
	...
	"pages.administration.school.index.generalSettings.save.success": "General settings successfully saved.",
	...
	"pages.administration.school.index.privacySettings.labels.aiTutor": "Activate AI tutor at school",
	...
	"pages.administration.school.index.privacySettings.longText.studentVisibilityBrandenburg":
		"Enabling this option turns on the visibility of all students of this school for each teacher.",
	...
	"pages.administration.school.index.schoolIsCurrentlyDrawing": "Your school is currently getting",
	"pages.administration.school.index.schoolPolicy.cancel": "Cancel",
	"pages.administration.school.index.schoolPolicy.delete.success": "Privacy Policy file was successfully deleted.",
	"pages.administration.school.index.schoolPolicy.delete.text":
		"If you delete this file, the default Privacy Policy will be automatically used.",
	"pages.administration.school.index.schoolPolicy.delete.title": "Delete Privacy Policy",
	"pages.administration.school.index.schoolPolicy.download": "Download Privacy Policy",
	...
	"pages.administration.school.index.schoolPolicy.notUploadedYet": "Not uploaded yet",
	"pages.administration.school.index.schoolPolicy.replace": "Replace",
	...
	"pages.administration.school.index.termsOfUse.delete.success": "Terms of Use file was successfully deleted.",
	"pages.administration.school.index.termsOfUse.delete.text":
		"If you delete this file, the default Terms of Use will be automatically used.",
	"pages.administration.school.index.termsOfUse.delete.title": "Delete Terms of Use",
	"pages.administration.school.index.termsOfUse.download": "Download Terms of Use",
	...
	"pages.administration.school.index.termsOfUse.notUploadedYet": "Not uploaded yet",
	"pages.administration.school.index.termsOfUse.replace": "Replace",
	...
	"pages.administration.school.index.usedFileStorage": "Used file storage in the cloud",
	"pages.administration.select": "select",
	"pages.administration.selected": "selected",
	...
	"pages.administration.students.consent.print.title": "Registration successfully completed",
	"pages.administration.students.consent.print": "Print list with access data",
	"pages.administration.students.consent.steps.complete.info":
		"Make sure that the birth dates of all users are complete and add missing data if necessary.",
	"pages.administration.students.consent.steps.complete.inputerror": "Date of birth missing",
	"pages.administration.students.consent.steps.complete.next": "Apply data",
	"pages.administration.students.consent.steps.complete.warn":
		"Not all users have valid birth dates. Please complete missing birth data first.",
	"pages.administration.students.consent.steps.complete": "Add data",
	"pages.administration.students.consent.steps.download.explanation":
		"These are the passwords for the initial login to the school cloud.\nA new password must be chosen for the first login. Students who are at least 14 years old must also declare their consent when they log in for the first time.",
	"pages.administration.students.consent.steps.download.info":
		"Save and print the list and hand it out to the users for their first registration.",
	"pages.administration.students.consent.steps.download.next": "Download access data",
	"pages.administration.students.consent.steps.download": "Download access data",
	"pages.administration.students.consent.steps.register.analog-consent": "analogous consent form",
	"pages.administration.students.consent.steps.register.confirm.warn":
		"Please confirm that you have received the consent forms from parents and students on paper and that you have read the rules for consent.",
	"pages.administration.students.consent.steps.register.confirm":
		"I hereby confirm that I have received the {analogConsent} on paper from the parents of the above-mentioned students.",
	"pages.administration.students.consent.steps.register.info":
		"Check that you have received the consent of the listed students analogously by handout, you will be required to register on behalf of the users.",
	"pages.administration.students.consent.steps.register.next": "Register users",
	"pages.administration.students.consent.steps.register.print":
		"You can now log in to the cloud with your starting password. Go to {hostName} and log in with the following access details:",
	"pages.administration.students.consent.steps.register.success": "User successfully registered",
	"pages.administration.students.consent.steps.register": "Perform registration",
	"pages.administration.students.consent.steps.success.back": "Back to overview",
	...
	"pages.administration.students.index.tableActions.qr": "Print registration links as QR Code",
	"pages.administration.students.index.tableActions.registration": "Manual registration",
	"pages.administration.students.index.title": "Manage students",
	"pages.administration.students.infobox.headline": "Complete registrations",
	...
	"pages.administration.students.infobox.LDAP.paragraph-1":
		"Deine Schule bezieht sämtliche Login-Daten aus einem Quellsystem (LDAP o.ä.). Die Nutzer können sich mit dem Usernamen und Passwort aus dem Quellsystem in der Schul-Cloud einloggen.",
	"pages.administration.students.infobox.LDAP.paragraph-2":
	...
	"pages.administration.students.infobox.li-1":
		"Send registration links via the school cloud to the e-mail addresses provided (also possible directly while importing/creating)",
	"pages.administration.students.infobox.li-2":
		"Print the registration links as QR sheets, cut them out and distribute the QR sheets to users (or their parents)",
	"pages.administration.students.infobox.li-3":
		"Waive off the digital collection of consents. Use the paper form instead and generate start passwords for your users (More info)",
	"pages.administration.students.infobox.more.info": "(mehr Infos)",
	"pages.administration.students.infobox.paragraph-1":
		"You have the following options to guide the users for completion of the registration:",
	"pages.administration.students.infobox.paragraph-2":
		"To do this, select one or more users, e.g. all students:inside a class. Then carry out the desired action.",
	"pages.administration.students.infobox.paragraph-3":
		"Alternatively, you can switch to the Edit mode of the user profile and retrieve the individual registration link to send it manually by a method of your choice.",
	"pages.administration.students.infobox.paragraph-4":
		"IMPORTANT: For students under 16 years of age, the first thing asked for during the registration process is the consent of a parent or guardian. In this case, we recommend the distribution of registration links as QR-sheets or retrieval of the links individually and sending them to the parents. After the parents have given their consent, the students receive a start password and can complete the last part of the registration on their own at any time. For use of the school cloud at primary schools, paper forms are a popular alternative.",
	"pages.administration.students.infobox.registrationOnly.headline": "Registration information",
	"pages.administration.students.infobox.registrationOnly.li-1":
		"Sending registration links to the stored e-mail addresses (also possible directly during import/creation)",
	"pages.administration.students.infobox.registrationOnly.li-2":
		"Print registration links as QR print sheets, cut them out and distribute QR slips to students",
	"pages.administration.students.infobox.registrationOnly.li-3":
		"Select one or more users, e.g. all students of a class, and then perform the desired action",
	"pages.administration.students.infobox.registrationOnly.li-4":
		"Alternatively: Switch to the edit mode of the user profile and retrieve the individual registration link directly in order to send it manually",
	"pages.administration.students.infobox.registrationOnly.paragraph-1":
		"A declaration of consent does not have to be obtained when registering students. The use of the Schul-Cloud Brandenburg is regulated by the Brandenburg School Act (§ 65 para. 2 BbGSchulG).",
	"pages.administration.students.infobox.registrationOnly.paragraph-2":
		"If the school obtains or receives the user data via an external system, the above options cannot be used. The changes must then be made accordingly in the source system.",
	"pages.administration.students.infobox.registrationOnly.paragraph-3":
		"Otherwise, invitations to register can be sent via link from the cloud administration area:",
	"pages.administration.students.legend.icon.success": "Registration complete",
	"pages.administration.students.manualRegistration.steps.download.explanation":
		"These are the passwords for the initial login. A new password must be chosen for the first login.",
	"pages.administration.students.manualRegistration.steps.success":
		"Congratulations, you have successfully completed the manuel registration!",
	"pages.administration.students.manualRegistration.title": "Manual registration",
	"pages.administration.students.new.checkbox.label": "Send registration link to student",
	"pages.administration.students.new.error":
		"Student could not be added successfully. The e-mail address may already exist.",
	"pages.administration.students.new.success": "Student successfully created!",
	"pages.administration.students.new.title": "Add student",
	...
	"pages.administration.teachers.index.tableActions.qr": "Print registration links as QR Code",
	"pages.administration.teachers.index.title": "Manage teachers",
	"pages.administration.teachers.new.checkbox.label": "Send registration link to teacher",
	"pages.administration.teachers.new.error":
		"Teacher could not be added successfully. The email address may already exist.",
	...
	"pages.courseRooms.createBoard.error": "An error occurred while creating the board.",
	"pages.courseRooms.deleteLesson.error": "An error occurred while deleting the topic.",
	"pages.courseRooms.deleteTask.error": "An error occurred while deleting the task.",
	"pages.courseRooms.deleteBoard.error": "An error occurred while deleting the board.",
	"pages.courseRooms.finishTask.error": "An error occurred while finishing the task.",
	...
	"pages.files.overview.courseFiles": "My course files",
	...
	"pages.files.personal.uploadError": "The file could not be uploaded.",
	"pages.files.legacy.folders": "Folder",
	"pages.files.legacy.files": "Files",
	"pages.files.legacy.createFolder": "Create a new folder",
	"pages.files.legacy.newFolderTitle": "New folder",
	"pages.files.legacy.folderName": "Name of the folder",
	"pages.files.legacy.createFolderSubmit": "Create folder",
	"pages.files.legacy.renameFolder": "Rename folder",
	"pages.files.legacy.renameFile": "Rename file",
	"pages.files.legacy.renameDirTitle": "Rename folder",
	"pages.files.legacy.chooseNewName": "Select a new name:",
	"pages.files.legacy.deleteFile": "Delete file",
	"pages.files.legacy.deleteFolder": "Delete folder",
	"pages.files.legacy.assertDeletion": "Are you sure you want to delete ' {filename} '?",
	"pages.files.legacy.downloadFile": "Download file",
	"pages.files.legacy.shareFile": "Share file",
	"pages.files.legacy.shareLinkTitle": "Share link",
	"pages.files.legacy.shareLinkHint": "Distribute the following link to provide access to the file.",
	"pages.files.legacy.editPermissions": "Edit file permissions",
	"pages.files.legacy.editPermissionsTitle": "Edit permissions",
	"pages.files.legacy.roleUser": "Role / user",
	"pages.files.legacy.read": "Read",
	"pages.files.legacy.write": "Write",
	"pages.files.legacy.noPermissions": "There are no permissions to edit.",
	"pages.files.legacy.permissionsError": "Unfortunately, there was an error while retrieving the permissions.",
	"pages.files.legacy.permissionsSaved": "File permissions changed successfully",
	"pages.files.legacy.renameDirSuccess": "The folder was renamed successfully!",
	"pages.files.legacy.renameFileSuccess": "The file was renamed successfully!",
	"pages.files.legacy.fileMoved": "The file was moved successfully!",
	"pages.files.legacy.fileBlocked": "The file may contain malicious content",
	"pages.files.legacy.dangerousCode": "Malicious code",
	"pages.files.legacy.personalTitle": "Personal files",
	"pages.files.legacy.courseTitle": "Course files",
	"pages.files.legacy.teamTitle": "Team files",
	"pages.files.legacy.sharedTitle": "Shared files",
	"pages.files.legacy.myPersonalData": "My personal files",
	"pages.files.legacy.filesFromMyCourse": "Files from my courses",
	"pages.files.legacy.filesFromMyTeam": "Files from my teams",
	"pages.files.legacy.filesSharedWithMe": "Files shared with me",
	"pages.files.legacy.noAccess": "You don't have access to this file!",
	"pages.files.legacy.selectFolder": "Select a folder",
	"pages.files.legacy.uploadHint": "Place files to upload here, or search computer",
	"pages.files.legacy.uploading": "Files uploading",
	"pages.files.legacy.toTeam": "To the team",
	"pages.files.legacy.toCourse": "To the course",
	"pages.files.legacy.sortBy": "Sort by...",
	"pages.files.legacy.sort.createdAt": "Creation date",
	"pages.files.legacy.sort.updatedAt": "Modification date",
	"pages.files.legacy.sort.name": "File name",
	"pages.files.legacy.sort.size": "Size",
	"pages.files.legacy.openFolder": "open folder {name}",
	"pages.files.legacy.openFile": "open file {name}",
	"pages.files.legacy.close": "Close",
	"pages.files.legacy.uploadSuccess": "File (s) saved successfully.",
	"pages.files.legacy.openError": "Error while opening the file",
	"pages.files.legacy.dirExists": "A folder with this name already exists in the same folder!",
	"pages.files.legacy.sorting": "Sorting",
	"pages.files.legacy.role.teacher": "Teacher",
	"pages.files.legacy.role.student": "Students",
	"pages.files.legacy.role.teammember": "Attendee",
	"pages.files.legacy.role.teamexpert": "Expert",
	"pages.files.legacy.role.teamleader": "Leader",
	"pages.files.legacy.role.teamadministrator": "Administrator",
	"pages.files.legacy.role.teamowner": "Owner",
	"pages.files.legacy.myPersonalDataContent":
		"Here you can find all your personal files. Only you have access to these files, but you can also share them with other users.",
	"pages.files.legacy.filesSharedWithMeContent":
		"Here you can find all the files you have shared with you. These are files that have been made available by other users.",
	"pages.files.legacy.copyLink": "Copy link",
	"pages.files.legacy.linkCopied": "Link copied to the clipboard",
	"pages.files.legacy.moveFile": "Move file",
	"pages.files.legacy.moveFolder": "Move folder",
	"pages.files.legacy.moveError": "The file could not be moved.",
	"pages.files.legacy.actionError": "The action could not be completed.",
	...
	"pages.room.copy.course.message.copied": "Course was successfully duplicated.",
	"pages.room.copy.course.message.partiallyCopied": "The course could not be duplicated completely.",
	...
	"pages.tasks.due": "Deadline",
	"pages.tasks.overdue": "Overdue",
	...
	"pages.rooms.importCourse.importError":
		"Unfortunately, we were not able to import the entire course content. We are aware of the bug and will fix it in the coming months.",
	"pages.rooms.importCourse.importErrorButton": "Okay, understood",
	...
	"pages.rooms.importCourse.step_2": "Paste the code here to import the shared course.",
	...
	"pages.rooms.ccImportCourse.importSuccess":
		"Your course file '{file}' has been successfully imported and will be available in the course overview after reloading.",
	"pages.rooms.ccImportCourse.importError": "An error occurred while importing the course file '{file}'.",
	...
	"pages.roomCreate.templates.title": "How would you like to start?",
	"pages.roomCreate.templates.subtitle":
		"Pick a template. Everything in it can be renamed, moved and deleted afterwards.",
	"pages.roomCreate.templates.change": "Change template",
	"pages.roomCreate.templates.preview.title": "This will be created",
	"pages.roomCreate.templates.preview.more": "+{count} more",
	"pages.roomCreate.templates.applying": "The room is being created from the template …",
	"pages.roomCreate.templates.applyError": "Not all template content could be created. You can add it in the room.",
	"pages.roomCreate.templates.element.text": "Text",
	"pages.roomCreate.templates.element.link": "Link",
	"pages.roomCreate.templates.element.boardLink": "Reference to a section",
	"pages.roomCreate.templates.element.folder": "File folder",
	"pages.roomCreate.templates.element.drawing": "Whiteboard",
	"pages.roomCreate.templates.element.collaborative": "Shared text document",
	"pages.roomCreate.templates.element.videoConference": "Video conference",
	"pages.roomCreate.templates.folder.material": "Material folder",
	"pages.roomCreate.templates.folder.results": "Submission folder",
	"pages.roomCreate.templates.folder.parents": "Letters to parents",
	"pages.roomCreate.templates.folder.minutes": "Minutes",
	"pages.roomCreate.templates.subject.cards.links.text":
		"<p>Links to explainer videos, practice sites and reference works belong here.</p>",
	"pages.roomCreate.templates.project.cards.ideas.title": "Idea collection",
	"pages.roomCreate.templates.project.cards.ideas.text": "<p>Collect and sort first ideas on the whiteboard.</p>",
	"pages.roomCreate.templates.classroom.cards.toOrganisation.title": "To the class organisation",
	"pages.roomCreate.templates.team.cards.latest.conference": "Team meeting",
	"pages.roomCreate.ai.title": "Start with ai",
	"pages.roomCreate.ai.subtitle":
		"Describe your room in your own words. The ai suggests a structure you can check before it is created.",
	"pages.roomCreate.ai.label": "Description",
	"pages.roomCreate.ai.placeholder": "e.g. maths year 9, fractions over three weeks with practice and a self-check",
	"pages.roomCreate.ai.generate": "Suggest a structure",
	"pages.roomCreate.ai.preview": "The ai is writing the suggestion. Everything in it can be changed later.",
	"pages.roomCreate.ai.discard": "Discard",
	"pages.roomCreate.ai.accept": "Use this",
	"pages.roomCreate.ai.error": "The suggestion could not be created. Try again or pick a template.",
	"pages.roomCreate.templates.params.title": "Adjust template",
	"pages.roomCreate.templates.params.subject": "Subject",
	"pages.roomCreate.templates.params.grade": "Class / year",
	"pages.roomCreate.templates.params.weeks": "Number of weeks",
	"pages.roomCreate.templates.params.projectName": "Project name",
	"pages.roomCreate.templates.params.groups": "Number of groups",
	"pages.roomCreate.templates.params.className": "Class",
	"pages.roomCreate.templates.params.topic": "Topic",
	"pages.roomCreate.templates.weeklyPlan.columns.week": "Week {index}",
	"pages.roomCreate.templates.project.cards.group.title": "Group {index}",
	"pages.roomCreate.templates.project.cards.group.text":
		"<p>Tasks, responsibilities and progress of group {index}.</p>",
	"pages.roomCreate.templates.blank.title": "Empty room",
	"pages.roomCreate.templates.blank.description": "Start without a template and create the sections yourself.",
	"pages.roomCreate.templates.subject.title": "Subject room",
	"pages.roomCreate.templates.subject.description":
		"A room for one subject across the school year: organisation, material, tasks and dates.",
	"pages.roomCreate.templates.subject.roomName": "{subject} {grade}",
	"pages.roomCreate.templates.subject.boards.overview": "Overview",
	"pages.roomCreate.templates.subject.columns.organisation": "Organisation",
	"pages.roomCreate.templates.subject.columns.material": "Material",
	"pages.roomCreate.templates.subject.columns.tasks": "Tasks",
	"pages.roomCreate.templates.subject.columns.dates": "Dates & exams",
	"pages.roomCreate.templates.subject.cards.welcome.title": "Welcome",
	"pages.roomCreate.templates.subject.cards.welcome.text":
		"<p>Welcome to {subject}! Here you find everything important about the subject.</p><p>Replace this text with your own welcome note.</p>",
	"pages.roomCreate.templates.subject.cards.rules.title": "Rules & grading",
	"pages.roomCreate.templates.subject.cards.rules.text":
		"<ul><li>How is the grade composed?</li><li>Which materials are needed?</li><li>Which rules apply in class?</li></ul>",
	"pages.roomCreate.templates.subject.cards.material.title": "Scripts & worksheets",
	"pages.roomCreate.templates.subject.cards.material.text": "<p>Upload files or link to materials.</p>",
	"pages.roomCreate.templates.subject.cards.links.title": "Link collection",
	"pages.roomCreate.templates.subject.cards.currentTask.title": "Current task",
	"pages.roomCreate.templates.subject.cards.currentTask.text":
		"<p><strong>Task:</strong> …</p><p><strong>Due:</strong> …</p>",
	"pages.roomCreate.templates.subject.cards.nextDates.title": "Upcoming dates",
	"pages.roomCreate.templates.subject.cards.nextDates.text": "<ul><li>Exam: …</li><li>Excursion: …</li></ul>",
	"pages.roomCreate.templates.weeklyPlan.title": "Weekly plan",
	"pages.roomCreate.templates.weeklyPlan.description":
		"The weekly rhythm at a glance: this week, preview, support material and done.",
	"pages.roomCreate.templates.weeklyPlan.roomName": "Weekly plan {subject}",
	"pages.roomCreate.templates.weeklyPlan.boards.week": "Weekly plan",
	"pages.roomCreate.templates.weeklyPlan.columns.help": "Material & support",
	"pages.roomCreate.templates.weeklyPlan.columns.done": "Done",
	"pages.roomCreate.templates.weeklyPlan.cards.goals.title": "Learning goals",
	"pages.roomCreate.templates.weeklyPlan.cards.goals.text": "<ul><li>I can …</li><li>I can …</li></ul>",
	"pages.roomCreate.templates.weeklyPlan.cards.tasks.title": "Tasks of the week",
	"pages.roomCreate.templates.weeklyPlan.cards.tasks.text": "<ol><li>…</li><li>…</li></ol>",
	"pages.roomCreate.templates.weeklyPlan.cards.help.title": "Explanations & videos",
	"pages.roomCreate.templates.weeklyPlan.cards.help.text":
		"<p>Support material for working independently goes here.</p>",
	"pages.roomCreate.templates.weeklyPlan.cards.archive.title": "Archive",
	"pages.roomCreate.templates.weeklyPlan.cards.archive.text": "<p>Drag finished cards here.</p>",
	"pages.roomCreate.templates.project.title": "Project & group work",
	"pages.roomCreate.templates.project.description":
		"From the project brief to the presentation – for project weeks and group work.",
	"pages.roomCreate.templates.project.roomName": "{projectName}",
	"pages.roomCreate.templates.project.boards.project": "Project board",
	"pages.roomCreate.templates.project.columns.briefing": "Project brief",
	"pages.roomCreate.templates.project.columns.todo": "To do",
	"pages.roomCreate.templates.project.columns.doing": "In progress",
	"pages.roomCreate.templates.project.columns.done": "Done",
	"pages.roomCreate.templates.project.columns.results": "Results",
	"pages.roomCreate.templates.project.cards.goal.title": "Goal & guiding question",
	"pages.roomCreate.templates.project.cards.goal.text":
		"<p><strong>Guiding question:</strong> …</p><p><strong>Result:</strong> …</p>",
	"pages.roomCreate.templates.project.cards.team.title": "Team & roles",
	"pages.roomCreate.templates.project.cards.team.text":
		"<ul><li>Project lead: …</li><li>Research: …</li><li>Presentation: …</li></ul>",
	"pages.roomCreate.templates.project.cards.schedule.title": "Schedule",
	"pages.roomCreate.templates.project.cards.schedule.text":
		"<ul><li>Start: …</li><li>Interim review: …</li><li>Submission: …</li></ul>",
	"pages.roomCreate.templates.project.cards.presentation.title": "Presentation & feedback",
	"pages.roomCreate.templates.project.cards.presentation.text": "<p>Collect results, presentations and feedback.</p>",
	"pages.roomCreate.templates.classroom.title": "Class room",
	"pages.roomCreate.templates.classroom.description":
		"For the class teacher: news, class organisation, dates and information for parents.",
	"pages.roomCreate.templates.classroom.roomName": "Class {className}",
	"pages.roomCreate.templates.classroom.boards.news": "News",
	"pages.roomCreate.templates.classroom.boards.organisation": "Class organisation",
	"pages.roomCreate.templates.classroom.columns.announcements": "Announcements",
	"pages.roomCreate.templates.classroom.columns.duties": "Class duties",
	"pages.roomCreate.templates.classroom.columns.rules": "Rules & agreements",
	"pages.roomCreate.templates.classroom.columns.dates": "Dates & trips",
	"pages.roomCreate.templates.classroom.columns.parents": "For parents",
	"pages.roomCreate.templates.classroom.cards.welcome.title": "Welcome to our class",
	"pages.roomCreate.templates.classroom.cards.welcome.text":
		"<p>Current information for class {className} – the most important on top.</p>",
	"pages.roomCreate.templates.classroom.cards.thisWeek.title": "This week",
	"pages.roomCreate.templates.classroom.cards.thisWeek.text": "<ul><li>Monday: …</li><li>Tuesday: …</li></ul>",
	"pages.roomCreate.templates.classroom.cards.dutyPlan.title": "Duty roster",
	"pages.roomCreate.templates.classroom.cards.dutyPlan.text":
		"<ul><li>Blackboard duty: …</li><li>Tidying duty: …</li></ul>",
	"pages.roomCreate.templates.classroom.cards.classRules.title": "Our class rules",
	"pages.roomCreate.templates.classroom.cards.classRules.text": "<ol><li>…</li><li>…</li></ol>",
	"pages.roomCreate.templates.classroom.cards.nextDates.title": "Upcoming dates",
	"pages.roomCreate.templates.classroom.cards.parentInfo.title": "Information for parents",
	"pages.roomCreate.templates.classroom.cards.parentInfo.text": "<p>Parents' evenings, forms and contact persons.</p>",
	"pages.roomCreate.templates.team.title": "Department & team",
	"pages.roomCreate.templates.team.description":
		"Collaboration among colleagues: announcements, materials, minutes and responsibilities.",
	"pages.roomCreate.templates.team.roomName": "Department {subject}",
	"pages.roomCreate.templates.team.boards.team": "Team room",
	"pages.roomCreate.templates.team.columns.announcements": "Announcements",
	"pages.roomCreate.templates.team.columns.material": "Materials & curriculum",
	"pages.roomCreate.templates.team.columns.minutes": "Minutes & decisions",
	"pages.roomCreate.templates.team.columns.tasks": "Tasks & responsibilities",
	"pages.roomCreate.templates.team.cards.latest.title": "News",
	"pages.roomCreate.templates.team.cards.latest.text": "<p>Short updates for the team.</p>",
	"pages.roomCreate.templates.team.cards.curriculum.title": "School curriculum",
	"pages.roomCreate.templates.team.cards.curriculum.text":
		"<p>Syllabi, material collections and agreements on the subject.</p>",
	"pages.roomCreate.templates.team.cards.lastMeeting.title": "Last meeting",
	"pages.roomCreate.templates.team.cards.lastMeeting.text":
		"<p><strong>Date:</strong> …</p><p><strong>Decisions:</strong> …</p>",
	"pages.roomCreate.templates.team.cards.responsibilities.title": "Who does what?",
	"pages.roomCreate.templates.team.cards.responsibilities.text":
		"<ul><li>Collection: …</li><li>Ordering material: …</li></ul>",
	"pages.roomCreate.templates.selfStudy.title": "Self-study unit",
	"pages.roomCreate.templates.selfStudy.description":
		"A learning path in four steps: intro, working phase, practice and consolidation.",
	"pages.roomCreate.templates.selfStudy.roomName": "Self-study unit {topic}",
	"pages.roomCreate.templates.selfStudy.boards.path": "Learning path",
	"pages.roomCreate.templates.selfStudy.columns.intro": "1 – Intro",
	"pages.roomCreate.templates.selfStudy.columns.learn": "2 – Working phase",
	"pages.roomCreate.templates.selfStudy.columns.practice": "3 – Practice",
	"pages.roomCreate.templates.selfStudy.columns.secure": "4 – Consolidation",
	"pages.roomCreate.templates.selfStudy.cards.hook.title": "Intro",
	"pages.roomCreate.templates.selfStudy.cards.hook.text":
		"<p>How do learners get started with {topic}: video, image or question?</p>",
	"pages.roomCreate.templates.selfStudy.cards.input.title": "Material & input",
	"pages.roomCreate.templates.selfStudy.cards.input.text":
		"<p>Texts, videos and explanations for working independently.</p>",
	"pages.roomCreate.templates.selfStudy.cards.exercises.title": "Practice tasks",
	"pages.roomCreate.templates.selfStudy.cards.exercises.text":
		"<ol><li>Basic task</li><li>In-depth task</li><li>Extra task for fast learners</li></ol>",
	"pages.roomCreate.templates.selfStudy.cards.check.title": "Self-check",
	"pages.roomCreate.templates.selfStudy.cards.check.text":
		"<ul><li>I can now: …</li><li>I still need help with: …</li></ul>",
	...
	"pages.roomDetails.fab.add.board": "Create board",
	...
	"pages.rooms.members.error.updateRole": "The change of the room permission has failed.",
	...
	"pages.rooms.members.add.students.studentAdmins": "Students can only add students from their own class to a room.",
	...
	"pages.rooms.members.actionMenu.ariaLabel": "Action menu for {memberFullName}",
	"pages.rooms.members.actionMenu.selectedMembers": "Action menu for {count} selected participants",
	"pages.rooms.members.changePermission": "Change room permissions",
	"pages.rooms.members.changePermission.ariaLabel": "Change room permissions for {memberFullName}",
	...
	"pages.rooms.members.remove.ariaLabel": "Remove {memberFullName} from the room",
	"pages.rooms.members.resetSelection.ariaLabel": "Reset selected members from the list",
	"pages.rooms.members.multipleRemove.ariaLabel": "Remove multiple members from the room",
	"pages.rooms.members.remove.confirmation": "Remove {memberFullName} from the room?",
	"pages.rooms.members.multipleRemove.confirmation": "Remove selected members from the room?",
	...
	"pages.rooms.members.roleChange.Roomviewer.label": "Access the boards in the room and view content",
	...
	"pages.rooms.members.roleChange.Roomowner.label": "Same permissions as “Administer”, additionally delete room",
	"pages.rooms.members.roleChange.Roomowner.label.subText":
		"Attention: Only one person in the room can receive this permission!",
	"pages.rooms.members.roleChange.dialogTitle.handOver": "Transfer room permission “own”?",
	"pages.rooms.members.roleChange.handOverBtn.text": "Transfer ownership",
	"pages.rooms.members.handOverAlert.label": "This room's permissions are being transferred to {memberFullName}.",
	...
	"pages.rooms.members.invitationTable.multipleDelete.confirmation": "Delete selected invitation links?",
	"pages.rooms.members.invitationTable.delete.confirmation": "Delete the invitation link '{invitation}'?",
	"pages.rooms.members.confirmationTable.menus.confirm.label": "Confirm membership request",
	"pages.rooms.members.confirmationTable.menus.reject.label": "Reject membership request",
	"pages.rooms.members.confirmationTable.notification.confirm": "{fullName} has been added as a room member.",
	"pages.rooms.members.confirmationTable.notification.reject": "{fullName}'s request to join was rejected.",
	...
	"pages.rooms.members.confirmationTable.actionMenu.ariaLabel": "Action menu for {fullName}",
	"pages.rooms.members.confirmationTable.actionMenu.confirm.ariaLabel": "Confirm the membership request for {fullName}",
	...
	"pages.rooms.administration.table.row.actionMenu.ariaLabel": "Action menu for room “{roomName}”",
	"pages.rooms.administration.table.actionMenu.delete": "Delete room",
	"pages.rooms.administration.table.actionMenu.manageRoom": "Manage room members",
	...
	"pages.tool.apiError.tool_param_required":
		"Inputs for mandatory parameters are still missing for the configuration of this tool. Please enter the missing values.",
	...
	"pages.tool.context.displayNameDescription": "The tool display name can be overridden and must be unique",
	...
	"pages.tool.select.description": "Type the address, or use the button to paste it from the clipboard",
	...
	"pages.userMigration.description.firstParagraph.fromSource": "You can now migrate your account to {targetSystem}.",
	...
	"pages.userMigration.error.description.fail": "Unfortunately, the move of your account to {targetSystem} failed.",
	"pages.userMigration.error.description.support": "Please contact the administrator or {0} directly.",
	...
	"pages.userMigration.error.schoolNumberMismatch.information": "Please pass on this information:",
	...
	"pages.userMigration.success.description": "The move of your account to {targetSystem} is complete.",
	"pages.userMigration.success.description.loginAgain": "Please register again now.",
	"pages.userMigration.success.login": "Login via {targetSystem}",
	"pages.userMigration.success.title": "Successful migration of your registration system",
	...
	"ui-confirmation-dialog.ask-delete-type": "Delete {itemType}?",
	...
	"utils.adminFilter.consent.label.parentsAgreementMissing": "Student agreement missing",
	"utils.adminFilter.consent.missing": "not available",
	"utils.adminFilter.consent.ok": "completely",
	"utils.adminFilter.consent.parentsAgreed": "only parents have agreed",
	"utils.adminFilter.consent.title": "Registrations",
	"utils.adminFilter.consent": "Consent form:",
	"utils.adminFilter.date.created": "Created between",
	"utils.adminFilter.date.label.from": "Date from",
	"utils.adminFilter.date.label.until": "Date until",
	"utils.adminFilter.date.title": "Creation date",
	"utils.adminFilter.lastMigration.label.from": "Last migrated on from",
	"utils.adminFilter.lastMigration.label.until": "Last migrated on until",
	"utils.adminFilter.lastMigration.title": "Last migrated on",
	"utils.adminFilter.outdatedSince.label.from": "Obsolete since from",
	"utils.adminFilter.outdatedSince.label.until": "Obsolete since until",
	"utils.adminFilter.outdatedSince.title": "Obsolete since",
	"utils.adminFilter.placeholder.class": "Filter by class...",
	"utils.adminFilter.placeholder.complete.lastname": "Filter by full last name...",
	...
	"pages.folder.delete-multiple-confirmation": "Move all {total} files to trash?",
	"pages.folder.delete-confirmation": "Move file {name} to trash?",
	...
	"pages.folder.trash.title": "Trash: {folderName}",
	"pages.folder.trash.breadcrumb": "Trash",
