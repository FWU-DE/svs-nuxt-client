export default {
	...
	"pages.files.personal.missingContext": "Personal files cannot be loaded without user and school context.",
	"pages.files.personal.title": "Personal files",
	"pages.files.personal.uploadHint": "Place files to upload here, or search computer",
	"pages.files.personal.sortBy": "Sort by...",
	"pages.files.personal.sortOrder": "Sorting",
	"pages.files.personal.sort.createdAt": "Creation date",
	"pages.files.personal.sort.updatedAt": "Modification date",
	"pages.files.personal.sort.name": "File name",
	"pages.files.personal.sort.size": "Size",
	"pages.files.personal.download": "Download file",
