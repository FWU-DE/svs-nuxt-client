export default {
	...
	"pages.helpContact.consent": "I agree that the following information may transferred for better handling of my problem:",
	...
	"pages.helpContact.knownText": "Have you checked if your problem is already known? It helps us to solve problems faster if only new issues are shared.",
	"pages.helpContact.knownStatus": "Additionally you can check our status page to see, if we currently have problems with our technical systems.",
	...
	"pages.helpContact.consentWish": "I agree that the following information may be transferred for better handling of my request:",
	...
	"pages.helpContact.acceptancePlaceholder": "For example, after logging in to the system, I reach the lesson context in maximum two steps, can edit the student task there with a click and, if necessary, automatically inform the students about the change.",
