export default {
	...
	"global.sidebar.item.formerMemberships": "Former memberships",
	...
	"pages.formerMemberships.title": "Former memberships",
	"pages.formerMemberships.info":
		"After a school change, you lost access to the following courses/rooms. You can bring a copy along to your current school here, or discard the entry.",
	"pages.formerMemberships.table.name": "Name",
	"pages.formerMemberships.table.type": "Type",
	"pages.formerMemberships.reclaim.action": "Reclaim",
	"pages.formerMemberships.reclaim.confirmation":
		"Do you want to bring a copy of “{itemName}” along to your current school? The original will remain unchanged.",
	"pages.formerMemberships.reclaim.success": "A copy of “{itemName}” has been added to your current school.",
	"pages.formerMemberships.reclaim.error": "The copy could not be created.",
	"pages.formerMemberships.reclaim.noLongerAvailable": "“{itemName}” no longer exists and cannot be copied.",
	"pages.formerMemberships.discard.action": "Discard",
	"pages.formerMemberships.discard.confirmation": "Do you want to discard “{itemName}”? This cannot be undone.",
	"pages.formerMemberships.discard.success": "“{itemName}” has been discarded.",
	"pages.formerMemberships.discard.error": "“{itemName}” could not be discarded.",
	"pages.formerMemberships.dashboardBanner.dismiss": "Don't show this again",
