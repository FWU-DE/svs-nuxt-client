export default {
	...
	"global.sidebar.item.nostrSearch": "Nostr search",
	...
	"pages.nostrSearch.title": "Nostr search",
	"pages.nostrSearch.subtitle": "Search open educational resources, notes and profiles on the Nostr network.",
	"pages.nostrSearch.searchLabel": "Search term",
	"pages.nostrSearch.searchAction": "Search",
	"pages.nostrSearch.mode.notes": "Notes",
	"pages.nostrSearch.mode.profiles": "Profiles",
	"pages.nostrSearch.disclaimer":
		"Results come from public Nostr relays and are neither moderated nor reviewed by the school or the cloud.",
	"pages.nostrSearch.empty": "No results. A different search term or additional relays may help.",
	"pages.nostrSearch.resultCount": "{count} results",
	"pages.nostrSearch.error.tooShort": "Please enter at least two characters.",
	"pages.nostrSearch.error.noRelays": "No relay is active. Please switch on at least one relay.",
	"pages.nostrSearch.error.allRelaysFailed": "No relay could be reached. Please try again later.",
	"pages.nostrSearch.relays.title": "Relays",
	"pages.nostrSearch.relays.summary": "{active} of {total} active",
	"pages.nostrSearch.relays.description":
		"Nostr has no central index: a search only reaches the relays it asks. Not every relay supports full-text search (NIP-50).",
	"pages.nostrSearch.relays.toggle": "Switch relay {relay} on or off",
	"pages.nostrSearch.relays.remove": "Remove relay {relay}",
	"pages.nostrSearch.relays.add": "Add",
	"pages.nostrSearch.relays.addLabel": "Relay address (wss://)",
	"pages.nostrSearch.relays.invalid": "Please enter a valid wss:// address that is not on the list yet.",
	"pages.nostrSearch.relays.reset": "Reset",
	"pages.nostrSearch.relay.state.searching": "Searching …",
	"pages.nostrSearch.relay.state.matches": "{count} results",
	"pages.nostrSearch.relay.state.noSearchSupport": "No full-text search (NIP-50)",
	"pages.nostrSearch.relay.error.unreachable": "Not reachable",
	"pages.nostrSearch.relay.error.timeout": "No response",
	"pages.nostrSearch.relay.error.rejected": "Request rejected",
	"pages.nostrSearch.result.open": "Open",
	"pages.nostrSearch.result.copy": "Copy ID",
	"pages.nostrSearch.result.copied": "Copied",
	"pages.nostrSearch.mode.resources": "Learning resources",
	"pages.nostrSearch.result.note": "Note",
	"pages.nostrSearch.result.free": "Free to access",
	"pages.nostrSearch.result.addToBoard": "To board",
	"pages.nostrSearch.board.title": "Add to a board",
	"pages.nostrSearch.board.description": "“{title}” will be added as a new card.",
	"pages.nostrSearch.board.room": "Room",
	"pages.nostrSearch.board.board": "Board",
	"pages.nostrSearch.board.empty": "This room has no board you are allowed to edit.",
	"pages.nostrSearch.board.confirm": "Add",
	"pages.nostrSearch.board.success": "The card was created.",
	"pages.nostrSearch.board.open": "Open board",
	"pages.nostrSearch.board.error.rooms": "The rooms could not be loaded.",
	"pages.nostrSearch.board.error.boards": "The boards of this room could not be loaded.",
	"pages.nostrSearch.board.error.add": "The card could not be created.",
	"pages.nostrSearch.board.label.source": "Source",
	"pages.nostrSearch.board.label.license": "Licence",
	"pages.nostrSearch.board.label.via": "Found through the Nostr search",
	"pages.nostrSearch.board.label.fallbackTitle": "Find from the Nostr search",
