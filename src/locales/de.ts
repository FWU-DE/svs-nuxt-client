export default {
	...
	"global.sidebar.item.nostrSearch": "Nostr-Suche",
	...
	"pages.nostrSearch.title": "Nostr-Suche",
	"pages.nostrSearch.subtitle": "Offene Bildungsinhalte, Notizen und Profile im Nostr-Netzwerk durchsuchen.",
	"pages.nostrSearch.searchLabel": "Suchbegriff",
	"pages.nostrSearch.searchAction": "Suchen",
	"pages.nostrSearch.mode.notes": "Notizen",
	"pages.nostrSearch.mode.profiles": "Profile",
	"pages.nostrSearch.disclaimer":
		"Die Treffer stammen aus öffentlichen Nostr-Relays und werden weder von der Schule noch von der Schul-Cloud moderiert oder geprüft.",
	"pages.nostrSearch.empty": "Keine Treffer. Ein anderer Suchbegriff oder zusätzliche Relays können helfen.",
	"pages.nostrSearch.resultCount": "{count} Treffer",
	"pages.nostrSearch.error.tooShort": "Bitte mindestens zwei Zeichen eingeben.",
	"pages.nostrSearch.error.noRelays": "Es ist kein Relay aktiv. Bitte mindestens ein Relay einschalten.",
	"pages.nostrSearch.error.allRelaysFailed": "Kein Relay war erreichbar. Bitte später noch einmal versuchen.",
	"pages.nostrSearch.relays.title": "Relays",
	"pages.nostrSearch.relays.summary": "{active} von {total} aktiv",
	"pages.nostrSearch.relays.description":
		"Nostr hat keinen zentralen Index: gesucht wird nur dort, wo gefragt wird. Nicht jedes Relay unterstützt die Volltextsuche (NIP-50).",
	"pages.nostrSearch.relays.toggle": "Relay {relay} ein- oder ausschalten",
	"pages.nostrSearch.relays.remove": "Relay {relay} entfernen",
	"pages.nostrSearch.relays.add": "Hinzufügen",
	"pages.nostrSearch.relays.addLabel": "Relay-Adresse (wss://)",
	"pages.nostrSearch.relays.invalid": "Bitte eine gültige wss://-Adresse eingeben, die noch nicht in der Liste steht.",
	"pages.nostrSearch.relays.reset": "Zurücksetzen",
	"pages.nostrSearch.relay.state.searching": "Suche läuft …",
	"pages.nostrSearch.relay.state.matches": "{count} Treffer",
	"pages.nostrSearch.relay.state.noSearchSupport": "Keine Volltextsuche (NIP-50)",
	"pages.nostrSearch.relay.error.unreachable": "Nicht erreichbar",
	"pages.nostrSearch.relay.error.timeout": "Keine Antwort",
	"pages.nostrSearch.relay.error.rejected": "Anfrage abgelehnt",
	"pages.nostrSearch.result.open": "Öffnen",
	"pages.nostrSearch.result.copy": "ID kopieren",
	"pages.nostrSearch.result.copied": "Kopiert",
	"pages.nostrSearch.mode.resources": "Bildungsinhalte",
	"pages.nostrSearch.result.note": "Notiz",
	"pages.nostrSearch.result.free": "Frei zugänglich",
	"pages.nostrSearch.result.addToBoard": "Zu Board",
	"pages.nostrSearch.board.title": "Zu einem Board hinzufügen",
	"pages.nostrSearch.board.description": "„{title}“ wird als neue Karte angelegt.",
	"pages.nostrSearch.board.room": "Raum",
	"pages.nostrSearch.board.board": "Board",
	"pages.nostrSearch.board.empty": "In diesem Raum gibt es kein Board, das du bearbeiten darfst.",
	"pages.nostrSearch.board.confirm": "Hinzufügen",
	"pages.nostrSearch.board.success": "Die Karte wurde angelegt.",
	"pages.nostrSearch.board.open": "Board öffnen",
	"pages.nostrSearch.board.error.rooms": "Die Räume konnten nicht geladen werden.",
	"pages.nostrSearch.board.error.boards": "Die Boards dieses Raums konnten nicht geladen werden.",
	"pages.nostrSearch.board.error.add": "Die Karte konnte nicht angelegt werden.",
	"pages.nostrSearch.board.label.source": "Quelle",
	"pages.nostrSearch.board.label.license": "Lizenz",
	"pages.nostrSearch.board.label.via": "Gefunden über die Nostr-Suche",
	"pages.nostrSearch.board.label.fallbackTitle": "Fund aus der Nostr-Suche",
