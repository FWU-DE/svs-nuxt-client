export default {
	...
	"pages.files.personal.missingContext":
		"Persönliche Dateien können ohne Benutzer- und Schulkontext nicht geladen werden.",
	"pages.files.personal.title": "Persönliche Dateien",
	"pages.files.personal.uploadHint": "Dateien zum Hochladen hier ablegen oder Computer durchsuchen",
	"pages.files.personal.sortBy": "Sortieren nach...",
	"pages.files.personal.sortOrder": "Sortierung",
	"pages.files.personal.sort.createdAt": "Erstelldatum",
	"pages.files.personal.sort.updatedAt": "Änderungsdatum",
	"pages.files.personal.sort.name": "Dateiname",
	"pages.files.personal.sort.size": "Größe",
	"pages.files.personal.download": "Datei herunterladen",
