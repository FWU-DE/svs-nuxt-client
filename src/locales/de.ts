export default {
	...
	"common.actions.moveToTrash": "In Papierkorb verschieben",
	...
	"common.actions.show.all": "Alle anzeigen",
	...
	"common.labels.class": "Klasse",
	"common.labels.classes": "Klasse(n)",
	"common.labels.close": "Schließen",
	"common.labels.collapse": "einklappen",
	"common.labels.collapsed": "eingeklappt",
	"common.labels.complete.firstName": "Vollständiger Vorname",
	...
	"common.labels.description": "Beschreibung",
	"common.labels.email": "E-Mail",
	"common.labels.expand": "expandieren",
	...
	"common.labels.repeat.email": "Neue E-Mail",
	...
	"common.notifications.errors.notFinished":
	...
	"common.placeholder.lastName": "Fall",
	"common.placeholder.password.confirmation": "Durch Passwort bestätigen",
	"common.placeholder.password.current": "Aktuelles Passwort",
	"common.placeholder.password.new.confirmation": "Neues Passwort wiederholen",
	"common.placeholder.password.new": "Neues Passwort",
	...
	"common.words.color.blue-grey": "Blaugrau",
	"common.words.color.brown": "Braun",
	"common.words.color.green": "Grün",
	"common.words.color.light-blue": "Hellblau",
	...
	"components.board.ai.action": "Mit KI ergänzen",
	"components.board.ai.preset.material": "Material finden",
	"components.board.ai.preset.material.hint": "Offene Bildungsmaterialien suchen und als Karten mit Link einfügen.",
	"components.board.ai.search.label": "Suchbegriff",
	...
	"components.board.ai.source.card": "Grundlage ist diese Karte",
	"components.board.ai.source.column": "Grundlage sind alle Karten dieser Spalte",
	"components.board.ai.preset.differentiate": "Differenzieren",
	"components.board.ai.preset.differentiate.hint":
		"Zwei Varianten derselben Aufgabe: eine mit mehr Stützung, eine mit höherem Anspruch.",
	"components.board.ai.preset.exercises": "Übungsaufgaben",
	"components.board.ai.preset.exercises.hint":
		"Aufgaben mit steigender Schwierigkeit, dazu eine Karte mit Lösungshinweisen.",
	"components.board.ai.preset.simplify": "Sprache vereinfachen",
	"components.board.ai.preset.simplify.hint":
		"Derselbe Inhalt in kurzen Sätzen, Fachbegriffe erklärt – für DaZ und inklusiven Unterricht.",
	"components.board.ai.preset.selfCheck": "Selbstcheck",
	"components.board.ai.preset.selfCheck.hint": "„Das kann ich jetzt …“-Fragen zum Selbstprüfen, plus kurze Antworten.",
	"components.board.ai.preset.free": "Freie Eingabe",
	"components.board.ai.preset.free.hint": "Beschreibe selbst, welche Karten entstehen sollen.",
	"components.board.ai.prompt.label": "Auftrag",
	"components.board.ai.prompt.placeholder": "z. B. Schreibe drei Exit-Ticket-Fragen zum Inhalt",
	"components.board.ai.generate": "Vorschlag erzeugen",
	"components.board.ai.regenerate": "Neu erzeugen",
	"components.board.ai.insert": "{count} Karten einfügen",
	"components.board.ai.error": "Der Vorschlag konnte nicht erzeugt werden. Bitte versuche es noch einmal.",
	"components.board.ai.insertError": "Nicht alle Karten konnten eingefügt werden.",
	...
	"components.board.menu.pollElement": "Umfrage-Einstellungen",
	"components.board.menu.deadlineElement": "Termin-Einstellungen",
	"components.board.menu.codeElement": "Code-Einstellungen",
	...
	"components.cardElement.recordingElement.waveform": "Wellenform der Aufnahme",
	...
	"components.cardElement.codeElement.language": "Sprache",
	"components.cardElement.codeElement.lineNumbers": "Zeilennummern",
	"components.cardElement.codeElement.highlighting": "Syntax-Hervorhebung",
	"components.cardElement.codeElement.code": "Code",
	"components.cardElement.codeElement.copy": "Kopieren",
	"components.cardElement.codeElement.copied": "Code kopiert",
	"components.cardElement.formulaElement": "Formel",
	"components.cardElement.formulaElement.latex": "LaTeX",
	"components.cardElement.formulaElement.empty": "Noch keine Formel eingetragen",
	"components.cardElement.formulaElement.invalid": "Formel konnte nicht gelesen werden",
	"components.cardElement.checklistElement": "Checkliste",
	"components.cardElement.checklistElement.title": "Bezeichnung",
	"components.cardElement.checklistElement.item": "Punkt {index}",
	"components.cardElement.checklistElement.addItem": "Punkt hinzufügen",
	"components.cardElement.checklistElement.removeItem": "Punkt {index} entfernen",
	"components.cardElement.checklistElement.empty": "Noch keine Punkte",
	"components.cardElement.checklistElement.progress": "{done} von {total} erledigt",
	"components.cardElement.checklistElement.progressMode": "Fortschritt",
	"components.cardElement.checklistElement.progressMode.shared": "Gemeinsam für alle",
	"components.cardElement.checklistElement.progressMode.perUser": "Persönlich für jede Person",
	"components.cardElement.checklistElement.modeResetHint": "Der Wechsel setzt die bisherigen Häkchen zurück.",
	"components.cardElement.checklistElement.personal": "nur für dich",
	"components.cardElement.checklistElement.participants": "{count} haben begonnen",
	"components.board.settings.inherit": "Vom Raum übernehmen",
	"components.board.settings.inheritedValue": "derzeit: {value}",
	"components.board.settings.off": "Aus",
	"components.elementTypeSelection.elements.deadlineElement.subtitle": "Termin",
	"components.elementTypeSelection.elements.codeElement.subtitle": "Code",
	"components.elementTypeSelection.elements.formulaElement.subtitle": "Formel",
	"components.elementTypeSelection.elements.checklistElement.subtitle": "Checkliste",
	...
	"components.boardCard.settings.readersCanEdit": "Alle dürfen bearbeiten",
	"components.boardCard.comment.placeholder": "Kommentar schreiben",
	"components.boardCard.comment.hint": "Enter sendet, Umschalt+Enter macht einen Zeilenumbruch",
	"components.boardCard.comment.submit": "Absenden",
	"components.boardCard.comment.edited": "bearbeitet",
	"components.boardCard.comment.removed": "Kommentar zurückgezogen",
	"components.boardCard.comment.removedByModerator": "Kommentar von einer Lehrkraft entfernt",
	"components.boardCard.comment.menu": "Kommentar-Aktionen",
	"components.boardCard.comment.report": "Melden",
	...
	"components.board.reactionType.like.hint": "Ein Klick pro Person, gezählt wird die Anzahl.",
	"components.board.reactionType.star": "Sterne",
	"components.board.reactionType.star.hint": "Bewertung von einem bis fünf Sternen, angezeigt wird der Durchschnitt.",
	"components.board.reactionType.vote": "Abstimmung",
	"components.board.reactionType.vote.hint": "Zustimmung oder Ablehnung, angezeigt wird die Differenz.",
	"components.boardCard.reaction.like": "Gefällt mir",
	"components.boardCard.reaction.upvote": "Zustimmen",
	"components.boardCard.reaction.downvote": "Ablehnen",
	"components.boardCard.reaction.star": "{count} von 5 Sternen",
	"components.boardCard.reaction.average": "{average} ({count})",
	"components.boardCard.reaction.noRating": "Noch keine Bewertung",
	...
	"components.cardElement.pollElement": "Umfrage",
	"components.cardElement.pollElement.question": "Frage",
	"components.cardElement.pollElement.noQuestion": "Noch keine Frage gestellt",
	"components.cardElement.pollElement.option": "Antwort {index}",
	"components.cardElement.pollElement.noOptionText": "Antwort ohne Text",
	"components.cardElement.pollElement.addOption": "Antwort hinzufügen",
	"components.cardElement.pollElement.removeOption": "Antwort {index} entfernen",
	"components.cardElement.pollElement.multipleChoice": "Mehrfachauswahl erlauben",
	"components.cardElement.pollElement.anonymous": "Anonym",
	"components.cardElement.pollElement.close": "Umfrage beenden",
	"components.cardElement.pollElement.closed": "Beendet",
	"components.cardElement.pollElement.showResults": "Ergebnisse anzeigen",
	"components.cardElement.pollElement.showResults.always": "Sofort für alle",
	"components.cardElement.pollElement.showResults.afterVote": "Nach eigener Stimmabgabe",
	"components.cardElement.pollElement.showResults.onRelease": "Erst nach Freigabe durch die Lehrkraft",
	"components.cardElement.pollElement.resultsRelease": "Ergebnisse freigeben",
	"components.cardElement.pollElement.resultsWithdraw": "Freigabe zurücknehmen",
	"components.cardElement.pollElement.resultsAfterVote": "Ergebnisse sichtbar nach eigener Stimmabgabe",
	"components.cardElement.pollElement.resultsAfterClose": "Ergebnisse noch nicht freigegeben",
	"components.cardElement.pollElement.voterCount": "{count} Teilnehmende",
	"components.cardElement.pollElement.votes": "{count} Stimmen",
	...
	"components.legacy.footer.imprint": "Impressum",
	"components.legacy.footer.powered_by": "Translated by",
	"components.legacy.footer.privacy_policy_thr": "Datenschutzhinweise",
	"components.legacy.footer.privacy_policy": "Datenschutzerklärung",
	...
	"components.molecules.ContentCardMenu.action.delete": "Löschen",
	...
	"components.molecules.importUsersMatch.saveMatch": "Verknüpfung speichern",
	"components.molecules.importUsersMatch.search": "Benutzerkonto suchen",
	...
	"components.organisms.importUsers.legend": "Erklärung der Filter-Symbole",
	"components.organisms.importUsers.legendAdminMatched":
		"Das {source}-Benutzerkonto wurde manuell mit einem vorhandenen {instance}-Benutzerkonto verknüpft.",
	"components.organisms.importUsers.legendAutoMatched":
		"Das {source}-Benutzerkonto wurde automatisch mit einem vorhandenen {instance}-Benutzerkonto verknüpft.",
	...
	"components.organisms.importUsers.searchLastName": "Suche nach Nachname",
	"components.organisms.importUsers.searchRole": "Rolle wählen",
	"components.organisms.importUsers.searchUnMatched": "Suche nicht verknüpft",
	"components.organisms.importUsers.searchUserName": "Suche nach Nutzername",
	"components.organisms.importUsers.tableClasses": "Klassen",
	"components.organisms.importUsers.tableFirstName": "Vorname",
	"components.organisms.importUsers.tableFlag": "Markieren",
	"components.organisms.importUsers.tableLastName": "Nachname",
	"components.organisms.importUsers.tableMatch": "{instance}-Konto verknüpfen",
	"components.organisms.importUsers.tableRoles": "Rollen",
	...
	"components.organisms.Pagination.perPage.5": "5 pro Seite",
	...
	"components.roomForm.labels.feedback.reactions.like": "Gefällt mir",
	"components.roomForm.labels.feedback.reactions.star": "Sterne (1–5)",
	"components.roomForm.labels.feedback.reactions.vote": "Zustimmung und Ablehnung",
	...
	"feature-copy.copyInfo.text.alert.followingContent": "Folgendes wird nicht kopiert:",
	"feature-copy.copyInfo.text.alert.membersPermissions": "{type}-Mitglieder und Berechtigungen",
	"feature-copy.copyInfo.text.alert.courseFiles": "Dateien unter Kursdateien",
	"feature-copy.copyInfo.text.alert.courseGroup": "Kursgruppen",
	"feature-copy.copyInfo.text.alert.Etherpad": "Inhalte aus Etherpads",
	"feature-copy.copyInfo.text.alert.whiteboard": "Inhalte aus Whiteboards",
	"feature-copy.copyInfo.text.alert.geogebra": "Geogebra IDs",
	"feature-copy.copyInfo.text.alert.protectedSettings": "Geschützte Einstellungen externer Tools",
	"feature-copy.inProgress.title.loading": "Duplizieren läuft...",
	"feature-copy.inProgress.course.info": "Kurs wird erstellt",
	"feature-copy.inProgress.ariaLabelSuffix": "wird noch kopiert",
	"feature-copy.inProgress.timeoutSuccess": "Das Duplizieren wurde abgeschlossen.",
	"feature-copy.notifications.success.successfullyCopied": "{type} erfolgreich dupliziert",
	"feature-copy.copyInfo.type.course": "Kurs",
	"feature-copy.copyInfo.type.board": "Bereich",
	"feature-copy.copyInfo.type.task": "Aufgabe",
	"feature-copy.copyInfo.type.lesson": "Thema",
	"feature-copy.copyInfo.type.room": "Raum",
	"feature-copy.copyInfo.type.card": "Karte",
	"feature-copy.copyInfo.type.ofCourse": "des Kurses",
	"feature-copy.copyInfo.type.ofBoard": "des Bereichs",
	"feature-copy.copyInfo.type.ofTask": "der Aufgabe",
	...
	"global.topbar.language.select": "Sprachauswahl",
	"global.topbar.language.selectedLanguage": "Ausgewählte Sprache",
	...
	"mixins.typeMeta.types.default": "Inhalt",
	...
	"pages.dashboard.calendar.title": "Nächste Termine",
	"pages.dashboard.calendar.subtitle": "Direkter Blick auf anstehende Kurs- und Teamtermine.",
	"pages.dashboard.calendar.showAll": "Zur Übersicht",
	"pages.dashboard.calendar.empty.title": "Keine anstehenden Termine",
	"pages.dashboard.calendar.empty.text": "Sobald Termine im Kalenderdienst verfügbar sind, erscheinen sie hier.",
	"pages.dashboard.calendar.openCourse": "Kurs öffnen",
	"pages.dashboard.calendar.openTeam": "Team öffnen",
	"pages.dashboard.calendar.openContext": "Kontext öffnen",
	"pages.calendar.title": "Kalender",
	"pages.calendar.subtitle": "Alle Termine aus Kalender-, Kurs- und Team-Kontexten.",
	"pages.calendar.empty": "Es sind keine Termine verfügbar.",
	"pages.calendar.today": "Heute",
	"pages.calendar.past": "Vergangene Termine",
	"pages.calendar.view.day": "Tag",
	"pages.calendar.view.week": "Woche",
	"pages.calendar.view.month": "Monat",
	"pages.calendar.previous": "Zurück",
	"pages.calendar.next": "Weiter",
	"pages.calendar.addEvent": "Termin hinzufügen",
	"pages.calendar.confirmDelete": "Möchtest du diesen Termin wirklich löschen?",
	"pages.calendar.deleteEvent": "Termin löschen",
	"pages.calendar.deleted": "Termin gelöscht.",
	"pages.calendar.form.createTitle": "Termin hinzufügen",
	"pages.calendar.form.description": "Beschreibung",
	"pages.calendar.form.editTitle": "Termin bearbeiten",
	"pages.calendar.form.endBeforeStart": "Das Ende muss nach dem Beginn liegen.",
	"pages.calendar.form.error": "Der Termin konnte nicht gespeichert werden.",
	"pages.calendar.form.from": "Von",
	"pages.calendar.form.location": "Ort",
	"pages.calendar.form.locationPlaceholder": "z.B. Turnhalle",
	"pages.calendar.form.required": "Bitte ausfüllen.",
	"pages.calendar.form.title": "Titel",
	"pages.calendar.form.titlePlaceholder": "z.B. Handball-Training",
	"pages.calendar.form.to": "Bis",
	"pages.accountSettings.title": "Dein Account",
	"pages.accountSettings.profile": "Profil",
	"pages.accountSettings.security": "Sicherheit",
	"pages.accountSettings.currentPassword": "Aktuelles Passwort",
	"pages.accountSettings.passwordHint":
		"Änderungen an E-Mail oder Passwort müssen mit dem aktuellen Passwort bestätigt werden.",
	"pages.accountSettings.ssoHint":
		"Deine Nutzerdaten werden automatisch von einem Identitätsmanagement (IDM) synchronisiert. Änderungen daran können nur in dem Ausgangssystem erfolgen (z.B. Schulserver oder Schulportal), das den Daten im IDM zugrunde liegt. Bitte wende dich an den lokalen Admin deiner Schule, um Änderungen an deinen Nutzerdaten vorzunehmen.",
	...
	"pages.news.overview.search": "Suche nach Neuigkeiten",
	"pages.accountThirdPartyProviders.title": "Drittanbieter-Logins",
	"pages.accountThirdPartyProviders.empty": "Keine Drittanbieter genutzt",
	"pages.accountThirdPartyProviders.revoked": "Drittanbieter-Anmeldung entfernt.",
	"pages.accountThirdPartyProviders.revokeError": "Drittanbieter-Anmeldung konnte nicht entfernt werden.",
	"pages.accountTeams.title": "Team Einstellungen",
	"pages.accountTeams.visibilityTitle": "Sichtbarkeit für Einladungen",
	"pages.accountTeams.visibilityText":
		"Hier wird gesteuert, ob du in Verzeichnissen für Einladungen in Räume oder Teams gefunden werden kannst.",
	"pages.accountTeams.nativeNote":
		"Diese Ansicht ist nativ migriert. Die konkrete Sichtbarkeitseinstellung wird in einem folgenden Slice an die passende Backend-Konfiguration angebunden.",
	"pages.dashboard.empty.news": "Bisher gibt es keine News.",
	"pages.legacyViewMigration.title": "Legacy-Ansicht migriert",
	"pages.legacyViewMigration.description":
		"Diese Legacy-Ansicht wird nicht mehr im alten Client geöffnet. Der Pfad ist in der Nuxt-Migrationsliste erfasst und kann nun schrittweise als native Ansicht umgesetzt werden.",
	"pages.legacyViewMigration.requestedPath": "Angefragter Pfad",
	...
	"pages.legacyViewMigration.note":
		"Bis die native Ansicht fertig ist, nutze bitte die Übersicht oder die Hilfe, um zum passenden Arbeitsbereich zu wechseln.",
	"pages.legacyViewMigration.toDashboard": "Zur Übersicht",
	"pages.legacyViewMigration.toHelp": "Zur Hilfe",
	"pages.releaseNotes.title": "Release Notes",
	"pages.releaseNotes.empty": "Es sind noch keine Release Notes verfügbar.",
	"pages.releaseNotes.openSource": "Quelle öffnen",
	"pages.helpArticles.title": "Hilfeartikel",
	"pages.helpArticles.training": "Online-Videokurse",
	"pages.helpArticles.liveFormats": "Live-Formate",
	"pages.helpArticles.quickstartPdf": "Schnellstart-PDF",
	"pages.helpArticles.documents": "Dokumente zum Download",
	"pages.helpArticles.search": "suchen...",
	"pages.helpArticles.firstSteps.students": "Schüler:innen",
	"pages.helpArticles.firstSteps.teachers": "Lehrkräfte",
	"pages.helpArticles.firstSteps.principal": "Schulleitung",
	"pages.helpArticles.firstSteps": "Erste Schritte",
	"pages.helpArticles.usageHelp": "Nutzungshilfen",
	"pages.helpContact.title": "Kontakt",
	"pages.helpContact.problem": "Problem",
	"pages.helpContact.wish": "Wunsch",
	"pages.helpContact.problemArea": "Thema wählen",
	"pages.helpContact.subject": "Kurzbeschreibung des Problems",
	"pages.helpContact.problemDescription": "Problembeschreibung",
	"pages.helpContact.role": "Als...",
	"pages.helpContact.desire": "möchte ich...",
	"pages.helpContact.benefit": "um ...",
	"pages.helpContact.acceptanceCriteria": "Akzeptanzkriterien",
	"pages.helpContact.device": "Das Problem tritt auf diesem Gerät auf",
	"pages.helpContact.replyEmail": "E-Mail-Adresse für eventuelle Rückfragen",
	"pages.helpContact.consent":
		"Ich bin damit einverstanden, dass zur besseren Bearbeitung meines Problems folgende Informationen mitgeschickt werden dürfen:",
	"pages.helpContact.sent": "Anfrage wurde gesendet.",
	"pages.helpContact.sendError": "Anfrage konnte nicht gesendet werden.",
	"pages.helpContact.formTitle": "Kontaktformular",
	"pages.helpContact.feedbackKind": "Welche Art von Feedback möchtest du uns senden?",
	"pages.helpContact.topicTitle": "Thema auswählen",
	"pages.helpContact.severalTopics": "Auswahl mehrerer Themen möglich",
	"pages.helpContact.required": "(Pflichtfeld)",
	"pages.helpContact.noProblemArea": "Sie müssen ein Thema auswählen.",
	"pages.helpContact.knownTitle": "Ist das Problem bereits bekannt?",
	"pages.helpContact.knownText":
		"Hast du geschaut, ob dein Problem bereits bekannt ist? Denn es hilft uns, schneller voran zu kommen, wenn nur neue Probleme mitgeteilt werden.",
	"pages.helpContact.knownStatus":
		"Zusätzlich kannst du auf unserer Statusseite sehen, ob aktuell technische Probleme bei den Systemen vorliegen.",
	"pages.helpContact.supportTitle": "Support kontaktieren",
	"pages.helpContact.supportSubtitle": "Dein Problem ist nicht dabei? Kontaktiere den Support.",
	"pages.helpContact.supportSubtitleWish": "Du möchtest einen Wunsch mitteilen? Kontaktiere den Support.",
	"pages.helpContact.subjectWish": "Kurzbeschreibung des Wunsches",
	"pages.helpContact.deviceWish": "Gerät",
	"pages.helpContact.emailPlaceholder": "E-Mail-Adresse",
	"pages.helpContact.furtherInformation": "Weitere Informationen zu deinem Browser und Betriebssystem",
	"pages.helpContact.consentWish":
		"Ich bin damit einverstanden, dass zur besseren Bearbeitung meines Wunsches folgende Informationen mitgeschickt werden dürfen:",
	"pages.helpContact.consentBrowser": "Browser Name und Version (z.B. Firefox 69.0)",
	"pages.helpContact.consentOs": "Betriebssystem und Version (z.B. Windows 10)",
	"pages.helpContact.submit": "Absenden",
	"pages.helpContact.rolePlaceholder": "z.B. Schüler:innen, Lehrkräfte, Admins, Hausmeister:innen usw.",
	"pages.helpContact.desirePlaceholder": "z.B. eine im System angelegte Aufgabe leicht auffinden und ändern können",
	"pages.helpContact.benefitPlaceholder": "z.B. sie zu aktualisieren",
	"pages.helpContact.acceptancePlaceholder":
		"z.B. Nach der Systemanmeldung gelange ich in maximal zwei Schritten zum Stundenkontext, kann die Aufgabe dort mit einem Klick bearbeiten und die Schüler:innen bei Bedarf automatisch über die Änderung informieren.",
	"pages.helpContact.whichArea": "Welchen Bereich der {themeTitle} betrifft dein Thema?",
	"pages.helpConfluence.title": "Hilfeartikel",
	"pages.helpConfluence.hint": "Wenn der Artikel nicht korrekt angezeigt wird, öffne ihn direkt in der Dokumentation.",
	"pages.helpConfluence.openExternal": "Artikel extern öffnen",
	"pages.helpDocuments.title": "Dokumente zum Download",
	"pages.helpDocuments.empty": "Es sind keine Dokumente verfügbar.",
	"pages.taskDetail.back": "Zur Aufgabenübersicht",
	"pages.taskDetail.description": "Beschreibung",
	"pages.taskDetail.maxSubmissions": "Max. Abgaben",
	"pages.taskDetail.noDescription": "Keine Beschreibung vorhanden.",
	"pages.taskDetail.notFound": "Aufgabe wurde nicht gefunden.",
	"pages.taskDetail.submissions": "Abgaben",
	"pages.taskDetail.submissions.empty": "Es sind noch keine Abgabestatus verfügbar.",
	"pages.taskDetail.tab.details": "Details",
	"pages.taskDetail.tab.submissions": "Abgaben",
	"pages.taskDetail.toCourseFiles": "Zu den Kursdateien",
	"pages.taskDetail.toCourse": "Zum Kurs",
	"pages.taskDetail.till": "bis",
	"pages.taskDetail.confirmDelete": "Bist du dir sicher, dass du '{name}' löschen möchtest?",
	"pages.taskDetail.error": "Das hat nicht geklappt.",
	"pages.taskDetail.feedback.files": "Als Kommentar/Bewertung hochgeladene Dateien",
	"pages.taskDetail.feedback.none": "Noch kein Kommentar vorhanden.",
	"pages.taskDetail.feedback.solvedPercent": "Du hast {grade}% richtig gelöst.",
	"pages.taskDetail.files.none": "Keine Dateien vorhanden.",
	"pages.taskDetail.files.upload": "Dateien hochladen",
	"pages.taskDetail.finish": "Abschließen",
	"pages.taskDetail.grading.comment": "Bewertungskommentar",
	"pages.taskDetail.grading.error": "Die Bewertung konnte nicht gespeichert werden.",
	"pages.taskDetail.grading.files": "Korrigierte Dateien hochladen",
	"pages.taskDetail.grading.grade": "Bewertung",
	"pages.taskDetail.grading.inPercent": "%",
	"pages.taskDetail.grading.saveAndSend": "Speichern und Abschicken",
	"pages.taskDetail.grading.saved": "Bewertung wurde gespeichert!",
	"pages.taskDetail.lessonHidden": "Aufgabe nicht sichtbar, da Thema unveröffentlicht",
	"pages.taskDetail.noDueDate": "Ohne Abgabedatum",
	"pages.taskDetail.print": "Aufgabenstellung drucken",
	"pages.taskDetail.restore": "Wiederherstellen",
	"pages.taskDetail.state.done": "Super! Du hast deine Aufgabe erledigt!",
	"pages.taskDetail.state.late": "Zu spät! Versuche beim nächsten Mal besser auf deine Zeit zu achten.",
	"pages.taskDetail.submission.chooseTeamMembers": "Mitstreiter:innen auswählen",
	"pages.taskDetail.submission.done": "Super! Du hast deine Aufgabe erledigt!",
	"pages.taskDetail.submission.error": "Die Abgabe konnte nicht gespeichert werden.",
	"pages.taskDetail.submission.fileUpload": "Dateiabgabe",
	"pages.taskDetail.submission.maxTeamSize": "Die maximale Teamgröße beträgt {max} Mitglieder",
	"pages.taskDetail.submission.placeholder": "Erstelle deine Abgabe...",
	"pages.taskDetail.submission.saveDraft": "Entwurf speichern",
	"pages.taskDetail.submission.saveFirst":
		"Speichere deine Abgabe zuerst als Entwurf, dann kannst du Dateien hochladen.",
	"pages.taskDetail.submission.saved": "Entwurf gespeichert.",
	"pages.taskDetail.submission.submit": "Abgabe senden",
	"pages.taskDetail.submission.submitted": "Abgabe gesendet.",
	"pages.taskDetail.submission.teamSubmission": "Teamabgabe",
	"pages.taskDetail.submission.textDelivery": "Textabgabe",
	"pages.taskDetail.submissions.grade": "Bewertung",
	"pages.taskDetail.submissions.noSubmissionYetFrom": "Bisher keine Abgabe von:",
	"pages.taskDetail.submissions.noText": "Keine Abgabe",
	"pages.taskDetail.submissions.none": "Keine Abgaben vorhanden.",
	"pages.taskDetail.submissions.rating": "Kommentar/Bewertung",
	"pages.taskDetail.submissions.show": "Anzeigen",
	"pages.taskDetail.submissions.submitted": "Abgegeben",
	"pages.taskDetail.submissions.submittedFiles": "Zur Abgabe hochgeladene Dateien",
	"pages.taskDetail.submissions.team": "Team",
	"pages.taskDetail.tab.feedback": "Kommentar/Bewertung",
	"pages.taskDetail.tab.submission": "Abgabe",
	"pages.taskEdit.availableDate": "Für Schüler:innen sichtbar und zu bearbeiten ab",
	"pages.taskEdit.course": "Kurs",
	"pages.taskEdit.createTitle": "Aufgabe hinzufügen",
	"pages.taskEdit.description": "Aufgabenstellung",
	"pages.taskEdit.descriptionPlaceholder": "Begründe, warum...",
	"pages.taskEdit.draft": "Entwurf (nicht für Schüler sichtbar)",
	"pages.taskEdit.dueBeforeStart": "Das Beginndatum muss vor dem Abgabedatum liegen!",
	"pages.taskEdit.dueDate": "Bearbeitungszeitraum endet am",
	"pages.taskEdit.editTitle": "Aufgabe bearbeiten",
	"pages.taskEdit.error": "Die Aufgabe konnte nicht gespeichert werden.",
	"pages.taskEdit.maxTeamMembers": "maximale Gruppengröße",
	"pages.taskEdit.name": "Titel",
	"pages.taskEdit.noCourse": "Keine Zuordnung",
	"pages.taskEdit.noTopic": "Kein Thema ausgewählt",
	"pages.taskEdit.publicSubmissions": "Schüler:innenabgaben untereinander sichtbar",
	"pages.taskEdit.publicSubmissionsHint":
		"Durch das Aktivieren dieser Option werden die Abgaben aller Kursteilnehmer:innen für alle anderen Schüler:innen des Kurses einsehbar.",
	"pages.taskEdit.required": "Dieses Feld ist erforderlich.",
	"pages.taskEdit.saved": "Aufgabe gespeichert.",
	"pages.taskEdit.substitutionCannotChangeCourse": "(Vertretungslehrkräfte dürfen den Kurs nicht ändern)",
	"pages.taskEdit.teamSubmissions": "Gruppenabgabe ermöglichen",
	"pages.taskEdit.topic": "Thema",
	...
	"pages.administration.ldap.activate.firstName": "Vorname",
	"pages.administration.ldap.activate.lastName": "Name",
	"pages.administration.ldap.activate.message":
		"Deine Konfiguration ist gespeichert. Die Synchronisation kann bis zu einigen Stunden andauern.",
	"pages.administration.ldap.activate.migrateExistingUsers.checkbox":
		"Migrations-Assistenten verwenden, um bestehende Nutzer und LDAP-Nutzer zusammenzuführen",
	...
	"pages.administration.ldap.users.path.email": "Attributwert E-Mail",
	"pages.administration.ldap.users.path.firstname": "Attributwert Vorname",
	"pages.administration.ldap.users.path.lastname": "Attributwert Nachname",
	"pages.administration.ldap.users.path.title": "Nutzer-Pfad(e)",
	...
	"pages.administration.ldap.users.title": "Nutzer",
	"pages.administration.ldap.users.uid.info":
		"Der spätere Login-Name darf zur selben Zeit in deinem LDAP nur einmal vorkommen.",
	"pages.administration.ldap.users.uid.title": "Attribut uid",
	"pages.administration.ldap.users.uuid.info":
		"Über die Nutzer-UUID findet die spätere Zuordnung statt. Deshalb darf sich diese nicht ändern.",
	"pages.administration.ldap.users.uuid.title": "Attribut uuid",
	...
	"pages.administration.migration.step4.bullets.newUsers":
		"Es wurden noch keine neuen Benutzerkonten angelegt. Nutzer:innen, die bisher kein Benutzerkonto in der dBildungscloud hatten und durch den Migrations-Assistenten importiert werden sollen, können sich noch nicht einloggen.",
	"pages.administration.migration.step4.bullets.oldUsers":
		"Nicht verknüpfte Benutzerkonten wurden nicht verändert und können bei Bedarf gelöscht werden (ggf. bitte Support kontaktieren).",
	"pages.administration.migration.step4.endTransferphase":
		"Bitte beende nun die Transferphase, damit die Schule für den Sync-Lauf freigeschaltet wird. Der Sync-Lauf erfolgt stündlich.",
	"pages.administration.migration.step4.linkingFinished":
		"Die Verknüpfung der {source}-Benutzerkonten mit den {instance}-Benutzerkonten ist erfolgt.",
	"pages.administration.migration.step4.nbc.linkingFinished":
		"Die Verknüpfung der {source}-Benutzerkonten mit den {instance}-Benutzerkonten ist erfolgt. Es wurden {totalMatched} Benutzerkonten verknüpft.",
	"pages.administration.migration.step4.transferphase":
		"Die Schule befindet sich nun in der Transfer-Phase (analog zum Schuljahreswechsel). In dieser Phase wird kein Sync-Lauf durchgeführt. Das bedeutet:",
	"pages.administration.migration.step4": "Transferphase",
	...
	"pages.administration.migration.summary.thirdParagraph.importUsersUnmatchedCount":
		"{source}-Benutzerkonten sind keinem {instance}-Benutzerkonto zugeordnet.",
	...
	"pages.administration.school.index.privacySettings.longText.studentVisibilityBrandenburg":
		"Die Aktivierung dieser Option schaltet die Sichtbarkeit aller Schüler:innen der Schule für jede Lehrkraft an.",
	...
	"pages.administration.students.infobox.li-2":
		"Drucke die Registrierungslinks als QR-Druckbogen, schneide sie aus und verteile die QR-Zettel an Nutzer:innen (bzw. deren Eltern)",
	"pages.administration.students.infobox.li-3":
		"Verzichte auf das digitale Einholen der Zustimmungen. Nutze stattdessen das Papierformular und generiere Startpasswörter für deine Nutzer:innen ",
	"pages.administration.students.infobox.more.info": "(mehr Infos)",
	"pages.administration.students.infobox.paragraph-1":
		"Du hast folgende Möglichkeiten, die Nutzer:innen zum Abschluss der Registrierung zu führen:",
	"pages.administration.students.infobox.paragraph-2":
		"Wähle dazu einen oder mehrere Nutzer:innen aus, z.B. alle Schüler:innen einer Klasse. Führe dann die gewünschte Aktion durch.",
	...
	"pages.administration.students.infobox.registrationOnly.paragraph-1":
		"Eine Einverständniserklärung bei der Registrierung von Schüler:innen muss nicht eingeholt werden. Die Nutzung der Schul-Cloud Brandenburg ist im brandenburgischen Schulgesetz (§ 65 Abs. 2 BbGSchulG) geregelt.",
	...
	"pages.files.overview.courseFiles": "Meine Kurs-Dateien",
	...
	"pages.files.personal.uploadError": "Die Datei konnte nicht hochgeladen werden.",
	"pages.files.legacy.folders": "Ordner",
	"pages.files.legacy.files": "Dateien",
	"pages.files.legacy.createFolder": "Neuen Ordner erstellen",
	"pages.files.legacy.newFolderTitle": "Neuer Ordner",
	"pages.files.legacy.folderName": "Name des Ordners",
	"pages.files.legacy.createFolderSubmit": "Ordner erstellen",
	"pages.files.legacy.renameFolder": "Ordner umbenennen",
	"pages.files.legacy.renameFile": "Datei umbenennen",
	"pages.files.legacy.renameDirTitle": "Ordner umbenennen",
	"pages.files.legacy.chooseNewName": "Wähle einen neuen Namen aus:",
	"pages.files.legacy.deleteFile": "Datei löschen",
	"pages.files.legacy.deleteFolder": "Ordner löschen",
	"pages.files.legacy.assertDeletion": "Bist du dir sicher, dass du '{filename}' löschen möchtest?",
	"pages.files.legacy.downloadFile": "Datei herunterladen",
	"pages.files.legacy.shareFile": "Datei teilen",
	"pages.files.legacy.shareLinkTitle": "Freigabe-Link",
	"pages.files.legacy.shareLinkHint": "Verteile folgenden Link, um Zugriff auf die Datei zu gewährleisten.",
	"pages.files.legacy.editPermissions": "Dateiberechtigungen bearbeiten",
	"pages.files.legacy.editPermissionsTitle": "Berechtigungen bearbeiten",
	"pages.files.legacy.roleUser": "Rolle/Benutzer",
	"pages.files.legacy.read": "Lesen",
	"pages.files.legacy.write": "Schreiben",
	"pages.files.legacy.noPermissions": "Keine Berechtigungen zum Bearbeiten vorhanden.",
	"pages.files.legacy.permissionsError": "Leider ist ein Fehler beim Abfragen der Berechtigungen aufgetreten.",
	"pages.files.legacy.permissionsSaved": "Datei-Berechtigungen erfolgreich geändert",
	"pages.files.legacy.renameDirSuccess": "Umbenennen des Ordners war erfolgreich!",
	"pages.files.legacy.renameFileSuccess": "Umbenennen der Datei war erfolgreich!",
	"pages.files.legacy.fileMoved": "Verschieben der Datei war erfolgreich!",
	"pages.files.legacy.fileBlocked": "Die Datei enthält möglicherweise schädlichen Inhalt",
	"pages.files.legacy.dangerousCode": "Schädlicher Code",
	"pages.files.legacy.personalTitle": "Persönliche Dateien",
	"pages.files.legacy.courseTitle": "Kurs-Dateien",
	"pages.files.legacy.teamTitle": "Team-Dateien",
	"pages.files.legacy.sharedTitle": "Geteilte Dateien",
	"pages.files.legacy.myPersonalData": "Meine persönlichen Dateien",
	"pages.files.legacy.filesFromMyCourse": "Dateien aus meinen Kursen",
	"pages.files.legacy.filesFromMyTeam": "Dateien aus meinen Teams",
	"pages.files.legacy.filesSharedWithMe": "Mit mir geteilte Dateien",
	"pages.files.legacy.noAccess": "Zu dieser Datei haben Sie keinen Zugriff!",
	"pages.files.legacy.selectFolder": "Wähle einen Ordner aus",
	"pages.files.legacy.uploadHint": "Dateien zum Hochladen hier ablegen oder Computer durchsuchen",
	"pages.files.legacy.uploading": "Dateien werden hochgeladen",
	"pages.files.legacy.toTeam": "Zum Team",
	"pages.files.legacy.toCourse": "Zum Kurs",
	"pages.files.legacy.sortBy": "Sortieren nach...",
	"pages.files.legacy.sort.createdAt": "Erstelldatum",
	"pages.files.legacy.sort.updatedAt": "Änderungsdatum",
	"pages.files.legacy.sort.name": "Dateiname",
	"pages.files.legacy.sort.size": "Größe",
	"pages.files.legacy.openFolder": "Ordner {name} öffnen",
	"pages.files.legacy.openFile": "Datei {name} öffnen",
	"pages.files.legacy.close": "Schließen",
	"pages.files.legacy.uploadSuccess": "Datei(en) erfolgreich gespeichert.",
	"pages.files.legacy.openError": "Fehler beim Öffnen der Datei",
	"pages.files.legacy.dirExists": "Es existiert bereits ein Ordner mit diesem Namen im gleichen Ordner!",
	"pages.files.legacy.sorting": "Sortierung",
	"pages.files.legacy.role.teacher": "Lehrkraft",
	"pages.files.legacy.role.student": "Schüler:innen",
	"pages.files.legacy.role.teammember": "Teilnehmer:in",
	"pages.files.legacy.role.teamexpert": "Expert:in",
	"pages.files.legacy.role.teamleader": "Leiter:in",
	"pages.files.legacy.role.teamadministrator": "Admin",
	"pages.files.legacy.role.teamowner": "Eigentümer:in",
	"pages.files.legacy.myPersonalDataContent":
		"Hier findest du alle deine persönlichen Dateien. Auf diese Dateien hast nur du Zugriff, du kannst sie aber auch mit anderen Nutzer:innen teilen.",
	"pages.files.legacy.filesSharedWithMeContent":
		"Hier findest du alle mit dir geteilten Dateien. Dies sind Dateien die von anderen Nutzer:innen zur Verfügung gestellt worden sind.",
	"pages.files.legacy.copyLink": "Link kopieren",
	"pages.files.legacy.linkCopied": "Link in die Zwischenablage kopiert",
	"pages.files.legacy.moveFile": "Datei verschieben",
	"pages.files.legacy.moveFolder": "Ordner verschieben",
	"pages.files.legacy.moveError": "Die Datei konnte nicht verschoben werden.",
	"pages.files.legacy.actionError": "Die Aktion konnte nicht ausgeführt werden.",
	...
	"pages.rooms.importCourse.importError":
		"Leider konnte nicht der gesamte Kursinhalt importieren werden. Der Fehler ist uns bekannt und wird in den kommenden Monaten behoben.",
	"pages.rooms.importCourse.importErrorButton": "Okay, verstanden",
	...
	"pages.roomCreate.templates.title": "Wie möchtest du starten?",
	"pages.roomCreate.templates.subtitle":
		"Wähle eine Vorlage. Alles darin lässt sich danach umbenennen, verschieben und löschen.",
	"pages.roomCreate.templates.change": "Vorlage wechseln",
	"pages.roomCreate.templates.preview.title": "Das wird angelegt",
	"pages.roomCreate.templates.preview.more": "+{count} weitere",
	...
	"pages.roomCreate.templates.params.weeks": "Anzahl Wochen",
	"pages.roomCreate.templates.params.projectName": "Projektname",
	"pages.roomCreate.templates.params.groups": "Anzahl Gruppen",
	"pages.roomCreate.templates.params.className": "Klasse",
	"pages.roomCreate.templates.params.topic": "Thema",
	"pages.roomCreate.templates.weeklyPlan.columns.week": "Woche {index}",
	"pages.roomCreate.templates.project.cards.group.title": "Gruppe {index}",
	"pages.roomCreate.templates.project.cards.group.text":
		"<p>Aufgaben, Zuständigkeiten und Zwischenstand von Gruppe {index}.</p>",
	"pages.roomCreate.templates.blank.title": "Leerer Raum",
	"pages.roomCreate.templates.blank.description": "Ohne Vorlage starten und die Bereiche selbst anlegen.",
	"pages.roomCreate.templates.subject.title": "Fachraum",
	"pages.roomCreate.templates.subject.description":
		"Ein Raum für ein Fach über das Schuljahr: Organisation, Material, Aufgaben und Termine.",
	"pages.roomCreate.templates.subject.roomName": "{subject} {grade}",
	"pages.roomCreate.templates.subject.boards.overview": "Übersicht",
	"pages.roomCreate.templates.subject.columns.organisation": "Organisatorisches",
	"pages.roomCreate.templates.subject.columns.material": "Material",
	"pages.roomCreate.templates.subject.columns.tasks": "Aufgaben",
	"pages.roomCreate.templates.subject.columns.dates": "Termine & Prüfungen",
	"pages.roomCreate.templates.subject.cards.welcome.title": "Willkommen",
	"pages.roomCreate.templates.subject.cards.welcome.text":
		"<p>Herzlich willkommen in {subject}! Hier findet ihr alles Wichtige zum Fach.</p><p>Diesen Text durch eine eigene Begrüßung ersetzen.</p>",
	"pages.roomCreate.templates.subject.cards.rules.title": "Regeln & Bewertung",
	"pages.roomCreate.templates.subject.cards.rules.text":
		"<ul><li>Wie setzt sich die Note zusammen?</li><li>Welche Materialien werden gebraucht?</li><li>Welche Absprachen gelten im Unterricht?</li></ul>",
	"pages.roomCreate.templates.subject.cards.material.title": "Skripte & Arbeitsblätter",
	"pages.roomCreate.templates.subject.cards.material.text": "<p>Dateien hochladen oder Materialien verlinken.</p>",
	"pages.roomCreate.templates.subject.cards.links.title": "Linksammlung",
	"pages.roomCreate.templates.subject.cards.currentTask.title": "Aktuelle Aufgabe",
	"pages.roomCreate.templates.subject.cards.currentTask.text":
		"<p><strong>Aufgabe:</strong> …</p><p><strong>Abgabe bis:</strong> …</p>",
	"pages.roomCreate.templates.subject.cards.nextDates.title": "Nächste Termine",
	"pages.roomCreate.templates.subject.cards.nextDates.text": "<ul><li>Klassenarbeit: …</li><li>Exkursion: …</li></ul>",
	"pages.roomCreate.templates.weeklyPlan.title": "Wochenplan",
	"pages.roomCreate.templates.weeklyPlan.description":
		"Der Wochenrhythmus auf einen Blick: aktuelle Woche, Vorschau, Hilfen und Erledigtes.",
	"pages.roomCreate.templates.weeklyPlan.roomName": "Wochenplan {subject}",
	"pages.roomCreate.templates.weeklyPlan.boards.week": "Wochenplan",
	"pages.roomCreate.templates.weeklyPlan.columns.help": "Material & Hilfen",
	"pages.roomCreate.templates.weeklyPlan.columns.done": "Erledigt",
	"pages.roomCreate.templates.weeklyPlan.cards.goals.title": "Lernziele",
	"pages.roomCreate.templates.weeklyPlan.cards.goals.text": "<ul><li>Ich kann …</li><li>Ich kann …</li></ul>",
	"pages.roomCreate.templates.weeklyPlan.cards.tasks.title": "Aufgaben der Woche",
	"pages.roomCreate.templates.weeklyPlan.cards.tasks.text": "<ol><li>…</li><li>…</li></ol>",
	"pages.roomCreate.templates.weeklyPlan.cards.help.title": "Erklärungen & Videos",
	"pages.roomCreate.templates.weeklyPlan.cards.help.text": "<p>Hier liegen Hilfen für das selbstständige Arbeiten.</p>",
	"pages.roomCreate.templates.weeklyPlan.cards.archive.title": "Archiv",
	"pages.roomCreate.templates.weeklyPlan.cards.archive.text": "<p>Erledigte Karten hierher ziehen.</p>",
	"pages.roomCreate.templates.project.title": "Projekt & Gruppenarbeit",
	"pages.roomCreate.templates.project.description":
		"Vom Projektauftrag bis zur Präsentation – für Projektwochen und Gruppenarbeiten.",
	"pages.roomCreate.templates.project.roomName": "{projectName}",
	"pages.roomCreate.templates.project.boards.project": "Projektboard",
	"pages.roomCreate.templates.project.columns.briefing": "Projektauftrag",
	"pages.roomCreate.templates.project.columns.todo": "To-do",
	"pages.roomCreate.templates.project.columns.doing": "In Arbeit",
	"pages.roomCreate.templates.project.columns.done": "Fertig",
	"pages.roomCreate.templates.project.columns.results": "Ergebnisse",
	"pages.roomCreate.templates.project.cards.goal.title": "Ziel & Leitfrage",
	"pages.roomCreate.templates.project.cards.goal.text":
		"<p><strong>Leitfrage:</strong> …</p><p><strong>Ergebnis:</strong> …</p>",
	"pages.roomCreate.templates.project.cards.team.title": "Team & Rollen",
	"pages.roomCreate.templates.project.cards.team.text":
		"<ul><li>Projektleitung: …</li><li>Recherche: …</li><li>Präsentation: …</li></ul>",
	"pages.roomCreate.templates.project.cards.schedule.title": "Zeitplan",
	"pages.roomCreate.templates.project.cards.schedule.text":
		"<ul><li>Start: …</li><li>Zwischenstand: …</li><li>Abgabe: …</li></ul>",
	"pages.roomCreate.templates.project.cards.presentation.title": "Präsentation & Feedback",
	"pages.roomCreate.templates.project.cards.presentation.text":
		"<p>Ergebnisse, Präsentationen und Rückmeldungen sammeln.</p>",
	"pages.roomCreate.templates.classroom.title": "Klassenraum",
	"pages.roomCreate.templates.classroom.description":
		"Für die Klassenleitung: Aktuelles, Klassenorganisation, Termine und Elterninfos.",
	"pages.roomCreate.templates.classroom.roomName": "Klasse {className}",
	"pages.roomCreate.templates.classroom.boards.news": "Aktuelles",
	"pages.roomCreate.templates.classroom.boards.organisation": "Klassenorganisation",
	"pages.roomCreate.templates.classroom.columns.announcements": "Ankündigungen",
	"pages.roomCreate.templates.classroom.columns.duties": "Klassendienste",
	"pages.roomCreate.templates.classroom.columns.rules": "Regeln & Absprachen",
	"pages.roomCreate.templates.classroom.columns.dates": "Termine & Ausflüge",
	"pages.roomCreate.templates.classroom.columns.parents": "Elterninfos",
	"pages.roomCreate.templates.classroom.cards.welcome.title": "Willkommen in unserer Klasse",
	"pages.roomCreate.templates.classroom.cards.welcome.text":
		"<p>Hier stehen aktuelle Infos für die Klasse {className} – das Wichtigste immer oben.</p>",
	"pages.roomCreate.templates.classroom.cards.thisWeek.title": "Diese Woche",
	"pages.roomCreate.templates.classroom.cards.thisWeek.text": "<ul><li>Montag: …</li><li>Dienstag: …</li></ul>",
	"pages.roomCreate.templates.classroom.cards.dutyPlan.title": "Dienstplan",
	"pages.roomCreate.templates.classroom.cards.dutyPlan.text":
		"<ul><li>Tafeldienst: …</li><li>Ordnungsdienst: …</li></ul>",
	"pages.roomCreate.templates.classroom.cards.classRules.title": "Unsere Klassenregeln",
	"pages.roomCreate.templates.classroom.cards.classRules.text": "<ol><li>…</li><li>…</li></ol>",
	"pages.roomCreate.templates.classroom.cards.nextDates.title": "Nächste Termine",
	"pages.roomCreate.templates.classroom.cards.parentInfo.title": "Informationen für Eltern",
	"pages.roomCreate.templates.classroom.cards.parentInfo.text": "<p>Elternabende, Formulare und Ansprechpersonen.</p>",
	"pages.roomCreate.templates.team.title": "Fachschaft & Team",
	"pages.roomCreate.templates.team.description":
		"Zusammenarbeit im Kollegium: Ankündigungen, Materialien, Protokolle und Zuständigkeiten.",
	"pages.roomCreate.templates.team.roomName": "Fachschaft {subject}",
	"pages.roomCreate.templates.team.boards.team": "Teamraum",
	"pages.roomCreate.templates.team.columns.announcements": "Ankündigungen",
	"pages.roomCreate.templates.team.columns.material": "Materialien & Curriculum",
	"pages.roomCreate.templates.team.columns.minutes": "Protokolle & Beschlüsse",
	"pages.roomCreate.templates.team.columns.tasks": "Aufgaben & Zuständigkeiten",
	"pages.roomCreate.templates.team.cards.latest.title": "Aktuelles",
	"pages.roomCreate.templates.team.cards.latest.text": "<p>Kurze Infos für das Team.</p>",
	"pages.roomCreate.templates.team.cards.curriculum.title": "Schulinternes Curriculum",
	"pages.roomCreate.templates.team.cards.curriculum.text":
		"<p>Lehrpläne, Materialsammlungen und fachliche Absprachen.</p>",
	"pages.roomCreate.templates.team.cards.lastMeeting.title": "Letzte Sitzung",
	"pages.roomCreate.templates.team.cards.lastMeeting.text":
		"<p><strong>Datum:</strong> …</p><p><strong>Beschlüsse:</strong> …</p>",
	"pages.roomCreate.templates.team.cards.responsibilities.title": "Wer macht was?",
	"pages.roomCreate.templates.team.cards.responsibilities.text":
		"<ul><li>Sammlung: …</li><li>Materialbestellung: …</li></ul>",
	"pages.roomCreate.templates.selfStudy.title": "Selbstlerneinheit",
	"pages.roomCreate.templates.selfStudy.description":
		"Lernpfad in vier Schritten: Einstieg, Erarbeitung, Übung und Sicherung.",
	"pages.roomCreate.templates.selfStudy.roomName": "Selbstlerneinheit {topic}",
	"pages.roomCreate.templates.selfStudy.boards.path": "Lernpfad",
	"pages.roomCreate.templates.selfStudy.columns.intro": "1 – Einstieg",
	"pages.roomCreate.templates.selfStudy.columns.learn": "2 – Erarbeitung",
	"pages.roomCreate.templates.selfStudy.columns.practice": "3 – Übung",
	"pages.roomCreate.templates.selfStudy.columns.secure": "4 – Sicherung",
	"pages.roomCreate.templates.selfStudy.cards.hook.title": "Einstieg",
	"pages.roomCreate.templates.selfStudy.cards.hook.text":
		"<p>Womit steigen die Lernenden in {topic} ein: Video, Bild oder Frage?</p>",
	...
	"pages.roomCreate.templates.selfStudy.cards.input.text":
		"<p>Texte, Videos und Erklärungen zum eigenständigen Erarbeiten.</p>",
	"pages.roomCreate.templates.selfStudy.cards.exercises.title": "Übungsaufgaben",
	"pages.roomCreate.templates.selfStudy.cards.exercises.text":
		"<ol><li>Basisaufgabe</li><li>Vertiefung</li><li>Zusatz für Schnelle</li></ol>",
	"pages.roomCreate.templates.selfStudy.cards.check.title": "Selbstcheck",
	"pages.roomCreate.templates.selfStudy.cards.check.text":
		"<ul><li>Das kann ich jetzt: …</li><li>Dabei brauche ich noch Hilfe: …</li></ul>",
	...
	"pages.tasks.notGraded": "Unbewertet",
	"pages.tasks.state.empty": "Keine Aufgaben entsprechen den gewählten Filtern.",
	...
	"pages.tool.apiError.tool_param_duplicate":
		"Dieses Tool hat mindestens einen doppelten Parameter. Bitte an den Support wenden.",
	"pages.tool.apiError.tool_param_required":
		"Für die Konfiguration dieses Tools fehlen noch Eingaben für Pflichtparameter. Bitte die fehlenden Werte eingeben.",
	...
	"utils.adminFilter.consent.title": "Registrierungen",
	"utils.adminFilter.consent": "Einverständniserklärung:",
	"utils.adminFilter.date.created": "Erstellt zwischen",
	"utils.adminFilter.date.label.from": "Datum von",
	"utils.adminFilter.date.label.until": "Datum bis",
	"utils.adminFilter.date.title": "Erstellungsdatum",
	"utils.adminFilter.lastMigration.label.from": "Zuletzt migriert am von",
	"utils.adminFilter.lastMigration.label.until": "Zuletzt migriert am bis",
	"utils.adminFilter.lastMigration.title": "Zuletzt migriert am",
	"utils.adminFilter.outdatedSince.label.from": "Veraltet seit von",
	...
	"pages.folder.delete-multiple-confirmation": "Alle {total} Dateien wirklich in den Papierkorb verschieben?",
	"pages.folder.delete-confirmation": "Datei {name} wirklich in den Papierkorb verschieben?",
	...
	"pages.folder.trash.title": "Papierkorb: {folderName}",
	"pages.folder.trash.breadcrumb": "Papierkorb",
