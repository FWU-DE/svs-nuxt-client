export default {
	...
	"components.board.ai.preset.material.hint":
		"Offene Bildungsmaterialien aus AMB und OERSI suchen und als Karten mit Link einfügen.",
	...
	"components.board.ai.search.relays": "Gesucht wird im AMB-Relay und im OERSI-Relay.",
