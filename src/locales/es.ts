export default {
	...
	"global.sidebar.item.nostrSearch": "Búsqueda en Nostr",
	...
	"pages.nostrSearch.title": "Búsqueda en Nostr",
	"pages.nostrSearch.subtitle": "Busca recursos educativos abiertos, notas y perfiles en la red Nostr.",
	"pages.nostrSearch.searchLabel": "Término de búsqueda",
	"pages.nostrSearch.searchAction": "Buscar",
	"pages.nostrSearch.mode.notes": "Notas",
	"pages.nostrSearch.mode.profiles": "Perfiles",
	"pages.nostrSearch.disclaimer":
		"Los resultados provienen de relés Nostr públicos y ni la escuela ni la nube los moderan o revisan.",
	"pages.nostrSearch.empty": "Sin resultados. Prueba con otro término de búsqueda o añade más relés.",
	"pages.nostrSearch.resultCount": "{count} resultados",
	"pages.nostrSearch.error.tooShort": "Introduce al menos dos caracteres.",
	"pages.nostrSearch.error.noRelays": "No hay ningún relé activo. Activa al menos uno.",
	"pages.nostrSearch.error.allRelaysFailed": "No se pudo contactar con ningún relé. Inténtalo más tarde.",
	"pages.nostrSearch.relays.title": "Relés",
	"pages.nostrSearch.relays.summary": "{active} de {total} activos",
	"pages.nostrSearch.relays.description":
		"Nostr no tiene un índice central: la búsqueda solo llega a los relés consultados. No todos admiten la búsqueda de texto completo (NIP-50).",
	"pages.nostrSearch.relays.toggle": "Activar o desactivar el relé {relay}",
	"pages.nostrSearch.relays.remove": "Eliminar el relé {relay}",
	"pages.nostrSearch.relays.add": "Añadir",
	"pages.nostrSearch.relays.addLabel": "Dirección del relé (wss://)",
	"pages.nostrSearch.relays.invalid": "Introduce una dirección wss:// válida que aún no esté en la lista.",
	"pages.nostrSearch.relays.reset": "Restablecer",
	"pages.nostrSearch.relay.state.searching": "Buscando …",
	"pages.nostrSearch.relay.state.matches": "{count} resultados",
	"pages.nostrSearch.relay.state.noSearchSupport": "Sin búsqueda de texto completo (NIP-50)",
	"pages.nostrSearch.relay.error.unreachable": "No accesible",
	"pages.nostrSearch.relay.error.timeout": "Sin respuesta",
	"pages.nostrSearch.relay.error.rejected": "Solicitud rechazada",
	"pages.nostrSearch.result.open": "Abrir",
	"pages.nostrSearch.result.copy": "Copiar ID",
	"pages.nostrSearch.result.copied": "Copiado",
	"pages.nostrSearch.mode.resources": "Recursos educativos",
	"pages.nostrSearch.result.note": "Nota",
	"pages.nostrSearch.result.free": "Acceso libre",
	"pages.nostrSearch.result.addToBoard": "Al tablero",
	"pages.nostrSearch.board.title": "Añadir a un tablero",
	"pages.nostrSearch.board.description": "«{title}» se añadirá como una tarjeta nueva.",
	"pages.nostrSearch.board.room": "Sala",
	"pages.nostrSearch.board.board": "Tablero",
	"pages.nostrSearch.board.empty": "Esta sala no tiene ningún tablero que puedas editar.",
	"pages.nostrSearch.board.confirm": "Añadir",
	"pages.nostrSearch.board.success": "La tarjeta se ha creado.",
	"pages.nostrSearch.board.open": "Abrir tablero",
	"pages.nostrSearch.board.error.rooms": "No se pudieron cargar las salas.",
	"pages.nostrSearch.board.error.boards": "No se pudieron cargar los tableros de esta sala.",
	"pages.nostrSearch.board.error.add": "No se pudo crear la tarjeta.",
	"pages.nostrSearch.board.label.source": "Fuente",
	"pages.nostrSearch.board.label.license": "Licencia",
	"pages.nostrSearch.board.label.via": "Encontrado con la búsqueda en Nostr",
	"pages.nostrSearch.board.label.fallbackTitle": "Hallazgo de la búsqueda en Nostr",
