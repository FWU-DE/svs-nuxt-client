export default {
	...
	"pages.helpContact.consent": "Acepto que la siguiente información puede transferirse para gestionar mejor mi problema:",
	...
	"pages.helpContact.knownText": "¿Has comprobado si tu problema ya es conocido? Nos ayuda a resolver los problemas más rápidamente si sólo se comparten problemas nuevos.",
	"pages.helpContact.knownStatus": "Además, puedes ver en nuestra página de estado si hay actualmente algún problema técnico con los sistemas.",
	"pages.helpContact.supportTitle": "Contactar soporte",
	"pages.helpContact.supportSubtitle": "¿Tu problema no aparece en la lista? Ponte en contacto con nuestro equipo de asistencia.",
	"pages.helpContact.supportSubtitleWish": "¿Quieres compartir un deseo? Ponte en contacto con nuestro equipo de asistencia.",
	...
	"pages.helpContact.consentWish": "Acepto que la siguiente información puede transferirse para gestionar mejor mi solicitud:",
	...
	"pages.helpContact.desirePlaceholder": "por ejemplo, puede encontrar y cambiar fácilmente una tarea de estudiante creada en el sistema",
	"pages.helpContact.benefitPlaceholder": "por ejemplo, para actualizaciones",
	"pages.helpContact.acceptancePlaceholder": "Por ejemplo, después de iniciar sesión en el sistema, llego al contexto de la lección en dos pasos como máximo, puedo editar la tarea del estudiante allí con un clic y, si es necesario, informar a los estudiantes sobre el cambio de forma automática.",
