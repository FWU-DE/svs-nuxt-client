export default {
	...
	"global.sidebar.item.formerMemberships": "Membresías anteriores",
	...
	"pages.formerMemberships.title": "Membresías anteriores",
	"pages.formerMemberships.info":
		"Tras un cambio de centro escolar, perdió el acceso a los siguientes cursos/salas. Aquí puede llevarse una copia a su centro actual o descartar la entrada.",
	"pages.formerMemberships.table.name": "Nombre",
	"pages.formerMemberships.table.type": "Tipo",
	"pages.formerMemberships.reclaim.action": "Recuperar",
	"pages.formerMemberships.reclaim.confirmation":
		"¿Desea llevarse una copia de «{itemName}» a su centro actual? El original permanecerá sin cambios.",
	"pages.formerMemberships.reclaim.success": "Se ha añadido una copia de «{itemName}» a su centro actual.",
	"pages.formerMemberships.reclaim.error": "No se pudo crear la copia.",
	"pages.formerMemberships.reclaim.noLongerAvailable": "«{itemName}» ya no existe y no se puede copiar.",
	"pages.formerMemberships.discard.action": "Descartar",
	"pages.formerMemberships.discard.confirmation":
		"¿Desea descartar «{itemName}»? Esta acción no se puede deshacer.",
	"pages.formerMemberships.discard.success": "«{itemName}» ha sido descartado.",
	"pages.formerMemberships.discard.error": "No se pudo descartar «{itemName}».",
	"pages.formerMemberships.dashboardBanner.dismiss": "No volver a mostrar",
