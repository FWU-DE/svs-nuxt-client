export default {
	...
	"pages.accountSettings.title": "Configuración de la cuenta",
	...
	"pages.accountSettings.ssoHint":
		"Esta cuenta se gestiona mediante un proveedor de identidad central. Los datos del perfil no se pueden cambiar aquí.",
	...
	"pages.accountThirdPartyProviders.empty": "No se utilizan inicios de sesión de terceros.",
	...
	"pages.accountTeams.title": "Configuración de salas y equipos",
	...
	"pages.files.overview.personalFiles.description": "Gestiona tus propios archivos y carpetas.",
	"pages.files.overview.courseFiles.description": "Abre archivos de cursos y salas de curso.",
	"pages.files.overview.sharedFiles.description": "Ver archivos compartidos contigo.",
