export default {
	...
	"pages.files.personal.missingContext":
		"Los archivos personales no se pueden cargar sin contexto de usuario y escuela.",
	"pages.files.personal.title": "Archivos personales",
	"pages.files.personal.uploadHint": "Coloque aquí los archivos para cargar o busque en los ordenadores",
	"pages.files.personal.sortBy": "Ordenar por...",
	"pages.files.personal.sortOrder": "Clasificación",
	"pages.files.personal.sort.createdAt": "Fecha de creación",
	"pages.files.personal.sort.updatedAt": "Fecha de modificación",
	"pages.files.personal.sort.name": "Nombre del archivo",
	"pages.files.personal.sort.size": "Tamaño",
	"pages.files.personal.download": "Descargar archivo",
