export default {
	...
	"common.file.scanWontCheck": "Debido al tamaño, no se puede generar una vista previa.",
	...
	"common.labels.class": "Clase",
	"common.labels.classes": "clases",
	"common.labels.close": "Cerrar",
	"common.labels.collapse": "colapsar",
	"common.labels.collapsed": "colapsado",
	"common.labels.complete.firstName": "Nombre completo",
	...
	"common.labels.description": "Descripción",
	"common.labels.email": "Correo electrónico",
	...
	"common.labels.logout": "Cerrar sesión",
	"common.labels.migrated.tooltip": "Muestra cuándo se completó la migración de la cuenta",
	...
	"common.labels.repeat.email": "Nuevo correo electrónico",
	...
	"common.medium.alert.incomplete": "La configuración del medio no actual o incompleta.",
	...
	"common.notification.error.preferences.update": "No se han podido actualizar las preferencias del usuario.",
	"common.notification.error.preferences.retrieve": "No se han podido recuperar las preferencias del usuario.",
	...
	"common.placeholder.lastName": "Caso",
	"common.placeholder.password.confirmation": "Confirmar con contraseña",
	"common.placeholder.password.current": "Contraseña actual",
	"common.placeholder.password.new.confirmation": "Repetir nueva contraseña",
	"common.placeholder.password.new": "Nueva contraseña",
	...
	"common.validation.tooLong": "El texto introducido supera la longitud máxima de {maxLength} caracteres.",
	"common.validation.fileTooBig": "El archivo no debe superar {maxSize} KB.",
	"common.validation.tooShort": "El texto introducido es inferior a la longitud mínima de {minLength} caracteres.",
	...
	"common.words.color.blue-grey": "Azul-gris",
	"common.words.color.brown": "Marrón",
	"common.words.color.green": "Verde",
	"common.words.color.light-blue": "Azul claro",
	...
	"common.words.copiedToClipboard.failure": "No se pudo copiar al portapapeles. Inténtelo manualmente.",
	"common.words.copyLinkToClipboard.success": "Enlace copiado al portapapeles",
	"common.words.copyLinkToClipboard.failure": "El enlace no se pudo copiar al portapapeles",
	...
	"common.words.member": "Miembro | Miembros",
	"common.words.no": "No",
	"common.words.not": "no",
	...
	"components.administrationSection.description.support":
		"Si no desea realizar una migración en su centro educativo, por favor, no inicie el proceso de migración, contacte con {0}.",
	"components.administrationSection.description.support.link": "soporte",
	"components.administrationSection.description.moreInformation":
		"Información importante sobre el proceso de migración es {0}.",
	"components.administrationSection.description.moreInformation.link": "disponible aquí",
	"components.administration.adminMigrationSection.enableSyncDuringMigration.label":
		"Permitir la sincronización con el sistema de inicio de sesión anterior para clases y cuentas durante la migración",
	...
	"components.administration.adminMigrationSection.endWarningCard.check":
		"Confirmo la finalización de la migración. Una vez transcurrido el periodo de espera de {gracePeriod} días como muy pronto, se desconectará definitivamente el antiguo sistema de inicio de sesión y se eliminarán las cuentas que no se hayan migrado.",
	...
	"components.administration.adminMigrationSection.endWarningCard.text":
		"Confirme que desea completar la migración de la cuenta de usuario a moin.schule.",
	...
	"components.administration.adminMigrationSection.headers": "Migración de cuenta a moin.schule",
	...
	"components.administration.adminMigrationSection.mandatorySwitch.label": "Migración obligatoria",
	"components.administration.adminMigrationSection.migrationActive": "La migración de cuenta está activa.",
	"components.administration.adminMigrationSection.migrationEnableButton.label": "Iniciar la migración",
	"components.administration.adminMigrationSection.migrationEndButton.label": "Completar la migración",
	...
	"components.administration.adminMigrationSection.migrationWizardButton.label": "Abrir asistente de migración",
	...
	"components.administration.adminMigrationSection.showOutdatedUsers.label": "Mostrar cuentas de usuario obsoletas",
	"components.administration.adminMigrationSection.startWarningCard.agree": "Comenzar",
	"components.administration.adminMigrationSection.startWarningCard.disagree": "Desgaje",
	...
	"components.administration.externalToolsSection.action.showDatasheet": "Ver hoja de datos",
	"components.administration.externalToolsSection.action.sync": "Disponibilidad de actualización",
	...
	"components.administration.externalToolsSection.vidis.notification.success": "Medios VIDIS actualizados exitosamente",
	...
	"components.administration.externalToolsSection.notification.created": "La herramienta se creó correctamente.",
	"components.administration.externalToolsSection.notification.deleted": "La herramienta se eliminó correctamente.",
	"components.administration.externalToolsSection.notification.updated":
		"La herramienta se ha actualizado correctamente.",
	"components.administration.externalToolsSection.table.header.status": "Estado",
	"components.administration.externalToolsSection.table.header.restrictedTo": "Restringido a",
	"components.administration.externalToolsSection.table.header.medium": "Gestión de medios",
	"components.administration.externalToolsSection.table.ariaLabel.mediumAvailable": "Medio externo autorizado",
	"components.administration.externalToolsSection.table.ariaLabel.mediumUnavailable": "Medio externo no autorizado",
	...
	"components.administration.provisioningOptions.class.label": "Sincronización de clases",
	"components.administration.provisioningOptions.course.description":
		"Active esta opción si los cursos y lecciones deben sincronizarse en la {instance}.",
	"components.administration.provisioningOptions.course.label": "Sincronización de cursos y lecciones",
	...
	"components.administration.provisioningOptions.otherGroups.label": "Sincronización de otros grupos.",
	...
	"components.administration.schoolYearChangeSection.info.part.two": " (más información sobre el {0})",
	"components.administration.schoolYearChangeSection.info.link": "Ayuda del lado de la ayuda",
	...
	"components.administration.schoolYearChangeSection.title.step.one": "Al final del año escolar",
	...
	"components.administration.schoolYearChangeSection.step.one.button.startTransfer": "Fase de transferencia de inicio",
	"components.administration.schoolYearChangeSection.step.one.button.transferStarted": "Fase de transferencia iniciada",
	"components.administration.schoolYearChangeSection.title.step.two": "Alrededor de las vacaciones de verano",
	...
	"components.administration.schoolYearChangeSection.step.two.button": "Verifique los datos de LDAP",
	"components.administration.schoolYearChangeSection.title.step.three": "Nuevo año escolar",
	...
	"components.administration.schoolYearChangeSection.step.three.button": "Fase de transferencia final",
	...
	"components.board.error.404": "Error 404 – No se ha encontrado ningún tablero con este nombre",
	"components.board.error.403": "Error 403 – Lamentablemente, falta la autorización para ver este contenido ...",
	...
	"components.board.ai.source.card": "A partir de esta tarjeta",
	"components.board.ai.source.column": "A partir de todas las tarjetas de esta columna",
	"components.board.ai.preset.differentiate": "Diferenciar",
	"components.board.ai.preset.differentiate.hint":
		"Dos versiones de la misma tarea: una con más apoyo y otra más exigente.",
	"components.board.ai.preset.exercises": "Ejercicios",
	"components.board.ai.preset.exercises.hint": "Tareas de dificultad creciente y una tarjeta con pistas de solución.",
	"components.board.ai.preset.simplify": "Simplificar el lenguaje",
	"components.board.ai.preset.simplify.hint": "El mismo contenido en frases cortas y con los términos explicados.",
	"components.board.ai.preset.selfCheck": "Autoevaluación",
	"components.board.ai.preset.selfCheck.hint":
		"Enunciados «ahora sé …» para comprobar el aprendizaje, con respuestas breves.",
	"components.board.ai.preset.free": "Instrucción libre",
	"components.board.ai.preset.free.hint": "Describe tú mismo las tarjetas que quieres.",
	"components.board.ai.prompt.label": "Instrucción",
	"components.board.ai.prompt.placeholder": "p. ej. escribe tres preguntas de salida sobre el contenido",
	"components.board.ai.generate": "Proponer tarjetas",
	"components.board.ai.regenerate": "Proponer de nuevo",
	"components.board.ai.insert": "Insertar {count} tarjetas",
	"components.board.ai.error": "No se pudo crear la propuesta. Inténtalo de nuevo.",
	"components.board.ai.insertError": "No se pudieron insertar todas las tarjetas.",
	...
	"components.board.menu.externalToolElement": "Configuración de la herramienta externa",
	...
	"components.board.menu.pollElement": "Ajustes de la encuesta",
	"components.board.menu.deadlineElement": "Ajustes del plazo",
	"components.board.menu.codeElement": "Ajustes del código",
	"components.board.menu.formulaElement": "Ajustes de la fórmula",
	"components.board.menu.checklistElement": "Ajustes de la lista",
	"components.board.menu.recordingElement": "Ajustes de la grabación",
	"components.cardElement.recordingElement": "Grabación",
	"components.cardElement.recordingElement.audio": "Grabación de voz",
	"components.cardElement.recordingElement.video": "Grabación de vídeo",
	"components.cardElement.recordingElement.caption": "Descripción",
	"components.cardElement.recordingElement.waveform": "Forma de onda de la grabación",
	...
	"components.cardElement.codeElement": "Código",
	"components.cardElement.codeElement.language": "Lenguaje",
	"components.cardElement.codeElement.lineNumbers": "Números de línea",
	"components.cardElement.codeElement.highlighting": "Resaltado de sintaxis",
	"components.cardElement.codeElement.code": "Código",
	"components.cardElement.codeElement.copy": "Copiar",
	"components.cardElement.codeElement.copied": "Código copiado",
	"components.cardElement.formulaElement": "Fórmula",
	"components.cardElement.formulaElement.latex": "LaTeX",
	"components.cardElement.formulaElement.empty": "Todavía no hay fórmula",
	"components.cardElement.formulaElement.invalid": "No se pudo leer la fórmula",
	"components.cardElement.checklistElement": "Lista de tareas",
	"components.cardElement.checklistElement.title": "Etiqueta",
	"components.cardElement.checklistElement.item": "Punto {index}",
	"components.cardElement.checklistElement.addItem": "Añadir punto",
	"components.cardElement.checklistElement.removeItem": "Eliminar el punto {index}",
	"components.cardElement.checklistElement.empty": "Todavía sin puntos",
	"components.cardElement.checklistElement.progress": "{done} de {total} completados",
	"components.cardElement.checklistElement.progressMode": "Progreso",
	"components.cardElement.checklistElement.progressMode.shared": "Compartido por todos",
	"components.cardElement.checklistElement.progressMode.perUser": "Personal para cada persona",
	"components.cardElement.checklistElement.modeResetHint": "Cambiar el modo borra las marcas hechas hasta ahora.",
	"components.cardElement.checklistElement.personal": "solo para ti",
	"components.cardElement.checklistElement.participants": "{count} han empezado",
	"components.board.settings.inherit": "Seguir a la sala",
	"components.board.settings.inheritedValue": "actualmente: {value}",
	"components.board.settings.off": "Desactivado",
	"components.elementTypeSelection.elements.deadlineElement.subtitle": "Plazo",
	"components.elementTypeSelection.elements.codeElement.subtitle": "Código",
	"components.elementTypeSelection.elements.formulaElement.subtitle": "Fórmula",
	"components.elementTypeSelection.elements.checklistElement.subtitle": "Lista de tareas",
	...
	"components.boardCard.settings.readersCanEdit": "Todos pueden editar",
	"components.boardCard.comment.placeholder": "Escribir un comentario",
	"components.boardCard.comment.hint": "Enter envía, Mayús+Enter añade un salto de línea",
	"components.boardCard.comment.submit": "Enviar",
	"components.boardCard.comment.edited": "editado",
	"components.boardCard.comment.removed": "Comentario retirado",
	"components.boardCard.comment.removedByModerator": "Comentario eliminado por el profesorado",
	"components.boardCard.comment.menu": "Acciones del comentario",
	"components.boardCard.comment.report": "Denunciar",
	...
	"components.board.reactionType.like.hint": "Un clic por persona, se muestra el número.",
	"components.board.reactionType.star": "Estrellas",
	"components.board.reactionType.star.hint": "Valoración de una a cinco estrellas, se muestra la media.",
	"components.board.reactionType.vote": "Votación",
	"components.board.reactionType.vote.hint": "A favor o en contra, se muestra la diferencia.",
	"components.boardCard.reaction.like": "Me gusta",
	"components.boardCard.reaction.upvote": "A favor",
	"components.boardCard.reaction.downvote": "En contra",
	"components.boardCard.reaction.star": "{count} de 5 estrellas",
	"components.boardCard.reaction.average": "{average} ({count})",
	"components.boardCard.reaction.noRating": "Sin valoraciones todavía",
	...
	"components.cardElement.pollElement": "Encuesta",
	"components.cardElement.pollElement.question": "Pregunta",
	"components.cardElement.pollElement.noQuestion": "Todavía no hay pregunta",
	"components.cardElement.pollElement.option": "Respuesta {index}",
	"components.cardElement.pollElement.noOptionText": "Respuesta sin texto",
	"components.cardElement.pollElement.addOption": "Añadir respuesta",
	"components.cardElement.pollElement.removeOption": "Eliminar respuesta {index}",
	"components.cardElement.pollElement.multipleChoice": "Permitir varias respuestas",
	"components.cardElement.pollElement.anonymous": "Anónima",
	"components.cardElement.pollElement.close": "Cerrar encuesta",
	"components.cardElement.pollElement.closed": "Cerrada",
	"components.cardElement.pollElement.showResults": "Mostrar resultados",
	"components.cardElement.pollElement.showResults.always": "Inmediatamente, a todos",
	"components.cardElement.pollElement.showResults.afterVote": "Tras votar",
	"components.cardElement.pollElement.showResults.onRelease": "Solo cuando el docente los publique",
	"components.cardElement.pollElement.resultsRelease": "Publicar resultados",
	"components.cardElement.pollElement.resultsWithdraw": "Retirar publicación",
	"components.cardElement.pollElement.resultsAfterVote": "Los resultados se ven después de votar",
	"components.cardElement.pollElement.resultsAfterClose": "Resultados aún no publicados",
	"components.cardElement.pollElement.voterCount": "{count} participantes",
	"components.cardElement.pollElement.votes": "{count} votos",
	...
	"components.elementTypeSelection.elements.folderElement": "Carpeta de archivos",
	...
	"components.externalTools.status.outdated": "Anticuado",
	"components.externalTools.status.unknown": "Desconocido",
	...
	"components.molecules.admintablelegend.externalSync":
		"Algunos o todos los datos de usuari{'@'} se sincronizan con un origen de datos externo (LDAP, IDM, etc.). Por lo tanto, no es posible editar la tabla manualmente con la nube de la escuela. La creación de nuevos estudiantes o profesores también es posible en el sistema de origen. Encuentra más información en el",
	...
	"components.molecules.ContentCard.report.body": "Informar del contenido con el ID",
	"components.molecules.ContentCard.report.email": "inhalte{'@'}hpi-schul-cloud.de",
	"components.molecules.ContentCard.report.subject":
		"Estimado equipo: me gustaría informar sobre el contenido mencionado en el asunto porque: [indica tus razones aquí]",
	"components.molecules.ContentCardMenu.action.copy": "Copia a...",
	"components.molecules.ContentCardMenu.action.delete": "Eliminar",
	"components.molecules.ContentCardMenu.action.report": "Informe",
	...
	"components.molecules.import.columnBoard.options.selectCourse": "Elija el curso",
	...
	"components.molecules.import.lessons.rename": "Si es necesario, se puede cambiar el nombre del tema: ",
	...
	"components.molecules.importUsersMatch.saveMatch": "Guardar enlace",
	"components.molecules.importUsersMatch.search": "Buscar cuenta de usuario",
	"components.molecules.importUsersMatch.subtitle.nbc":
		"Las cuentas de usuario {source} se importan posteriormente a la {instance}. Si desea vincular una cuenta de usuario de {source} a una cuenta de usuario de {instance} existente para conservar los datos del usuario, puede seleccionar aquí la cuenta de {instance} respectiva.",
	"components.molecules.importUsersMatch.subtitle":
		"Las cuentas de usuario {source} se importan posteriormente a la {instance}. Si desea vincular una cuenta de usuario de {source} a una cuenta de usuario de {instance} existente para conservar los datos del usuario, puede seleccionar aquí la cuenta de {instance} respectiva. De lo contrario, se creará como una nueva cuenta de usuario.",
	"components.molecules.importUsersMatch.title": "Vincular la cuenta {source} a la cuenta {instance}",
	"components.molecules.importUsersMatch.unMatched.nbc": "Ninguno.",
	"components.molecules.importUsersMatch.unMatched": "Ninguno. El usuario es recién creado.",
	"components.molecules.importUsersMatch.write": "Introduzca nombre o apellido",
	"components.molecules.importUsersMatch.externalRoleName.none": "No disponible",
	"components.molecules.importUsersMatch.externalRoleName.schulconnex.teacher": "Profesor",
	"components.molecules.importUsersMatch.externalRoleName.schulconnex.student": "Estudiante",
	...
	"components.molecules.shareImport.options.restrictions.infoText.personalData": "Datos personales",
	"components.molecules.shareImport.options.restrictions.infoText.courseFiles": "Archivos en Archivos de curso",
	"components.molecules.shareImport.options.restrictions.infoText.etherpad": "Contenido de Etherpads",
	"components.molecules.shareImport.options.restrictions.infoText.whiteboard": "Contenido de Whiteboards",
	"components.molecules.shareImport.options.restrictions.infoText.geogebra": "ID de Geogebra",
	"components.molecules.shareImport.options.restrictions.infoText.courseGroups": "Grupos de cursos",
	"components.molecules.shareImport.options.restrictions.infoText.roomMembershipsData":
		"Miembros y permisos de la sala",
	"components.molecules.share.options.tableHeader.InfoText": "No se copiará lo siguiente:",
	"components.molecules.share.courses.result.linkLabel": "Enlace a la copia del curso",
	...
	"components.molecules.share.lessons.result.linkLabel": "Enlace a la copia del tema",
	...
	"components.molecules.share.room.result.linkLabel": "Enlace a la copia del salón",
	...
	"components.molecules.TaskItemTeacher.lessonIsNotPublished": "Tema no publicada",
	"components.molecules.TaskItemTeacher.status": "{submitted}/{max} entregado, {graded} calificado",
	...
	"components.organisms.ContentCard.report.subject":
		"Estimado equipo: me gustaría informar sobre el contenido mencionado en el asunto porque: [pon tus razones aquí]",
	"components.organisms.DataFilter.add": "Añadir filtro",
	...
	"components.organisms.importUsers.legend": "Leyenda",
	"components.organisms.importUsers.legendAdminMatched":
		"Un administrador vinculó manualmente la cuenta {source} a la cuenta {instance}.",
	"components.organisms.importUsers.legendAutoMatched":
		"{source} se vinculó automáticamente a la cuenta de {instance}.",
	"components.organisms.importUsers.legendFlag":
		"Las entradas que deben marcarse y, en caso necesario, comprobarse posteriormente se pueden marcar con una bandera.",
	"components.organisms.importUsers.legendUnMatched":
		"{instance} usuario no encontrado. Una vez completada la migración, se creará automáticamente una nueva cuenta de usuario tan pronto como el usuario {source} inicie sesión en {instance} por primera vez.",
	"components.organisms.importUsers.searchAdminMatched": "Búsqueda vinculada por el administrador",
	"components.organisms.importUsers.searchAutoMatched": "Búsqueda vinculada automáticamente",
	"components.organisms.importUsers.searchClass": "Buscar por clase",
	"components.organisms.importUsers.searchFirstName": "Búsqueda por nombre",
	"components.organisms.importUsers.searchFlagged": "Búsqueda marcada",
	"components.organisms.importUsers.searchLastName": "Búsqueda por apellido",
	"components.organisms.importUsers.searchRole": "Elija el rol",
	"components.organisms.importUsers.searchUnMatched": "Búsqueda no vinculada",
	"components.organisms.importUsers.searchUserName": "Buscar por nombre de usuario",
	"components.organisms.importUsers.tableClasses": "Clase",
	"components.organisms.importUsers.tableFirstName": "Nombre",
	"components.organisms.importUsers.tableFlag": "Marca",
	"components.organisms.importUsers.tableLastName": "Apellido",
	"components.organisms.importUsers.tableMatch": "Cuentas de enlace",
	"components.organisms.importUsers.tableRoles": "Roles",
	"components.organisms.importUsers.tableUserName": "Nombre de usuario",
	"components.organisms.LegacyFooter.contact": "Contacto",
	"components.organisms.LegacyFooter.job-offer": "Anuncios de empleo",
	"components.organisms.Pagination.currentPage": "{start} a {end} desde {total}",
	"components.organisms.Pagination.perPage.10": "10 por página",
	"components.organisms.Pagination.perPage.100": "100 por página",
	"components.organisms.Pagination.perPage.25": "25 por página",
	"components.organisms.Pagination.perPage.5": "5 por página",
	"components.organisms.Pagination.perPage.50": "50 por página",
	"components.organisms.Pagination.perPage": "por página",
	...
	"components.roomForm.labels.feedback.reactions.like": "Me gusta",
	"components.roomForm.labels.feedback.reactions.star": "Estrellas (1–5)",
	"components.roomForm.labels.feedback.reactions.vote": "A favor y en contra",
	...
	"feature-board-external-tool-element.alert.error.teacher":
		"La herramienta no se puede iniciar actualmente. Actualice el tablero o comuníquese con el administrador de la escuela.",
	"feature-board-external-tool-element.dialog.title": "Selección y configuración",
	...
	"feature-copy.copyInfo.checkPrivacyAndCopyright":
		"Por favor verifica el contenido en cuanto a derechos de autor y privacidad.",
	"feature-copy.copyInfo.text.nextStep": "En el siguiente paso se creará una copia del {type}.",
	"feature-copy.copyInfo.text.alert.followingContent": "Lo siguiente no será copiado:",
	"feature-copy.copyInfo.text.alert.membersPermissions": "Miembros y permisos del {type}",
	"feature-copy.copyInfo.text.alert.courseFiles": "Archivos bajo archivos del curso",
	"feature-copy.copyInfo.text.alert.courseGroup": "Grupos de curso",
	"feature-copy.copyInfo.text.alert.Etherpad": "Contenido de Etherpads",
	"feature-copy.copyInfo.text.alert.whiteboard": "Contenido de pizarras",
	"feature-copy.copyInfo.text.alert.geogebra": "IDs de Geogebra",
	"feature-copy.copyInfo.text.alert.protectedSettings": "Configuraciones protegidas de herramientas externas",
	"feature-copy.inProgress.title.loading": "Duplicando en proceso...",
	"feature-copy.inProgress.course.info": "Creando curso",
	...
	"feature-copy.copyInfo.type.task": "Tarea",
	"feature-copy.copyInfo.type.lesson": "Lección",
	"feature-copy.copyInfo.type.room": "Sala",
	"feature-copy.copyInfo.type.card": "Tarjeta",
	"feature-copy.copyInfo.type.ofCourse": "del curso",
	"feature-copy.copyInfo.type.ofBoard": "del tablero",
	"feature-copy.copyInfo.type.ofTask": "de la tarea",
	...
	"feature-course-sync.GroupSelectionDialog.selection.label": "Selección de grupo",
	...
	"global.topbar.settings": "Configuración",
	"global.topbar.userMenu.ariaLabel": "Menú de usuario para {userName}",
	"mixins.typeMeta.types.default": "Contenido",
	...
	"pages.dashboard.calendar.title": "Próximos eventos",
	"pages.dashboard.calendar.subtitle": "Vista directa de los próximos eventos de cursos y equipos.",
	"pages.dashboard.calendar.showAll": "Ir al resumen",
	"pages.dashboard.calendar.empty.title": "No hay próximos eventos",
	"pages.dashboard.calendar.empty.text":
		"Los eventos aparecerán aquí en cuanto el servicio de calendario los proporcione.",
	"pages.dashboard.calendar.openCourse": "Abrir curso",
	"pages.dashboard.calendar.openTeam": "Abrir equipo",
	"pages.dashboard.calendar.openContext": "Abrir contexto",
	"pages.calendar.title": "Calendario",
	"pages.calendar.subtitle": "Todos los eventos de calendario, cursos y equipos.",
	"pages.calendar.empty": "No hay eventos disponibles.",
	"pages.calendar.today": "Hoy",
	"pages.calendar.past": "Eventos pasados",
	"pages.calendar.view.day": "Día",
	"pages.calendar.view.week": "Semana",
	"pages.calendar.view.month": "Mes",
	"pages.calendar.previous": "Anterior",
	"pages.calendar.next": "Siguiente",
	"pages.calendar.addEvent": "Añadir fecha",
	"pages.calendar.confirmDelete": "¿De verdad quieres eliminar esta fecha?",
	"pages.calendar.deleteEvent": "Eliminar fecha",
	"pages.calendar.deleted": "Fecha eliminada.",
	"pages.calendar.form.createTitle": "Añadir fecha",
	"pages.calendar.form.description": "Descripción",
	"pages.calendar.form.editTitle": "Editar fecha",
	"pages.calendar.form.endBeforeStart": "El final debe ser posterior al inicio.",
	"pages.calendar.form.error": "No se pudo guardar la fecha.",
	"pages.calendar.form.from": "De",
	"pages.calendar.form.location": "Lugar",
	"pages.calendar.form.locationPlaceholder": "por ejemplo, gimnasio",
	"pages.calendar.form.required": "Rellena este campo.",
	"pages.calendar.form.title": "Título",
	"pages.calendar.form.titlePlaceholder": "por ejemplo, entrenamiento de balonmano",
	"pages.calendar.form.to": "Para",
	"pages.accountSettings.title": "Tu cuenta",
	"pages.accountSettings.profile": "Perfil",
	"pages.accountSettings.security": "Seguridad",
	"pages.accountSettings.currentPassword": "Contraseña actual",
	"pages.accountSettings.passwordHint":
		"Los cambios de correo electrónico o contraseña deben confirmarse con la contraseña actual.",
	"pages.accountSettings.ssoHint":
		"Los datos de usuario se sincronizan automáticamente mediante una administración de identidades (IDM). Los cambios en él solo se pueden realizar en el sistema de origen (por ejemplo, el servidor escolar o Schulportal) en el que se basan los datos en el IDM. Ponte en contacto con el administrador local de tu escuela para realizar cambios en tus datos de usuario.",
	...
	"pages.news.overview.search": "Buscar noticias",
	"pages.accountThirdPartyProviders.title": "Inicios de sesión de terceros",
	"pages.accountThirdPartyProviders.empty": "No se utilizan proveedores de terceros",
	"pages.accountThirdPartyProviders.revoked": "Inicio de sesión de tercero eliminado.",
	"pages.accountThirdPartyProviders.revokeError": "No se pudo eliminar el inicio de sesión de tercero.",
	"pages.accountTeams.title": "Configuración del equipo",
	"pages.accountTeams.visibilityTitle": "Visibilidad para invitaciones",
	"pages.accountTeams.visibilityText":
		"Aquí se controla si puedes encontrarte en directorios para invitaciones a salas o equipos.",
	"pages.accountTeams.nativeNote":
		"Esta vista se ha migrado de forma nativa. La configuración concreta de visibilidad se conectará a la configuración backend correspondiente en un siguiente paso.",
	"pages.dashboard.empty.news": "Hasta el momento no hay noticias.",
	"pages.legacyViewMigration.title": "Vista heredada migrada",
	"pages.legacyViewMigration.description":
		"Esta vista heredada ya no se abre en el cliente antiguo. La ruta está registrada en la lista de migración de Nuxt y ahora puede implementarse paso a paso como vista nativa.",
	"pages.legacyViewMigration.requestedPath": "Ruta solicitada",
	"pages.legacyViewMigration.legacyView": "Vista heredada",
	"pages.legacyViewMigration.legacyController": "Controlador heredado",
	"pages.legacyViewMigration.note":
		"Hasta que la vista nativa esté completa, usa el resumen o la ayuda para cambiar al área de trabajo correspondiente.",
	"pages.legacyViewMigration.toDashboard": "Ir al resumen",
	"pages.legacyViewMigration.toHelp": "Ir a la ayuda",
	"pages.releaseNotes.title": "Notas de la versión",
	"pages.releaseNotes.empty": "Todavía no hay notas de la versión disponibles.",
	"pages.releaseNotes.openSource": "Abrir fuente",
	"pages.helpArticles.title": "Artículos de ayuda",
	"pages.helpArticles.training": "Cursos de vídeo en línea",
	"pages.helpArticles.liveFormats": "Formatos en vivo",
	"pages.helpArticles.quickstartPdf": "PDF de inicio rápido",
	"pages.helpArticles.documents": "Documentos para descargar",
	"pages.helpArticles.search": "buscar...",
	"pages.helpArticles.firstSteps.students": "Estudiantes",
	"pages.helpArticles.firstSteps.teachers": "Profesores",
	"pages.helpArticles.firstSteps.principal": "Director",
	"pages.helpArticles.firstSteps": "Erste Schritte",
	"pages.helpArticles.usageHelp": "Nutzungshilfen",
	"pages.helpContact.title": "Contacto",
	"pages.helpContact.problem": "Problema",
	"pages.helpContact.wish": "Solicitud",
	"pages.helpContact.problemArea": "Selecciona el tema",
	"pages.helpContact.subject": "Breve descripción del problema",
	"pages.helpContact.problemDescription": "Descripción del problema:",
	"pages.helpContact.role": "Como...",
	"pages.helpContact.desire": "Me gustaría...",
	"pages.helpContact.benefit": "alrededor de...",
	"pages.helpContact.acceptanceCriteria": "Criterios de aceptación",
	"pages.helpContact.device": "El problema se produce en este dispositivo",
	"pages.helpContact.replyEmail": "Dirección de correo electrónico para cualquier consulta.",
	"pages.helpContact.consent":
		"Acepto que la siguiente información puede transferirse para gestionar mejor mi problema:",
	"pages.helpContact.sent": "Solicitud enviada.",
	"pages.helpContact.sendError": "No se pudo enviar la solicitud.",
	"pages.helpContact.formTitle": "Formulario de contacto",
	"pages.helpContact.feedbackKind": "¿Qué tipo de comentarios te gustaría enviarnos?",
	"pages.helpContact.topicTitle": "Selecciona el tema",
	"pages.helpContact.severalTopics": "Posibilidad de elegir entre varios temas",
	"pages.helpContact.required": "(obligatorio)",
	"pages.helpContact.noProblemArea": "Tienes que elegir un tema.",
	"pages.helpContact.knownTitle": "¿Se conoce ya el problema?",
	"pages.helpContact.knownText":
		"¿Has comprobado si tu problema ya es conocido? Nos ayuda a resolver los problemas más rápidamente si sólo se comparten problemas nuevos.",
	"pages.helpContact.knownStatus":
		"Además, puedes ver en nuestra página de estado si hay actualmente algún problema técnico con los sistemas.",
	"pages.helpContact.supportTitle": "Contactar soporte",
	"pages.helpContact.supportSubtitle":
		"¿Tu problema no aparece en la lista? Ponte en contacto con nuestro equipo de asistencia.",
	"pages.helpContact.supportSubtitleWish":
		"¿Quieres compartir un deseo? Ponte en contacto con nuestro equipo de asistencia.",
	"pages.helpContact.subjectWish": "Breve descripción de la solicitud",
	"pages.helpContact.deviceWish": "Dispositivo",
	"pages.helpContact.emailPlaceholder": "Dirección de correo electrónico",
	"pages.helpContact.furtherInformation": "Información adicional sobre tu navegador y sistema operativo",
	"pages.helpContact.consentWish":
		"Acepto que la siguiente información puede transferirse para gestionar mejor mi solicitud:",
	"pages.helpContact.consentBrowser": "nombre y versión del navegador (por ejemplo, Firefox 69.0)",
	"pages.helpContact.consentOs": "Sistema operativo y versión (por ejemplo, Windows 10)",
	"pages.helpContact.submit": "Enviar",
	"pages.helpContact.rolePlaceholder": "por ejemplo, estudiantes, profesores, administradores, conserjes, etc.",
	"pages.helpContact.desirePlaceholder":
		"por ejemplo, puede encontrar y cambiar fácilmente una tarea de estudiante creada en el sistema",
	"pages.helpContact.benefitPlaceholder": "por ejemplo, para actualizaciones",
	"pages.helpContact.acceptancePlaceholder":
		"Por ejemplo, después de iniciar sesión en el sistema, llego al contexto de la lección en dos pasos como máximo, puedo editar la tarea del estudiante allí con un clic y, si es necesario, informar a los estudiantes sobre el cambio de forma automática.",
	"pages.helpContact.whichArea": "¿A qué área de {{shortTitle}} se refiere tu tema?",
	"pages.helpConfluence.title": "Artículo de ayuda",
	"pages.helpConfluence.hint": "Si el artículo no se muestra correctamente, ábrelo directamente en la documentación.",
	"pages.helpConfluence.openExternal": "Abrir artículo externamente",
	"pages.helpDocuments.title": "Documentos para descargar",
	"pages.helpDocuments.empty": "No hay documentos disponibles.",
	"pages.taskDetail.back": "Volver a tareas",
	"pages.taskDetail.description": "Descripción",
	"pages.taskDetail.maxSubmissions": "Máx. entregas",
	"pages.taskDetail.noDescription": "No hay descripción disponible.",
	"pages.taskDetail.notFound": "No se encontró la tarea.",
	"pages.taskDetail.submissions": "Entregas",
	"pages.taskDetail.submissions.empty": "Todavía no hay estado de entregas disponible.",
	"pages.taskDetail.tab.details": "Detalles",
	"pages.taskDetail.tab.submissions": "Envíos",
	"pages.taskDetail.toCourseFiles": "A los archivos del curso",
	"pages.taskDetail.toCourse": "Para el curso",
	"pages.taskDetail.till": "hasta",
	"pages.taskDetail.confirmDelete": "¿Estás seguro de que deseas eliminar '{name}'?",
	"pages.taskDetail.error": "No ha funcionado.",
	"pages.taskDetail.feedback.files": "Archivos cargados como comentarios/calificación",
	"pages.taskDetail.feedback.none": "Aún no hay comentarios disponibles.",
	"pages.taskDetail.feedback.solvedPercent": "Has pasado {grade} % correctamente.",
	"pages.taskDetail.files.none": "No hay archivos.",
	"pages.taskDetail.files.upload": "Subir archivos",
	"pages.taskDetail.finish": "Terminar",
	"pages.taskDetail.grading.comment": "Comentarios de calificación",
	"pages.taskDetail.grading.error": "No se pudo guardar la evaluación.",
	"pages.taskDetail.grading.files": "Cargar archivos corregidos",
	"pages.taskDetail.grading.grade": "clasificación",
	"pages.taskDetail.grading.inPercent": "%",
	"pages.taskDetail.grading.saveAndSend": "Guardar y enviar",
	"pages.taskDetail.grading.saved": "¡Se ha guardado la clasificación!",
	"pages.taskDetail.lessonHidden": "Tarea no visible, porque el tema no está publicado",
	"pages.taskDetail.noDueDate": "Sin fecha de envío",
	"pages.taskDetail.print": "Imprimir definición de la tarea",
	"pages.taskDetail.restore": "Restaurar",
	"pages.taskDetail.state.done": "¡Genial! ¡Has completado tu tarea!",
	"pages.taskDetail.state.late": "¡Demasiado tarde! La próxima vez, intenta gestionar mejor tu tiempo.",
	"pages.taskDetail.submission.chooseTeamMembers": "Seleccionar compañeros",
	"pages.taskDetail.submission.done": "¡Genial! ¡Has completado tu tarea!",
	"pages.taskDetail.submission.error": "No se pudo guardar la entrega.",
	"pages.taskDetail.submission.fileUpload": "Envío de archivos",
	"pages.taskDetail.submission.maxTeamSize": "El tamaño máximo de equipo es de {max} miembros",
	"pages.taskDetail.submission.placeholder": "Crea tu envío...",
	"pages.taskDetail.submission.saveDraft": "Guardar borrador",
	"pages.taskDetail.submission.saveFirst": "Guarda primero tu entrega como borrador; después podrás subir archivos.",
	"pages.taskDetail.submission.saved": "Borrador guardado.",
	"pages.taskDetail.submission.submit": "Enviar envío",
	"pages.taskDetail.submission.submitted": "Entrega enviada.",
	"pages.taskDetail.submission.teamSubmission": "Envío de equipos",
	"pages.taskDetail.submission.textDelivery": "Envío de texto",
	"pages.taskDetail.submissions.grade": "clasificación",
	"pages.taskDetail.submissions.noSubmissionYetFrom": "Aún no hay ningún envío de:",
	"pages.taskDetail.submissions.noText": "Sin envío",
	"pages.taskDetail.submissions.none": "No hay envíos disponibles.",
	"pages.taskDetail.submissions.rating": "Comentario/calificación",
	"pages.taskDetail.submissions.show": "Mostrar",
	"pages.taskDetail.submissions.submitted": "Enviado",
	"pages.taskDetail.submissions.submittedFiles": "Archivos subidos para su envío",
	"pages.taskDetail.submissions.team": "Equipo",
	"pages.taskDetail.tab.feedback": "Comentario/calificación",
	"pages.taskDetail.tab.submission": "Envío",
	"pages.taskEdit.availableDate": "Visible para los estudiantes y para editar desde",
	"pages.taskEdit.course": "Curso",
	"pages.taskEdit.createTitle": "Añadir tarea",
	"pages.taskEdit.description": "Definición de tarea",
	"pages.taskEdit.descriptionPlaceholder": "Explicar por qué ...",
	"pages.taskEdit.draft": "Borrador (no es visible para los estudiantes)",
	"pages.taskEdit.dueBeforeStart": "La fecha de inicio debe ser anterior a la fecha de envío.",
	"pages.taskEdit.dueDate": "El período de procesamiento finaliza el",
	"pages.taskEdit.editTitle": "Editar tarea",
	"pages.taskEdit.error": "No se pudo guardar la tarea.",
	"pages.taskEdit.maxTeamMembers": "Tamaño máximo del grupo",
	"pages.taskEdit.name": "Título",
	"pages.taskEdit.noCourse": "Sin asignación",
	"pages.taskEdit.noTopic": "No hay temas seleccionados",
	"pages.taskEdit.publicSubmissions": "Los envíos de los estudiantes son visibles entre ellos",
	"pages.taskEdit.publicSubmissionsHint":
		"Al activar esta opción, los envíos de todos los participantes del curso serán visibles para todos los demás estudiantes del curso.",
	"pages.taskEdit.required": "Este campo es obligatorio.",
	"pages.taskEdit.saved": "Tarea guardada.",
	"pages.taskEdit.substitutionCannotChangeCourse": "(Los profesores suplentes no pueden editar el curso)",
	"pages.taskEdit.teamSubmissions": "Permitir el envío de grupos",
	"pages.taskEdit.topic": "Tema",
	...
	"pages.administration.ldap.classes.activate.import": "Activar la importación de clases",
	"pages.administration.ldap.classes.hint":
		"Cada sistema LDAP utiliza diferentes atributos para representar las clases. Por favor, ayúdenos con la asignación de los atributos de sus clases. Hemos creado algunos valores predeterminados útiles que puede ajustar aquí en cualquier momento.",
	"pages.administration.ldap.classes.notice.title": "Atributo del Nombre de la pantalla",
	"pages.administration.ldap.classes.participant.title": "Atributo del Participante",
	"pages.administration.ldap.classes.path.info": "Ruta relativa desde la ruta base",
	...
	"pages.administration.ldap.classes.title": "Clases (opcional)",
	"pages.administration.ldap.connection.basis.path.info":
		"Todas las personas usuarias y las clases deben ser accesibles a través de la ruta base.",
	"pages.administration.ldap.connection.basis.path": "Ruta base de la escuela",
	"pages.administration.ldap.connection.search.user.info":
		"DN completa de la persona usuaria, incluida la ruta de acceso raíz de la persona usuaria que tiene acceso a toda la información de las personas usuarias.",
	"pages.administration.ldap.connection.search.user.password": "Contraseña de la persona usuaria de búsqueda",
	"pages.administration.ldap.connection.search.user": "Persona usuaria de búsqueda",
	"pages.administration.ldap.connection.server.info":
		"Por favor, asegúrese de que el servidor sea accesible a través del protocolo seguro ldaps://.",
	"pages.administration.ldap.connection.server.url": "URL del servidor",
	"pages.administration.ldap.connection.title": "Conexión",
	"pages.administration.ldap.errors.configuration": "Objeto de configuración no válido",
	"pages.administration.ldap.errors.credentials": "Credenciales incorrectas para la persona usuaria de búsqueda",
	"pages.administration.ldap.errors.path": "Ruta de búsqueda o base incorrecta",
	"pages.administration.ldap.index.buttons.reset": "Restablecer entradas",
	"pages.administration.ldap.index.buttons.verify": "Verificar las entradas",
	"pages.administration.ldap.index.title": "Configuración LDAP",
	"pages.administration.ldap.index.verified": "La verificación fue exitosa",
	"pages.administration.ldap.save.example.class": "Ejemplo de clase",
	"pages.administration.ldap.save.example.synchronize": "Activar la sincronización",
	"pages.administration.ldap.save.example.user": "Ejemplo de persona usuaria",
	"pages.administration.ldap.save.subtitle":
		"En los siguientes ejemplos puedes comprobar si hemos asignado los atributos correctamente.",
	"pages.administration.ldap.save.title": "Los siguientes conjuntos de datos están disponibles para la sincronización",
	"pages.administration.ldap.subtitle.help": "Puede encontrar más información en nuestra ",
	"pages.administration.ldap.subtitle.helping.link": "Área de ayuda para la configuración LDAP",
	"pages.administration.ldap.subtitle.one":
		"Cualquier cambio en la siguiente configuración puede hacer que el inicio de sesión deje de funcionar para usted y para todas las personas usuarias de su escuela. Por lo tanto, solo haga cambios si es consciente de las consecuencias. Algunas áreas son de solo lectura.",
	"pages.administration.ldap.subtitle.two":
		"Después de la verificación, puede previsualizar el contenido en la vista previa. Las personas usuarias a las que les falte alguno de los atributos requeridos en el directorio no serán sincronizadas.",
	"pages.administration.ldap.title":
		"Configuración de sincronización de personas usuarias e inicio de sesión mediante LDAP",
	"pages.administration.ldap.users.domain.title": "Nombre de dominio (ruta en LDAP)",
	"pages.administration.ldap.users.hint":
		"Cada sistema LDAP utiliza distintos atributos para representar a las personas usuarias. Por favor, ayúdanos con la asignación de los atributos de tus personas usuarias. Hemos creado algunos valores predeterminados útiles que puedes ajustar aquí en cualquier momento.",
	"pages.administration.ldap.users.path.email": "Valor de atributo de e-mail",
	"pages.administration.ldap.users.path.firstname": "Valor de atributo de Nombre",
	"pages.administration.ldap.users.path.lastname": "Valor de atributo de Apellido",
	"pages.administration.ldap.users.path.title": "Ruta de la persona usuaria",
	"pages.administration.ldap.users.title.info":
		"En el siguiente campo de entrada hay que definir dónde encontramos a las personas usuarias y cómo están estructuradas. Con la ayuda de dos puntos y coma (;;) tienes la posibilidad de almacenar varias rutas de personas usuarias por separado.",
	"pages.administration.ldap.users.title": "Personas usuarias",
	"pages.administration.ldap.users.uid.info":
		"El nombre de inicio de sesión sólo puede suceder una vez al mismo tiempo en su LDAP.",
	"pages.administration.ldap.users.uid.title": "Atributo uid",
	"pages.administration.ldap.users.uuid.info":
		"La asignación posterior se realiza a través del UUID de la persona usuaria. Por lo tanto, esto no debe cambiar.",
	"pages.administration.ldap.users.uuid.title": "Atributo uuid",
	"pages.administration.ldapEdit.roles.headLines.sectionDescription":
		"A continuación, las personas usuarias encontradas deben ser asignadas a los roles predefinidos de $longname.",
	"pages.administration.ldapEdit.roles.headLines.title": "Roles de la persona usuaria",
	"pages.administration.ldapEdit.roles.info.admin": "Ejemplo: cn=admin,ou=rollen,o=schule,dc=de",
	"pages.administration.ldapEdit.roles.info.student": "Ejemplo: cn=schueler,ou=rollen,o=schule,dc=de",
	"pages.administration.ldapEdit.roles.info.teacher": "Ejemplo: cn=lehrer,ou=rollen,o=schule,dc=de",
	"pages.administration.ldapEdit.roles.info.user": "Ejemplo:  cn=ehemalige,ou=rollen,o=schule,dc=de",
	"pages.administration.ldapEdit.roles.labels.admin": "Valor del atributo admin",
	"pages.administration.ldapEdit.roles.labels.member": "Atributo del rol",
	"pages.administration.ldapEdit.roles.labels.noSchoolCloud": "Valor del atributo para omitir la persona usuaria",
	"pages.administration.ldapEdit.roles.labels.radio.description":
		"¿El rol de la persona usuaria se almacena textualmente en el atributo de la persona usuaria o existe un grupo LDAP para los respectivos roles de las personas usuarias?",
	"pages.administration.ldapEdit.roles.labels.radio.ldapGroup": "Grupo LDAP",
	"pages.administration.ldapEdit.roles.labels.radio.userAttribute": "Atributo de la persona usuaria",
	"pages.administration.ldapEdit.roles.labels.student": "Valor del atributo estudiante",
	"pages.administration.ldapEdit.roles.labels.teacher": "Valor del atributo profesor",
	"pages.administration.ldapEdit.roles.labels.user": "Valor del atributo para omitir la persona usuaria",
	"pages.administration.ldapEdit.roles.placeholder.admin": "Valor del atributo admin",
	"pages.administration.ldapEdit.roles.placeholder.member": "miembroDe",
	"pages.administration.ldapEdit.roles.placeholder.student": "Valor del atributo estudiante",
	"pages.administration.ldapEdit.roles.placeholder.teacher": "Valor del atributo profesor",
	"pages.administration.ldapEdit.roles.placeholder.user": "Valor del atributo para omitir la persona usuaria",
	"pages.administration.ldapEdit.validation.path": "Por favor, utilice un formato de ruta LDAP",
	"pages.administration.ldapEdit.validation.url": "Por favor, utilice un formato de URL válido",
	"pages.administration.migration.back": "Paso anterior",
	"pages.administration.migration.clearAutoMatches": "Restablecer accesos directos automáticos",
	"pages.administration.migration.backToAdministration": "Volver a Administración",
	"pages.administration.migration.brbSchulportal": "weBBSchule",
	"pages.administration.migration.cannotStart":
		"La migración no puede comenzar. La escuela no está en modo de migración ni en fase de transferencia.",
	"pages.administration.migration.confirm":
		"Esto confirma que se ha comprobado o realizado la asignación de las cuentas de usuario locales y que se puede realizar la migración.",
	"pages.administration.migration.error": "Se ha producido un error. Por favor, inténtelo más tarde.",
	"pages.administration.migration.finishTransferPhase": "Fin de la fase de transferencia",
	"pages.administration.migration.finishWizard": "Asistente de migración completo",
	"pages.administration.migration.ldapSource": "LDAP",
	"pages.administration.migration.migrate": "Guardar enlace",
	"pages.administration.migration.nbc.migrate": "Realizar migración",
	"pages.administration.migration.next": "Próximo",
	"pages.administration.migration.performingMigration": "La implementación de la migración...",
	"pages.administration.migration.startUserMigration": "Iniciar la migración de cuentas",
	"pages.administration.migration.matchByPreferredName": "Prefiere apodos para la vinculación automática de cuentas",
	...
	"pages.administration.migration.step4.bullets.classes": "Aún no se ha importado ninguna clase del {source}.",
	"pages.administration.migration.step4.bullets.linkedUsers":
		"Los usuarios cuyas cuentas de usuario se han vinculado ya pueden iniciar sesión con sus datos de acceso LDAP. Sin embargo, los datos personales de estos usuarios (nombre, fecha de nacimiento, funciones, clases, etc.) aún no se han actualizado desde LDAP.",
	"pages.administration.migration.step4.bullets.newUsers":
		"Aún no se han creado nuevas cuentas de usuario. Los usuarios que no disponían de una cuenta de usuario en la {instance} y que van a ser importados por el asistente de migración aún no pueden iniciar sesión.",
	"pages.administration.migration.step4.bullets.oldUsers":
		"Las cuentas de usuario no vinculadas no se han modificado y pueden eliminarse si es necesario (póngase en contacto con el servicio de asistencia si es necesario).",
	"pages.administration.migration.step4.endTransferphase":
		"Por favor, finalice ahora la fase de transferencia para que la escuela esté activada para la ejecución de la sincronización. La sincronización se realiza cada hora.",
	"pages.administration.migration.step4.linkingFinished":
		"Se ha realizado la vinculación de las cuentas de usuario {source} con las cuentas de usuario dBildungscloud.",
	"pages.administration.migration.step4.nbc.linkingFinished":
		"Las cuentas de usuario de {source} se han vinculado a las cuentas de usuario de {instance}. Se han vinculado {totalMatched} cuentas de usuario.",
	"pages.administration.migration.step4.transferphase":
		"La escuela se encuentra ahora en la fase de traslado (análoga al cambio de curso escolar). En esta fase no se realiza ninguna ejecución de sincronización. Es decir:",
	"pages.administration.migration.step4": "Fase de transferencia",
	"pages.administration.migration.step5.afterSync.bullet1":
		"Cuentas de usuario vinculadas: Los usuarios pueden iniciar sesión con sus credenciales de {source}. Los datos personales de estos usuarios proceden de la {source} (nombre, fecha de nacimiento, función, clases, etc.).",
	"pages.administration.migration.step5.afterSync.bullet2": "Se han creado cuentas de usuario nuevas.",
	"pages.administration.migration.step5.afterSync":
		"Tras la ejecución de la sincronización, se completa la vinculación de las cuentas de usuario de {source} y {instance}. Es decir:",
	"pages.administration.migration.step5.nbc.bullet1":
		"Cuentas de usuario vinculadas: los usuarios pueden iniciar sesión con sus credenciales de {source}. Los datos personales de estos usuarios se obtienen de {source} y, si es necesario, se actualizan con cada proceso de inicio de sesión (nombre, fecha de nacimiento, rol, clases, etc.).",
	"pages.administration.migration.step5.nbc.linkingFinished":
		"Las cuentas de usuario de {instance} seleccionadas se han vinculado a las cuentas de usuario de {source} correspondientes.",
	"pages.administration.migration.step5.syncReady1": "La escuela está ahora habilitada para la ejecución de Sync.",
	"pages.administration.migration.step5.syncReady2":
		"Con la siguiente ejecución de sincronización, todos los datos de la {source} se transfieren a la {instance}.",
	"pages.administration.migration.step5": "Finalizar",
	"pages.administration.migration.summary.firstParagraph": "Se realizaron las siguientes asignaciones:",
	"pages.administration.migration.summary.secondParagraph.importUsersCount":
		"{source}-las cuentas de usuario tienen una cuenta de usuario {instance} asignada. Estas cuentas de usuario se migrarán a {source}.",
	"pages.administration.migration.summary.thirdParagraph.importUsersUnmatchedCount":
		"{source}: las cuentas de usuario no tienen ninguna cuenta de usuario de {instance} asociada.",
	"pages.administration.migration.summary.lastParagraph.usersUnmatchedCount":
		"A las cuentas de usuario de {instance} no se les asignó ninguna cuenta de {source}. Las cuentas de {instance} se conservan y se pueden eliminar posteriormente a través de la página de administración (o comuníquese con el servicio de atención al usuario).",
	"pages.administration.migration.summary.lastParagraph.nbc":
		"Las cuentas de usuario de {instance} que no se han migrado a {source} se conservan y pueden migrarse en una fecha posterior o eliminarse posteriormente en administración.",
	...
	"pages.administration.migration.waiting": "Esperando la sincronización de datos...",
	...
	"pages.administration.school.index.authSystems.addLdap": "Añadir sistema LDAP",
	...
	"pages.administration.school.index.authSystems.type": "Tipo",
	"pages.administration.school.index.back": "Para algunos ajustes ",
	"pages.administration.school.index.backLink": "vuelva a la antigua página de administración aquí",
	"pages.administration.school.index.error.gracePeriodExceeded":
		"El período de gracia después de finalizar la migración ha expirado",
	"pages.administration.school.index.error": "Ocurrió un error al cargar la escuela",
	...
	"pages.administration.school.index.generalSettings.labels.schoolYear": "Año escolar",
	"pages.administration.school.index.generalSettings.labels.schoolNumber": "Numero de la escuela",
	"pages.administration.school.index.generalSettings.labels.timezone": "Zona horaria",
	"pages.administration.school.index.generalSettings.labels.uploadSchoolLogo": "Cargar el logotipo de la escuela",
	...
	"pages.administration.school.index.generalSettings.save": "Guardar configuración",
	"pages.administration.school.index.generalSettings.save.success": "Ajustes generales guardados correctamente.",
	...
	"pages.administration.school.index.privacySettings.labels.aiTutor": "Activar tutor de IA en la escuela",
	...
	"pages.administration.school.index.privacySettings.longText.studentVisibilityBrandenburg":
		"Activando esta opción se activa la visibilidad de todos los alumnos de esta escuela para cada profesor.",
	...
	"pages.administration.school.index.privacySettings": "Configuración de la privacidad",
	"pages.administration.school.index.schoolIsCurrentlyDrawing": "Tu escuela está recibiendo",
	"pages.administration.school.index.schoolPolicy.cancel": "Cancelar",
	...
	"pages.administration.school.index.schoolPolicy.notUploadedYet": "Aún no se ha cargado",
	"pages.administration.school.index.schoolPolicy.replace": "Sustituir",
	"pages.administration.school.index.schoolPolicy.success": "El nuevo archivo se ha cargado correctamente.",
	"pages.administration.school.index.schoolPolicy.uploadedOn": "Subido {date}",
	"pages.administration.school.index.schoolPolicy.validation.fileTooBig":
		"El archivo pesa más de 4 MB. Por favor, reduzca el tamaño del archivo",
	"pages.administration.school.index.schoolPolicy.validation.notPdf":
		"Este formato de archivo no es compatible. Utilice sólo PDF",
	"pages.administration.school.index.termsOfUse.cancel": "Cancelar",
	...
	"pages.administration.school.index.termsOfUse.notUploadedYet": "Aún no se ha cargado",
	"pages.administration.school.index.termsOfUse.replace": "Sustituir",
	"pages.administration.school.index.termsOfUse.success": "El nuevo archivo se ha cargado correctamente.",
	"pages.administration.school.index.termsOfUse.uploadedOn": "Subido {date}",
	...
	"pages.administration.school.index.termsOfUse.validation.notPdf":
		"Este formato de archivo no es compatible. Utilice sólo PDF",
	"pages.administration.school.index.title": "Administrar escuela",
	"pages.administration.school.index.usedFileStorage": "Almacenamiento de archivos usados en la nube",
	...
	"pages.administration.students.consent.input.missing": "Falta la fecha de nacimiento",
	"pages.administration.students.consent.print.title": "Registro completado con éxito",
	"pages.administration.students.consent.print": "Imprimir lista con datos de acceso",
	"pages.administration.students.consent.steps.complete.info":
		"Asegúrate de que las fechas de nacimiento de todos l{'@'}s usuari{'@'}s estén completas y añade los datos que faltan si es necesario.",
	"pages.administration.students.consent.steps.complete.inputerror": "Falta la fecha de nacimiento",
	"pages.administration.students.consent.steps.complete.next": "Aplicar datos",
	"pages.administration.students.consent.steps.complete.warn":
		"No todos l{'@'}s usuari{'@'}s tienen fechas de nacimiento válidas. Primero completa los datos de nacimiento que faltan.",
	"pages.administration.students.consent.steps.complete": "Añadir datos",
	"pages.administration.students.consent.steps.download.explanation":
		"Estas son las contraseñas para el inicio de sesión inicial en la nube de la escuela.\nSe debe elegir una nueva contraseña para el primer inicio de sesión. Los estudiantes que tengan al menos 14 años de edad también deben declarar su consentimiento cuando inicien sesión por primera vez.",
	"pages.administration.students.consent.steps.download.info":
		"Guarda e imprime la lista y entrégala a l{'@'}s usuari{'@'}s para su primer registro.",
	"pages.administration.students.consent.steps.download.next": "Descargar datos de acceso",
	"pages.administration.students.consent.steps.download": "Descargar datos de acceso",
	"pages.administration.students.consent.steps.register.analog-consent": "formulario de consentimiento analógico",
	"pages.administration.students.consent.steps.register.confirm.warn":
		"Confirma que has recibido los formularios de consentimiento de los padres y estudiantes en papel y que has leído las normas para el consentimiento.",
	"pages.administration.students.consent.steps.register.confirm":
		"Por la presente confirmo que he recibido el {analogConsent} en papel de los padres de los estudiantes mencionados anteriormente.",
	"pages.administration.students.consent.steps.register.info":
		"Comprueba que has recibido el consentimiento de los estudiantes enumerados de manera analógica en papel, se te pedirá que te registres en nombre de l{'@'}s usuari{'@'}s.",
	"pages.administration.students.consent.steps.register.next": "Registrar usuarios",
	"pages.administration.students.consent.steps.register.print":
		"Ahora puedes iniciar sesión en la nube con tu contraseña inicial. Ve a {hostName} e inicia sesión con los siguientes datos de acceso:",
	"pages.administration.students.consent.steps.register.success": "Usuario registrado correctamente",
	"pages.administration.students.consent.steps.register": "Realizar el registro",
	"pages.administration.students.consent.steps.success.back": "Volver a la vista general",
	...
	"pages.administration.students.index.tableActions.email": "Enviar los enlaces de registro por correo electrónico",
	"pages.administration.students.index.tableActions.qr": "Imprimir los enlaces de registro como código QR",
	"pages.administration.students.index.tableActions.registration": "Registro manual",
	"pages.administration.students.index.title": "Administrar estudiantes",
	"pages.administration.students.infobox.headline": "Completar registros",
	"pages.administration.students.infobox.LDAP.helpsection": "Área de ayuda",
	"pages.administration.students.infobox.LDAP.paragraph-1":
		"Su escuela obtiene todos los datos de acceso de un sistema de origen (LDAP o similar). L{'@'}s usuari{'@'}s pueden acceder a Schul-Cloud con el nombre de usuari{'@'} y la contraseña del sistema de origen.",
	"pages.administration.students.infobox.LDAP.paragraph-2":
		"La primera vez que se conecte, se le pedirá el formulario de consentimiento para completar el registro.",
	"pages.administration.students.infobox.LDAP.paragraph-3":
		"IMPORTANTE: Para los estudiantes menores de 16 años, se requiere el consentimiento de un padre o tutor durante el proceso de inscripción. En este caso, asegúrese de que el primer inicio de sesión tenga lugar en presencia de uno de los padres, normalmente en casa.",
	"pages.administration.students.infobox.LDAP.paragraph-4": "Encontrará más información sobre la inscripción en ",
	"pages.administration.students.infobox.li-1":
		"Envía los enlaces de registro a través de la nube de la escuela a las direcciones de correo electrónico proporcionadas (también es posible hacerlo directamente al importar/crear)",
	"pages.administration.students.infobox.li-2":
		"Imprime los enlaces de registro como hojas QR, recórtalas y distribuye las hojas QR a l{'@'}s usuari{'@'}s (o a sus padres)",
	"pages.administration.students.infobox.li-3":
		"Prescinde de la recopilación digital de consentimientos. Utiliza el formulario en papel en su lugar y genera contraseñas de inicio para tus usuarios (más información)",
	"pages.administration.students.infobox.more.info": "(más información)",
	"pages.administration.students.infobox.paragraph-1":
		"Tienes las siguientes opciones para guiar a l{'@'}s usuari{'@'}s para completar el registro:",
	"pages.administration.students.infobox.paragraph-2":
		"Para ello, selecciona uno o más usuarios, por ejemplo, todos los estudiantes: dentro de una clase. Luego realiza la acción deseada.",
	"pages.administration.students.infobox.paragraph-3":
		"Como alternativa, puedes cambiar al modo de edición del perfil de usuari{'@'} y recuperar el enlace de registro individual para enviarlo manualmente mediante el método que elijas.",
	"pages.administration.students.infobox.paragraph-4":
		"IMPORTANTE: para los estudiantes menores de 16 años, lo primero que se pide durante el proceso de registro es el consentimiento de un padre o tutor. En este caso, recomendamos la distribución de los enlaces de registro como hojas QR o la recuperación de los enlaces de forma individual y su envío a los padres. Después de que los padres hayan dado su consentimiento, los estudiantes reciben una contraseña de inicio y pueden completar la última parte del registro por su cuenta en cualquier momento. Para el uso de la nube escolar en las escuelas primarias, los formularios en papel son una alternativa popular.",
	"pages.administration.students.infobox.registrationOnly.headline": "Información sobre la inscripción",
	"pages.administration.students.infobox.registrationOnly.li-1":
		"Envío de enlaces de registro a las direcciones de correo electrónico guardadas (también es posible directamente durante la importación/creación)",
	"pages.administration.students.infobox.registrationOnly.li-2":
		"Imprima los enlaces QR de registro como hojas de impresión, recórtelos y distribuya las hojas con el código QR a los alumnos",
	"pages.administration.students.infobox.registrationOnly.li-3":
		"Seleccione uno o varios usuarios, por ejemplo, todos los alumnos de una clase, y realice la acción deseada",
	"pages.administration.students.infobox.registrationOnly.li-4":
		"Alternativamente: Pase al modo de edición del perfil del usuario y recupere el enlace de acceso individual directamente para enviarlo manualmente",
	"pages.administration.students.infobox.registrationOnly.paragraph-1":
		"No es necesario obtener una declaración de consentimiento al inscribir a los alumnos. El uso de la Schul-Cloud Brandenburg está regulado por la Ley Escolar de Brandemburgo (§ 65 párrafo 2 BbGSchulG).",
	"pages.administration.students.infobox.registrationOnly.paragraph-2":
		"Si la escuela obtiene o recibe los datos de los usuarios a través de un sistema externo, no se pueden utilizar las opciones anteriores. Los cambios deben realizarse en consecuencia en el sistema de origen.",
	"pages.administration.students.infobox.registrationOnly.paragraph-3":
		"De lo contrario, se pueden enviar invitaciones para registrarse mediante un enlace a través del área de administración de la nube:",
	"pages.administration.students.legend.icon.success": "Registro completo",
	"pages.administration.students.manualRegistration.steps.download.explanation":
		"Estas son las contraseñas para el inicio de sesión inicial en la nube de la escuela. Se debe elegir una nueva contraseña para el primer inicio de sesión.",
	"pages.administration.students.manualRegistration.steps.success":
		"¡Enhorabuena, has completado con éxito el registro analógico!",
	"pages.administration.students.manualRegistration.title": "Registro manual",
	"pages.administration.students.new.checkbox.label": "Enviar el enlace de registro al estudiante",
	"pages.administration.students.new.error":
		"No se ha podido añadir el estudiante. Es posible que la dirección de correo electrónico ya exista.",
	...
	"pages.administration.teachers.index.tableActions.qr": "Imprimir los enlaces de registro como código QR",
	"pages.administration.teachers.index.title": "Gestionar a l{'@'}s profesora(e)s",
	"pages.administration.teachers.new.checkbox.label": "Enviar el enlace de registro al profesor",
	"pages.administration.teachers.new.error":
		"No se ha podido añadir el profesor. Es posible que la dirección de correo electrónico ya exista.",
	...
	"pages.files.overview.courseFiles": "Mis archivos del curso",
	...
	"pages.files.personal.uploadError": "No se pudo subir el archivo.",
	"pages.files.legacy.folders": "Carpeta",
	"pages.files.legacy.files": "Archivos",
	"pages.files.legacy.createFolder": "Crear una nueva carpeta",
	"pages.files.legacy.newFolderTitle": "Nueva carpeta",
	"pages.files.legacy.folderName": "Nombre de la carpeta",
	"pages.files.legacy.createFolderSubmit": "Crear carpeta",
	"pages.files.legacy.renameFolder": "Renombrar carpeta",
	"pages.files.legacy.renameFile": "Renombrar archivo",
	"pages.files.legacy.renameDirTitle": "Renombrar carpeta",
	"pages.files.legacy.chooseNewName": "Selecciona un nuevo nombre:",
	"pages.files.legacy.deleteFile": "Eliminar archivo",
	"pages.files.legacy.deleteFolder": "Eliminar carpeta",
	"pages.files.legacy.assertDeletion": '¿Estás seguro de que deseas eliminar "{filename}"?',
	"pages.files.legacy.downloadFile": "Descargar archivo",
	"pages.files.legacy.shareFile": "Compartir archivo",
	"pages.files.legacy.shareLinkTitle": "Compartir enlace",
	"pages.files.legacy.shareLinkHint": "Comparte el siguiente enlace para dar acceso al archivo.",
	"pages.files.legacy.editPermissions": "Editar permisos de archivos",
	"pages.files.legacy.editPermissionsTitle": "Editar permisos",
	"pages.files.legacy.roleUser": "Rol / usuario",
	"pages.files.legacy.read": "Leer",
	"pages.files.legacy.write": "Escribir",
	"pages.files.legacy.noPermissions": "No hay permisos para editar.",
	"pages.files.legacy.permissionsError": "Desafortunadamente, se ha producido un error al recuperar los permisos.",
	"pages.files.legacy.permissionsSaved": "Los permisos de archivo se han cambiado correctamente",
	"pages.files.legacy.renameDirSuccess": "¡La carpeta ha sido renombrada correctamente!",
	"pages.files.legacy.renameFileSuccess": "¡El archivo ha sido renombrado correctamente!",
	"pages.files.legacy.fileMoved": "¡El archivo se ha movido correctamente!",
	"pages.files.legacy.fileBlocked": "El archivo puede contener contenido malicioso",
	"pages.files.legacy.dangerousCode": "Código malicioso",
	"pages.files.legacy.personalTitle": "Archivos personales",
	"pages.files.legacy.courseTitle": "Archivos del curso",
	"pages.files.legacy.teamTitle": "Archivos del equipo",
	"pages.files.legacy.sharedTitle": "Archivos compartidos",
	"pages.files.legacy.myPersonalData": "Mis archivos personales",
	"pages.files.legacy.filesFromMyCourse": "Archivos de mis cursos",
	"pages.files.legacy.filesFromMyTeam": "Archivos de mis equipos",
	"pages.files.legacy.filesSharedWithMe": "Archivos compartidos conmigo",
	"pages.files.legacy.noAccess": "¡No tienes acceso a este archivo!",
	"pages.files.legacy.selectFolder": "Seleccionar una carpeta",
	"pages.files.legacy.uploadHint": "Coloque aquí los archivos para cargar o busque en los ordenadores",
	"pages.files.legacy.uploading": "Carga de archivos",
	"pages.files.legacy.toTeam": "Al equipo",
	"pages.files.legacy.toCourse": "Para el curso",
	"pages.files.legacy.sortBy": "Ordenar por...",
	"pages.files.legacy.sort.createdAt": "Fecha de creación",
	"pages.files.legacy.sort.updatedAt": "Fecha de modificación",
	"pages.files.legacy.sort.name": "Nombre del archivo",
	"pages.files.legacy.sort.size": "Tamaño",
	"pages.files.legacy.openFolder": "abrir carpeta {name}",
	"pages.files.legacy.openFile": "abrir archivo {name}",
	"pages.files.legacy.close": "Cerrar",
	"pages.files.legacy.uploadSuccess": "Archivo(s) guardado(s) con éxito.",
	"pages.files.legacy.openError": "Error al abrir el archivo",
	"pages.files.legacy.dirExists": "¡Ya existe una carpeta con este nombre en la misma carpeta!",
	"pages.files.legacy.sorting": "Clasificación",
	"pages.files.legacy.role.teacher": "Profesor",
	"pages.files.legacy.role.student": "Estudiantes",
	"pages.files.legacy.role.teammember": "Asistente",
	"pages.files.legacy.role.teamexpert": "Experto",
	"pages.files.legacy.role.teamleader": "Líder",
	"pages.files.legacy.role.teamadministrator": "Administrador",
	"pages.files.legacy.role.teamowner": "Propietario",
	"pages.files.legacy.myPersonalDataContent":
		"Aquí puedes encontrar todos tus archivos personales. Solo tú tienes acceso a estos archivos, pero también puedes compartirlos con otros usuarios.",
	"pages.files.legacy.filesSharedWithMeContent":
		"Aquí puedes encontrar todos los archivos que han compartido contigo. Estos archivos han sido compartidos por otros usuarios.",
	"pages.files.legacy.copyLink": "Copiar enlace",
	"pages.files.legacy.linkCopied": "Enlace copiado al portapapeles",
	"pages.files.legacy.moveFile": "Mover archivo",
	"pages.files.legacy.moveFolder": "Mover carpeta",
	"pages.files.legacy.moveError": "No se pudo mover el archivo.",
	"pages.files.legacy.actionError": "No se pudo completar la acción.",
	...
	"pages.room.copy.course.message.copied": "El curso se ha duplicado correctamente.",
	"pages.room.copy.course.message.partiallyCopied": "El curso no se pudo duplicar completamente.",
	"pages.room.copy.lesson.message.copied": "El tema se ha duplicado correctamente.",
	...
	"pages.rooms.importCourse.importError":
		"Lamentablemente, no podemos importar todo el contenido del curso. Somos conscientes del error y lo solucionaremos en los próximos meses.",
	"pages.rooms.importCourse.importErrorButton": "Bien, entendí",
	...
	"pages.rooms.importCourse.step_2": "Pegue el código aquí para importar el curso compartido.",
	...
	"pages.roomCreate.templates.title": "¿Cómo quieres empezar?",
	"pages.roomCreate.templates.subtitle":
		"Elige una plantilla. Después podrás renombrar, mover y eliminar todo su contenido.",
	"pages.roomCreate.templates.change": "Cambiar plantilla",
	"pages.roomCreate.templates.preview.title": "Esto se creará",
	"pages.roomCreate.templates.preview.more": "+{count} más",
	...
	"pages.roomCreate.templates.subject.columns.tasks": "Tareas",
	...
	"pages.roomCreate.templates.subject.cards.material.title": "Apuntes y fichas",
	"pages.roomCreate.templates.subject.cards.material.text": "<p>Sube archivos o enlaza materiales.</p>",
	"pages.roomCreate.templates.subject.cards.links.title": "Colección de enlaces",
	"pages.roomCreate.templates.subject.cards.currentTask.title": "Tarea actual",
	"pages.roomCreate.templates.subject.cards.currentTask.text":
		"<p><strong>Tarea:</strong> …</p><p><strong>Fecha de entrega:</strong> …</p>",
	"pages.roomCreate.templates.subject.cards.nextDates.title": "Próximas fechas",
	"pages.roomCreate.templates.subject.cards.nextDates.text": "<ul><li>Examen: …</li><li>Excursión: …</li></ul>",
	...
	"pages.roomCreate.templates.weeklyPlan.cards.archive.text": "<p>Arrastra aquí las tarjetas terminadas.</p>",
	...
	"pages.roomCreate.templates.project.columns.doing": "En curso",
	"pages.roomCreate.templates.project.columns.done": "Terminado",
	"pages.roomCreate.templates.project.columns.results": "Resultados",
	"pages.roomCreate.templates.project.cards.goal.title": "Objetivo y pregunta guía",
	"pages.roomCreate.templates.project.cards.goal.text":
		"<p><strong>Pregunta guía:</strong> …</p><p><strong>Resultado:</strong> …</p>",
	"pages.roomCreate.templates.project.cards.team.title": "Equipo y roles",
	"pages.roomCreate.templates.project.cards.team.text":
		"<ul><li>Coordinación: …</li><li>Investigación: …</li><li>Presentación: …</li></ul>",
	...
	"pages.roomCreate.templates.classroom.columns.duties": "Tareas de clase",
	"pages.roomCreate.templates.classroom.columns.rules": "Normas y acuerdos",
	"pages.roomCreate.templates.classroom.columns.dates": "Fechas y excursiones",
	...
	"pages.roomCreate.templates.classroom.cards.dutyPlan.text":
		"<ul><li>Pizarra: …</li><li>Orden y limpieza: …</li></ul>",
	"pages.roomCreate.templates.classroom.cards.classRules.title": "Nuestras normas de clase",
	"pages.roomCreate.templates.classroom.cards.classRules.text": "<ol><li>…</li><li>…</li></ol>",
	"pages.roomCreate.templates.classroom.cards.nextDates.title": "Próximas fechas",
	"pages.roomCreate.templates.classroom.cards.parentInfo.title": "Información para las familias",
	"pages.roomCreate.templates.classroom.cards.parentInfo.text": "<p>Reuniones, formularios y personas de contacto.</p>",
	...
	"pages.roomCreate.templates.team.columns.minutes": "Actas y acuerdos",
	"pages.roomCreate.templates.team.columns.tasks": "Tareas y responsabilidades",
	"pages.roomCreate.templates.team.cards.latest.title": "Novedades",
	"pages.roomCreate.templates.team.cards.latest.text": "<p>Información breve para el equipo.</p>",
	"pages.roomCreate.templates.team.cards.curriculum.title": "Currículo del centro",
	"pages.roomCreate.templates.team.cards.curriculum.text":
		"<p>Programaciones, colecciones de material y acuerdos de la materia.</p>",
	"pages.roomCreate.templates.team.cards.lastMeeting.title": "Última reunión",
	"pages.roomCreate.templates.team.cards.lastMeeting.text":
		"<p><strong>Fecha:</strong> …</p><p><strong>Acuerdos:</strong> …</p>",
	"pages.roomCreate.templates.team.cards.responsibilities.title": "¿Quién hace qué?",
	"pages.roomCreate.templates.team.cards.responsibilities.text":
		"<ul><li>Colección: …</li><li>Pedido de material: …</li></ul>",
	...
	"pages.roomCreate.templates.selfStudy.columns.practice": "3 – Práctica",
	...
	"pages.roomCreate.templates.selfStudy.cards.exercises.title": "Ejercicios",
	"pages.roomCreate.templates.selfStudy.cards.exercises.text":
		"<ol><li>Ejercicio básico</li><li>Profundización</li><li>Extra para quien termine antes</li></ol>",
	"pages.roomCreate.templates.selfStudy.cards.check.title": "Autoevaluación",
	"pages.roomCreate.templates.selfStudy.cards.check.text":
		"<ul><li>Ahora sé: …</li><li>Todavía necesito ayuda con: …</li></ul>",
	...
	"pages.rooms.members.error.load": "No se pudo cargar la lista de participantes.",
	...
	"pages.rooms.members.error.updateRole": "El cambio de autorizaciones en la sala ha fallado.",
	...
	"pages.rooms.members.add.students.studentAdmins":
		"Los alumnos sólo pueden añadir alumnos de su propia clase a una sala.",
	...
	"pages.rooms.members.actionMenu.ariaLabel": "Menú de acciones para {memberFullName}",
	"pages.rooms.members.actionMenu.selectedMembers": "Menú de acciones para {count} participantes seleccionados",
	"pages.rooms.members.changePermission": "Cambiar las autorizaciones en la sala",
	"pages.rooms.members.changePermission.ariaLabel": "Cambiar autorizaciones de sala para {memberFullName}",
	...
	"pages.rooms.members.remove.ariaLabel": "Eliminar {memberFullName} de la sala",
	"pages.rooms.members.resetSelection.ariaLabel": "Restablecer las miembros seleccionados de la lista",
	...
	"pages.rooms.members.select.all": "Seleccionar a todos los participantes de la sala",
	"pages.rooms.members.select.none": "Deseleccionar a todos los participantes de la sala",
	...
	"pages.rooms.members.roleChange.Roomviewer.label": "Accede a los tableros de la sala y visualiza el contenido",
	...
	"pages.rooms.members.invitationTable.delete.confirmation": "¿Suprimir el enlace de invitación '{invitation}'?",
	"pages.rooms.members.invitationTable.shareButton.ariaLabel": "Compartir enlace de invitación „{linkTitle}“",
	"pages.rooms.members.confirmationTable.menus.confirm.label": "Confirmar solicitud de afiliación",
	"pages.rooms.members.confirmationTable.menus.reject.label": "Rechazar la solicitud de adhesión",
	"pages.rooms.members.confirmationTable.notification.confirm": "{fullName} ha sido añadido como miembro de la sala.",
	...
	"pages.rooms.members.confirmationTable.actionMenu.ariaLabel": "Menú de acción para {fullName}",
	...
	"pages.rooms.administration.table.row.actionMenu.ariaLabel": "Menú de acciones para la sala “{roomName}”",
	"pages.rooms.administration.table.actionMenu.delete": "Eliminar sala",
	"pages.rooms.administration.table.actionMenu.manageRoom": "Administrar miembros de la sala",
	"pages.rooms.administration.error.load": "No se pudo cargar la lista de salas.",
	...
	"pages.tool.apiError.tool_param_duplicate":
		"Esta Herramienta tiene al menos un parámetro duplicado. Póngase en contacto con el soporte.",
	"pages.tool.apiError.tool_param_required":
		"Aún faltan entradas para parámetros obligatorios para la configuración de esta herramienta. Introduzca los valores que faltan.",
	...
	"pages.tool.description.secondParagraph": "Eliminar una configuración elimina la herramienta del curso.",
	"pages.tool.description.moreInformation": "Puede encontrar más información en nuestro {0}.",
	"pages.tool.description.moreInformation.link": "Sección de ayuda sobre herramientas externas",
	...
	"pages.userMigration.description.firstParagraph.fromSource": "Ahora puede migrar su cuenta a {targetSystem}.",
	"pages.userMigration.description.firstParagraph.fromSourceMandatory": "Ahora debe migrar su cuenta a {targetSystem}.",
	...
	"pages.userMigration.error.schoolNumberMismatch.information": "Por favor pasa esta información:",
	...
	"pages.userMigration.success.description": "Se completó el movimiento de su cuenta a {targetSystem}.",
	"pages.userMigration.success.description.loginAgain": "Por favor, regístrese de nuevo ahora.",
	...
	"utils.adminFilter.consent.label.parentsAgreementMissing": "Falta el acuerdo del estudiante",
	"utils.adminFilter.consent.missing": "no disponible",
	"utils.adminFilter.consent.ok": "completamente",
	"utils.adminFilter.consent.parentsAgreed": "solo están de acuerdo los padres",
	"utils.adminFilter.consent.title": "Registros",
	"utils.adminFilter.consent": "Formulario de consentimiento:",
	"utils.adminFilter.date.created": "Creado entre",
	"utils.adminFilter.date.label.from": "Fecha desde",
	"utils.adminFilter.date.label.until": "Fecha hasta",
	"utils.adminFilter.date.title": "Fecha de creación",
	"utils.adminFilter.lastMigration.label.from": "Migrado por última vez el desde",
	"utils.adminFilter.lastMigration.label.until": "Migrado por última vez el hasta",
	"utils.adminFilter.lastMigration.title": "Migrado por última vez el",
	"utils.adminFilter.outdatedSince.label.from": "Obsoleto desde",
	"utils.adminFilter.outdatedSince.label.until": "Obsoleto desde hasta",
	"utils.adminFilter.outdatedSince.title": "Obsoleto desde",
	"utils.adminFilter.placeholder.class": "Filtrar por clase...",
	"utils.adminFilter.placeholder.complete.lastname": "Filtra por el apellido completo...",
	"utils.adminFilter.placeholder.complete.name": "Filtrar por nombre completo...",
	...
	"feature.media-shelf.emptyState": "Actualmente no hay medios disponibles para su uso",
	...
	"pages.folder.columns.preview": "Vista previa",
